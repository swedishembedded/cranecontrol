...
#define IS_SPI_ALL_PERIPH_EXT(PERIPH)                                                              \
	(((PERIPH) == SPI1) || ((PERIPH) == SPI2) || ((PERIPH) == SPI3) || ((PERIPH) == SPI4) ||   \
	 ((PERIPH) == SPI5) || ((PERIPH) == SPI6) || ((PERIPH) == I2S2ext) ||                      \
	 ((PERIPH) == I2S3ext))
...
#define IS_SPI_I2S_GET_FLAG(FLAG)                                                                  \
	(((FLAG) == SPI_I2S_FLAG_BSY) || ((FLAG) == SPI_I2S_FLAG_OVR) ||                           \
	 ((FLAG) == SPI_FLAG_MODF) || ((FLAG) == SPI_FLAG_CRCERR) || ((FLAG) == I2S_FLAG_UDR) ||   \
	 ((FLAG) == I2S_FLAG_CHSIDE) || ((FLAG) == SPI_I2S_FLAG_TXE) ||                            \
	 ((FLAG) == SPI_I2S_FLAG_RXNE) || ((FLAG) == SPI_I2S_FLAG_TIFRFE))
/**
  * @}
  */
