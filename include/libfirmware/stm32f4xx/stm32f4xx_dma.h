...
#define IS_DMA_DIRECTION(DIRECTION)                                                                \
	(((DIRECTION) == DMA_DIR_PeripheralToMemory) ||                                            \
	 ((DIRECTION) == DMA_DIR_MemoryToPeripheral) || ((DIRECTION) == DMA_DIR_MemoryToMemory))
/**
  * @}
  */
...
#define IS_DMA_FIFO_STATUS(STATUS)                                                                 \
	(((STATUS) == DMA_FIFOStatus_Less1QuarterFull) || ((STATUS) == DMA_FIFOStatus_HalfFull) || \
	 ...
	 ((STATUS) == DMA_FIFOStatus_3QuartersFull) || ((STATUS) == DMA_FIFOStatus_Full) ||        \
...
#define IS_DMA_GET_FLAG(FLAG)                                                                      \
	(((FLAG) == DMA_FLAG_TCIF0) || ((FLAG) == DMA_FLAG_HTIF0) || ((FLAG) == DMA_FLAG_TEIF0) || \
	 ((FLAG) == DMA_FLAG_DMEIF0) || ((FLAG) == DMA_FLAG_FEIF0) ||                              \
	 ((FLAG) == DMA_FLAG_TCIF1) || ((FLAG) == DMA_FLAG_HTIF1) || ((FLAG) == DMA_FLAG_TEIF1) || \
	 ((FLAG) == DMA_FLAG_DMEIF1) || ((FLAG) == DMA_FLAG_FEIF1) ||                              \
	 ((FLAG) == DMA_FLAG_TCIF2) || ((FLAG) == DMA_FLAG_HTIF2) || ((FLAG) == DMA_FLAG_TEIF2) || \
	 ((FLAG) == DMA_FLAG_DMEIF2) || ((FLAG) == DMA_FLAG_FEIF2) ||                              \
	 ((FLAG) == DMA_FLAG_TCIF3) || ((FLAG) == DMA_FLAG_HTIF3) || ((FLAG) == DMA_FLAG_TEIF3) || \
	 ((FLAG) == DMA_FLAG_DMEIF3) || ((FLAG) == DMA_FLAG_FEIF3) ||                              \
	 ((FLAG) == DMA_FLAG_TCIF4) || ((FLAG) == DMA_FLAG_HTIF4) || ((FLAG) == DMA_FLAG_TEIF4) || \
	 ((FLAG) == DMA_FLAG_DMEIF4) || ((FLAG) == DMA_FLAG_FEIF4) ||                              \
	 ((FLAG) == DMA_FLAG_TCIF5) || ((FLAG) == DMA_FLAG_HTIF5) || ((FLAG) == DMA_FLAG_TEIF5) || \
	 ((FLAG) == DMA_FLAG_DMEIF5) || ((FLAG) == DMA_FLAG_FEIF5) ||                              \
	 ((FLAG) == DMA_FLAG_TCIF6) || ((FLAG) == DMA_FLAG_HTIF6) || ((FLAG) == DMA_FLAG_TEIF6) || \
	 ((FLAG) == DMA_FLAG_DMEIF6) || ((FLAG) == DMA_FLAG_FEIF6) ||                              \
	 ((FLAG) == DMA_FLAG_TCIF7) || ((FLAG) == DMA_FLAG_HTIF7) || ((FLAG) == DMA_FLAG_TEIF7) || \
