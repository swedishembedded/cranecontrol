...
#define IS_TIM_REMAP(TIM_REMAP)                                                                    \
	(((TIM_REMAP) == TIM2_TIM8_TRGO) || ((TIM_REMAP) == TIM2_ETH_PTP) ||                       \
	 ...
	 ((TIM_REMAP) == TIM5_GPIO) || ((TIM_REMAP) == TIM5_LSI) || ((TIM_REMAP) == TIM5_LSE) ||   \
	 ((TIM_REMAP) == TIM5_RTC) || ((TIM_REMAP) == TIM11_GPIO) || ((TIM_REMAP) == TIM11_HSE))
...
#define IS_TIM_GET_FLAG(FLAG)                                                                      \
	(((FLAG) == TIM_FLAG_Update) || ((FLAG) == TIM_FLAG_CC1) || ((FLAG) == TIM_FLAG_CC2) ||    \
	 ...
	 ((FLAG) == TIM_FLAG_CC1OF) || ((FLAG) == TIM_FLAG_CC2OF) || ((FLAG) == TIM_FLAG_CC3OF) || \
	 ((FLAG) == TIM_FLAG_CC4OF))
