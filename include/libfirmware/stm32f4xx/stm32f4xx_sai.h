...
#define IS_SAI_BLOCK_GET_FLAG(FLAG)                                                                \
	(((FLAG) == SAI_FLAG_OVRUDR) || ((FLAG) == SAI_FLAG_MUTEDET) ||                            \
	 ((FLAG) == SAI_FLAG_WCKCFG) || ((FLAG) == SAI_FLAG_FREQ) || ((FLAG) == SAI_FLAG_CNRDY) || \
	 ((FLAG) == SAI_FLAG_AFSDET) || ((FLAG) == SAI_FLAG_LFSDET))
...
#define IS_SAI_BLOCK_FIFO_STATUS(STATUS)                                                           \
	(((STATUS) == SAI_FIFOStatus_Less1QuarterFull) || ((STATUS) == SAI_FIFOStatus_HalfFull) || \
	 ...
	 ((STATUS) == SAI_FIFOStatus_3QuartersFull) || ((STATUS) == SAI_FIFOStatus_Full) ||        \
