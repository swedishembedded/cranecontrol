...
struct regmap_range_ops {
	ssize_t (*read)(regmap_range_t range, uint32_t id, regmap_value_type_t type, void *value,
			size_t size);
	ssize_t (*write)(regmap_range_t range, uint32_t id, regmap_value_type_t type,
...
struct regmap_device_ops {
	...
	int (*read)(regmap_device_t dev, uint32_t id, regmap_value_type_t get_as, void *value,
		    size_t value_size);
	int (*write)(regmap_device_t dev, uint32_t id, regmap_value_type_t set_from,
		     const void *value, size_t size);
};
...
int regmap_write_mem(struct regmap *self, uint32_t id, regmap_value_type_t set_from,
		     const void *value, size_t size);
int regmap_write_u8(struct regmap *self, uint32_t id, uint8_t value);
int regmap_write_i8(struct regmap *self, uint32_t id, int8_t value);
int regmap_write_u16(struct regmap *self, uint32_t id, uint16_t value);
int regmap_write_i16(struct regmap *self, uint32_t id, int16_t value);
int regmap_write_u32(struct regmap *self, uint32_t id, uint32_t value);
int regmap_write_i32(struct regmap *self, uint32_t id, int32_t value);
int regmap_write_string(struct regmap *self, uint32_t id, const char *str, size_t len);

int regmap_read_u32(struct regmap *self, uint32_t id, uint32_t *value);
int regmap_read_i32(struct regmap *self, uint32_t id, int32_t *value);
int regmap_read_u16(struct regmap *self, uint32_t id, uint16_t *value);
int regmap_read_i16(struct regmap *self, uint32_t id, int16_t *value);
int regmap_read_u8(struct regmap *self, uint32_t id, uint8_t *value);
int regmap_read_i8(struct regmap *self, uint32_t id, int8_t *value);
int regmap_read_string(struct regmap *self, uint32_t id, char *value, size_t max_len);
