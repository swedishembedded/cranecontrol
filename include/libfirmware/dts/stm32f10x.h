...
#define TIM1_TRG_COM_TIM11_IRQn                                                                    \
...
#define TIM8_TRG_COM_TIM14_IRQn                                                                    \
...
#define RCC_CFGR_PLLSRC_HSI_Div2                                                                   \
	(0x00000000) /*!< HSI clock divided by 2 selected as PLL entry clock source */
#define RCC_CFGR_PLLSRC_PREDIV1                                                                    \
	(0x00010000) /*!< PREDIV1 clock selected as PLL entry clock source */
...
#define RCC_CFGR_MCO_Ext_HSE                                                                       \
	(0x0A000000) /*!< XT1 external 3-25 MHz oscillator clock selected as MCO source */
...
#define RCC_BDCR_RTCSEL_HSE                                                                        \
	(0x00000300) /*!< HSE oscillator clock divided by 128 used as RTC clock */
...
#define AFIO_MAPR_USART3_REMAP_NOREMAP                                                             \
	(0x00000000) /*!< No remap (TX/PB10, RX/PB11, CK/PB12, CTS/PB13, RTS/PB14) */
#define AFIO_MAPR_USART3_REMAP_PARTIALREMAP                                                        \
	(0x00000010) /*!< Partial remap (TX/PC10, RX/PC11, CK/PC12, CTS/PB13, RTS/PB14) */
#define AFIO_MAPR_USART3_REMAP_FULLREMAP                                                           \
	(0x00000030) /*!< Full remap (TX/PD8, RX/PD9, CK/PD10, CTS/PD11, RTS/PD12) */
...
#define AFIO_MAPR_TIM1_REMAP_NOREMAP                                                               \
	(0x00000000) /*!< No remap (ETR/PA12, CH1/PA8, CH2/PA9, CH3/PA10, CH4/PA11, BKIN/PB12, CH1N/PB13, CH2N/PB14, CH3N/PB15) */
#define AFIO_MAPR_TIM1_REMAP_PARTIALREMAP                                                          \
	(0x00000040) /*!< Partial remap (ETR/PA12, CH1/PA8, CH2/PA9, CH3/PA10, CH4/PA11, BKIN/PA6, CH1N/PA7, CH2N/PB0, CH3N/PB1) */
#define AFIO_MAPR_TIM1_REMAP_FULLREMAP                                                             \
	(0x000000C0) /*!< Full remap (ETR/PE7, CH1/PE9, CH2/PE11, CH3/PE13, CH4/PE14, BKIN/PE15, CH1N/PE8, CH2N/PE10, CH3N/PE12) */
...
#define AFIO_MAPR_TIM2_REMAP_NOREMAP                                                               \
	(0x00000000) /*!< No remap (CH1/ETR/PA0, CH2/PA1, CH3/PA2, CH4/PA3) */
#define AFIO_MAPR_TIM2_REMAP_PARTIALREMAP1                                                         \
	(0x00000100) /*!< Partial remap (CH1/ETR/PA15, CH2/PB3, CH3/PA2, CH4/PA3) */
#define AFIO_MAPR_TIM2_REMAP_PARTIALREMAP2                                                         \
	(0x00000200) /*!< Partial remap (CH1/ETR/PA0, CH2/PA1, CH3/PB10, CH4/PB11) */
#define AFIO_MAPR_TIM2_REMAP_FULLREMAP                                                             \
	(0x00000300) /*!< Full remap (CH1/ETR/PA15, CH2/PB3, CH3/PB10, CH4/PB11) */
...
#define AFIO_MAPR_TIM3_REMAP_NOREMAP                                                               \
	(0x00000000) /*!< No remap (CH1/PA6, CH2/PA7, CH3/PB0, CH4/PB1) */
#define AFIO_MAPR_TIM3_REMAP_PARTIALREMAP                                                          \
	(0x00000800) /*!< Partial remap (CH1/PB4, CH2/PB5, CH3/PB0, CH4/PB1) */
#define AFIO_MAPR_TIM3_REMAP_FULLREMAP                                                             \
	(0x00000C00) /*!< Full remap (CH1/PC6, CH2/PC7, CH3/PC8, CH4/PC9) */

#define AFIO_MAPR_TIM4_REMAP (0x00001000) /*!< TIM4_REMAP bit (TIM4 remapping) */

#define AFIO_MAPR_CAN_REMAP                                                                        \
	(0x00006000) /*!< CAN_REMAP[1:0] bits (CAN Alternate function remapping) */
...
#define AFIO_MAPR_ADC1_ETRGINJ_REMAP                                                               \
	(0x00020000) /*!< ADC 1 External Trigger Injected Conversion remapping */
#define AFIO_MAPR_ADC1_ETRGREG_REMAP                                                               \
	(0x00040000) /*!< ADC 1 External Trigger Regular Conversion remapping */
#define AFIO_MAPR_ADC2_ETRGINJ_REMAP                                                               \
	(0x00080000) /*!< ADC 2 External Trigger Injected Conversion remapping */
#define AFIO_MAPR_ADC2_ETRGREG_REMAP                                                               \
	(0x00100000) /*!< ADC 2 External Trigger Regular Conversion remapping */
...
#define AFIO_MAPR_SWJ_CFG_NOJNTRST                                                                 \
	(0x01000000) /*!< Full SWJ (JTAG-DP + SW-DP) but without JNTRST */
...
#define AFIO_MAPR_MII_RMII_SEL                                                                     \
	(0x00800000) /*!< MII_RMII_SEL bit (Ethernet MII or RMII selection) */
...
#define AFIO_MAPR_TIM2ITR1_IREMAP                                                                  \
	(0x20000000) /*!< TIM2ITR1_IREMAP bit (TIM2 internal trigger 1 remapping) */
...
#define SysTick_LOAD_RELOAD                                                                        \
	(0x00FFFFFF) /*!< Value to load into the SysTick Current Value Register when the counter reaches 0 */
...
#define SCB_ICSR_RETTOBASE                                                                         \
	(0x00000800) /*!< All active exceptions minus the IPSR_current_exception yields the empty set */
...
#define SCB_ICSR_ISRPREEMPT                                                                        \
	(0x00800000) /*!< It indicates that a pending interrupt becomes active in the next running cycle */
...
#define SCB_AIRCR_PRIGROUP0                                                                        \
	(0x00000000) /*!< Priority group=0 (7 bits of pre-emption priority, 1 bit of subpriority) */
#define SCB_AIRCR_PRIGROUP1                                                                        \
	(0x00000100) /*!< Priority group=1 (6 bits of pre-emption priority, 2 bits of subpriority) */
#define SCB_AIRCR_PRIGROUP2                                                                        \
	(0x00000200) /*!< Priority group=2 (5 bits of pre-emption priority, 3 bits of subpriority) */
#define SCB_AIRCR_PRIGROUP3                                                                        \
	(0x00000300) /*!< Priority group=3 (4 bits of pre-emption priority, 4 bits of subpriority) */
#define SCB_AIRCR_PRIGROUP4                                                                        \
	(0x00000400) /*!< Priority group=4 (3 bits of pre-emption priority, 5 bits of subpriority) */
#define SCB_AIRCR_PRIGROUP5                                                                        \
	(0x00000500) /*!< Priority group=5 (2 bits of pre-emption priority, 6 bits of subpriority) */
#define SCB_AIRCR_PRIGROUP6                                                                        \
	(0x00000600) /*!< Priority group=6 (1 bit of pre-emption priority, 7 bits of subpriority) */
#define SCB_AIRCR_PRIGROUP7                                                                        \
	(0x00000700) /*!< Priority group=7 (no pre-emption priority, 8 bits of subpriority) */

#define SCB_AIRCR_ENDIANESS (0x00008000) /*!< Data endianness bit */
#define SCB_AIRCR_VECTKEY                                                                          \
	(0xFFFF0000) /*!< Register key (VECTKEY) - Reads as 0xFA05 (VECTKEYSTAT) */
...
#define SCB_CCR_NONBASETHRDENA                                                                     \
	(0x0001) /*!< Thread mode can be entered from any level in Handler mode by controlled return value */
#define SCB_CCR_USERSETMPEND                                                                       \
	(0x0002) /*!< Enables user code to write the Software Trigger Interrupt register to trigger (pend) a Main exception */
...
#define SCB_CCR_STKALIGN                                                                           \
	(0x0200) /*!< On exception entry, the SP used prior to the exception is adjusted to be 8-byte aligned */

/*******************  Bit definition for SCB_SHPR register ********************/
#define SCB_SHPR_PRI_N                                                                             \
	(0x000000FF) /*!< Priority of system handler 4,8, and 12. Mem Manage, reserved and Debug Monitor */
#define SCB_SHPR_PRI_N1                                                                            \
	(0x0000FF00) /*!< Priority of system handler 5,9, and 13. Bus Fault, reserved and reserved */
#define SCB_SHPR_PRI_N2                                                                            \
	(0x00FF0000) /*!< Priority of system handler 6,10, and 14. Usage Fault, reserved and PendSV */
#define SCB_SHPR_PRI_N3                                                                            \
	(0xFF000000) /*!< Priority of system handler 7,11, and 15. Reserved, SVCall and SysTick */
...
#define SCB_CFSR_UNDEFINSTR                                                                        \
	(0x00010000) /*!< The processor attempt to execute an undefined instruction */
...
#define SCB_CFSR_UNALIGNED                                                                         \
	(0x01000000) /*!< Fault occurs when there is an attempt to make an unaligned memory access */
#define SCB_CFSR_DIVBYZERO                                                                         \
	(0x02000000) /*!< Fault occurs when SDIV or DIV instruction is used with a divisor of 0 */

/*******************  Bit definition for SCB_HFSR register  *******************/
#define SCB_HFSR_VECTTBL                                                                           \
	(0x00000002) /*!< Fault occurs because of vector table read on exception processing */
#define SCB_HFSR_FORCED                                                                            \
	(0x40000000) /*!< Hard Fault activated when a configurable Fault was received and cannot activate */
...
#define ADC_CR2_JEXTSEL                                                                            \
	(0x00007000) /*!< JEXTSEL[2:0] bits (External event select for injected group) */
...
#define ADC_CR2_EXTSEL                                                                             \
	(0x000E0000) /*!< EXTSEL[2:0] bits (External Event Select for regular group) */
...
#define DAC_CR_WAVE1                                                                               \
	(0x000000C0) /*!< WAVE1[1:0] (DAC channel1 noise/triangle wave generation enable) */
...
#define DAC_CR_WAVE2                                                                               \
	(0x00C00000) /*!< WAVE2[1:0] (DAC channel2 noise/triangle wave generation enable) */
...
#define FSMC_PATT2_ATTHIZ2                                                                         \
	(0xFF000000) /*!< ATTHIZ2[7:0] bits (Attribute memory 2 databus HiZ time) */
...
#define FSMC_PATT3_ATTHIZ3                                                                         \
	(0xFF000000) /*!< ATTHIZ3[7:0] bits (Attribute memory 3 databus HiZ time) */
...
#define FSMC_PATT4_ATTHIZ4                                                                         \
	(0xFF000000) /*!< ATTHIZ4[7:0] bits (Attribute memory 4 databus HiZ time) */
...
#define SDIO_CMD_WAITPEND                                                                          \
	(0x0200) /*!< CPSM Waits for ends of data transfer (CmdPend internal signal) */
...
#define SDIO_STA_STBITERR                                                                          \
	(0x00000200) /*!< Start bit not detected on all data signals in wide bus mode */
...
#define SDIO_STA_TXFIFOHE                                                                          \
	(0x00004000) /*!< Transmit FIFO Half Empty: at least 8 words can be written into the FIFO */
#define SDIO_STA_RXFIFOHF                                                                          \
	(0x00008000) /*!< Receive FIFO Half Full: there are at least 8 words in the FIFO */
...
#define SDIO_MASK_CEATAENDIE                                                                       \
	(0x00800000) /*!< CE-ATA command completion signal received Interrupt Enable */

/*****************  Bit definition for SDIO_FIFOCNT register  *****************/
#define SDIO_FIFOCNT_FIFOCOUNT                                                                     \
	(0x00FFFFFF) /*!< Remaining number of words to be written to or read from the FIFO */
...
#define USB_EP0R_STAT_TX                                                                           \
	(0x0030) /*!< STAT_TX[1:0] bits (Status bits, for transmission transfers) */
...
#define USB_COUNT0_RX_0_NUM_BLOCK_0                                                                \
	(0x00007C00) /*!< NUM_BLOCK_0[4:0] bits (Number of blocks) (low) */
...
#define USB_COUNT0_RX_1_NUM_BLOCK_1                                                                \
	(0x7C000000) /*!< NUM_BLOCK_1[4:0] bits (Number of blocks) (high) */
...
#define DBGMCU_CR_TRACE_MODE                                                                       \
	(0x000000C0) /*!< TRACE_MODE[1:0] bits (Trace Pin Assignment Control) */
...
#define DBGMCU_CR_DBG_IWDG_STOP                                                                    \
	(0x00000100) /*!< Debug Independent Watchdog stopped when Core is halted */
#define DBGMCU_CR_DBG_WWDG_STOP                                                                    \
	(0x00000200) /*!< Debug Window Watchdog stopped when Core is halted */
...
#define DBGMCU_CR_DBG_I2C1_SMBUS_TIMEOUT                                                           \
	(0x00008000) /*!< SMBUS timeout mode stopped when Core is halted */
#define DBGMCU_CR_DBG_I2C2_SMBUS_TIMEOUT                                                           \
	(0x00010000) /*!< SMBUS timeout mode stopped when Core is halted */
...
#define FLASH_WRP0_nWRP0                                                                           \
	(0x0000FF00) /*!< Flash memory write protection complemented option bytes */

/******************  Bit definition for FLASH_WRP1 register  ******************/
#define FLASH_WRP1_WRP1 (0x00FF0000) /*!< Flash memory write protection option bytes */
#define FLASH_WRP1_nWRP1                                                                           \
	(0xFF000000) /*!< Flash memory write protection complemented option bytes */
...
#define ETH_MACCR_IFG_96Bit                                                                        \
	(0x00000000) /* Minimum IFG between frames during transmission is 96Bit */
#define ETH_MACCR_IFG_88Bit                                                                        \
	(0x00020000) /* Minimum IFG between frames during transmission is 88Bit */
#define ETH_MACCR_IFG_80Bit                                                                        \
	(0x00040000) /* Minimum IFG between frames during transmission is 80Bit */
#define ETH_MACCR_IFG_72Bit                                                                        \
	(0x00060000) /* Minimum IFG between frames during transmission is 72Bit */
#define ETH_MACCR_IFG_64Bit                                                                        \
	(0x00080000) /* Minimum IFG between frames during transmission is 64Bit */
#define ETH_MACCR_IFG_56Bit                                                                        \
	(0x000A0000) /* Minimum IFG between frames during transmission is 56Bit */
#define ETH_MACCR_IFG_48Bit                                                                        \
	(0x000C0000) /* Minimum IFG between frames during transmission is 48Bit */
#define ETH_MACCR_IFG_40Bit                                                                        \
	(0x000E0000) /* Minimum IFG between frames during transmission is 40Bit */
...
#define ETH_MACCR_BL                                                                               \
	(0x00000060) /* Back-off limit: random integer number (r) of slot time delays before rescheduling
...
#define ETH_MACFFR_PCF_BlockAll                                                                    \
	(0x00000040) /* MAC filters all control frames from reaching the application */
#define ETH_MACFFR_PCF_ForwardAll                                                                  \
	(0x00000080) /* MAC forwards all control frames to application even if they fail the Address Filter */
#define ETH_MACFFR_PCF_ForwardPassedAddrFilter                                                     \
	(0x000000C0) /* MAC forwards control frames that pass the Address Filter. */
...
#define ETH_MACA1HR_MBC                                                                            \
	(0x3F000000) /* Mask byte control: bits to mask for comparison of the MAC Address bytes */
...
#define ETH_MMCRIR_RGUFS                                                                           \
	(0x00020000) /* Set when Rx good unicast frames counter reaches half the maximum value */
#define ETH_MMCRIR_RFAES                                                                           \
	(0x00000040) /* Set when Rx alignment error counter reaches half the maximum value */
#define ETH_MMCRIR_RFCES                                                                           \
	(0x00000020) /* Set when Rx crc error counter reaches half the maximum value */

/* Bit definition for Ethernet MMC Transmit Interrupt Register */
#define ETH_MMCTIR_TGFS                                                                            \
	(0x00200000) /* Set when Tx good frame count counter reaches half the maximum value */
#define ETH_MMCTIR_TGFMSCS                                                                         \
	(0x00008000) /* Set when Tx good multi col counter reaches half the maximum value */
#define ETH_MMCTIR_TGFSCS                                                                          \
	(0x00004000) /* Set when Tx good single col counter reaches half the maximum value */

/* Bit definition for Ethernet MMC Receive Interrupt Mask Register */
#define ETH_MMCRIMR_RGUFM                                                                          \
	(0x00020000) /* Mask the interrupt when Rx good unicast frames counter reaches half the maximum value */
#define ETH_MMCRIMR_RFAEM                                                                          \
	(0x00000040) /* Mask the interrupt when when Rx alignment error counter reaches half the maximum value */
#define ETH_MMCRIMR_RFCEM                                                                          \
	(0x00000020) /* Mask the interrupt when Rx crc error counter reaches half the maximum value */

/* Bit definition for Ethernet MMC Transmit Interrupt Mask Register */
#define ETH_MMCTIMR_TGFM                                                                           \
	(0x00200000) /* Mask the interrupt when Tx good frame count counter reaches half the maximum value */
#define ETH_MMCTIMR_TGFMSCM                                                                        \
	(0x00008000) /* Mask the interrupt when Tx good multi col counter reaches half the maximum value */
#define ETH_MMCTIMR_TGFSCM                                                                         \
	(0x00004000) /* Mask the interrupt when Tx good single col counter reaches half the maximum value */

/* Bit definition for Ethernet MMC Transmitted Good Frames after Single Collision Counter Register */
#define ETH_MMCTGFSCCR_TGFSCC                                                                      \
	(0xFFFFFFFF) /* Number of successfully transmitted frames after a single collision in Half-duplex mode. */

/* Bit definition for Ethernet MMC Transmitted Good Frames after More than a Single Collision Counter Register */
#define ETH_MMCTGFMSCCR_TGFMSCC                                                                    \
	(0xFFFFFFFF) /* Number of successfully transmitted frames after more than a single collision in Half-duplex mode. */
...
#define ETH_MMCRFAECR_RFAEC                                                                        \
	(0xFFFFFFFF) /* Number of frames received with alignment (dribble) error */
...
#define ETH_DMABMR_RDP_1Beat                                                                       \
	(0x00020000) /* maximum number of beats to be transferred in one RxDMA transaction is 1 */
#define ETH_DMABMR_RDP_2Beat                                                                       \
	(0x00040000) /* maximum number of beats to be transferred in one RxDMA transaction is 2 */
#define ETH_DMABMR_RDP_4Beat                                                                       \
	(0x00080000) /* maximum number of beats to be transferred in one RxDMA transaction is 4 */
#define ETH_DMABMR_RDP_8Beat                                                                       \
	(0x00100000) /* maximum number of beats to be transferred in one RxDMA transaction is 8 */
#define ETH_DMABMR_RDP_16Beat                                                                      \
	(0x00200000) /* maximum number of beats to be transferred in one RxDMA transaction is 16 */
#define ETH_DMABMR_RDP_32Beat                                                                      \
	(0x00400000) /* maximum number of beats to be transferred in one RxDMA transaction is 32 */
#define ETH_DMABMR_RDP_4xPBL_4Beat                                                                 \
	(0x01020000) /* maximum number of beats to be transferred in one RxDMA transaction is 4 */
#define ETH_DMABMR_RDP_4xPBL_8Beat                                                                 \
	(0x01040000) /* maximum number of beats to be transferred in one RxDMA transaction is 8 */
#define ETH_DMABMR_RDP_4xPBL_16Beat                                                                \
	(0x01080000) /* maximum number of beats to be transferred in one RxDMA transaction is 16 */
#define ETH_DMABMR_RDP_4xPBL_32Beat                                                                \
	(0x01100000) /* maximum number of beats to be transferred in one RxDMA transaction is 32 */
#define ETH_DMABMR_RDP_4xPBL_64Beat                                                                \
	(0x01200000) /* maximum number of beats to be transferred in one RxDMA transaction is 64 */
#define ETH_DMABMR_RDP_4xPBL_128Beat                                                               \
	(0x01400000) /* maximum number of beats to be transferred in one RxDMA transaction is 128 */
...
#define ETH_DMABMR_PBL_1Beat                                                                       \
	(0x00000100) /* maximum number of beats to be transferred in one TxDMA (or both) transaction is 1 */
#define ETH_DMABMR_PBL_2Beat                                                                       \
	(0x00000200) /* maximum number of beats to be transferred in one TxDMA (or both) transaction is 2 */
#define ETH_DMABMR_PBL_4Beat                                                                       \
	(0x00000400) /* maximum number of beats to be transferred in one TxDMA (or both) transaction is 4 */
#define ETH_DMABMR_PBL_8Beat                                                                       \
	(0x00000800) /* maximum number of beats to be transferred in one TxDMA (or both) transaction is 8 */
#define ETH_DMABMR_PBL_16Beat                                                                      \
	(0x00001000) /* maximum number of beats to be transferred in one TxDMA (or both) transaction is 16 */
#define ETH_DMABMR_PBL_32Beat                                                                      \
	(0x00002000) /* maximum number of beats to be transferred in one TxDMA (or both) transaction is 32 */
#define ETH_DMABMR_PBL_4xPBL_4Beat                                                                 \
	(0x01000100) /* maximum number of beats to be transferred in one TxDMA (or both) transaction is 4 */
#define ETH_DMABMR_PBL_4xPBL_8Beat                                                                 \
	(0x01000200) /* maximum number of beats to be transferred in one TxDMA (or both) transaction is 8 */
#define ETH_DMABMR_PBL_4xPBL_16Beat                                                                \
	(0x01000400) /* maximum number of beats to be transferred in one TxDMA (or both) transaction is 16 */
#define ETH_DMABMR_PBL_4xPBL_32Beat                                                                \
	(0x01000800) /* maximum number of beats to be transferred in one TxDMA (or both) transaction is 32 */
#define ETH_DMABMR_PBL_4xPBL_64Beat                                                                \
	(0x01001000) /* maximum number of beats to be transferred in one TxDMA (or both) transaction is 64 */
#define ETH_DMABMR_PBL_4xPBL_128Beat                                                               \
	(0x01002000) /* maximum number of beats to be transferred in one TxDMA (or both) transaction is 128 */
...
#define ETH_DMAOMR_TTC_64Bytes                                                                     \
	(0x00000000) /* threshold level of the MTL Transmit FIFO is 64 Bytes */
#define ETH_DMAOMR_TTC_128Bytes                                                                    \
	(0x00004000) /* threshold level of the MTL Transmit FIFO is 128 Bytes */
#define ETH_DMAOMR_TTC_192Bytes                                                                    \
	(0x00008000) /* threshold level of the MTL Transmit FIFO is 192 Bytes */
#define ETH_DMAOMR_TTC_256Bytes                                                                    \
	(0x0000C000) /* threshold level of the MTL Transmit FIFO is 256 Bytes */
#define ETH_DMAOMR_TTC_40Bytes                                                                     \
	(0x00010000) /* threshold level of the MTL Transmit FIFO is 40 Bytes */
#define ETH_DMAOMR_TTC_32Bytes                                                                     \
	(0x00014000) /* threshold level of the MTL Transmit FIFO is 32 Bytes */
#define ETH_DMAOMR_TTC_24Bytes                                                                     \
	(0x00018000) /* threshold level of the MTL Transmit FIFO is 24 Bytes */
#define ETH_DMAOMR_TTC_16Bytes                                                                     \
	(0x0001C000) /* threshold level of the MTL Transmit FIFO is 16 Bytes */
...
#define ETH_DMAOMR_RTC_64Bytes                                                                     \
	(0x00000000) /* threshold level of the MTL Receive FIFO is 64 Bytes */
#define ETH_DMAOMR_RTC_32Bytes                                                                     \
	(0x00000008) /* threshold level of the MTL Receive FIFO is 32 Bytes */
#define ETH_DMAOMR_RTC_96Bytes                                                                     \
	(0x00000010) /* threshold level of the MTL Receive FIFO is 96 Bytes */
#define ETH_DMAOMR_RTC_128Bytes                                                                    \
	(0x00000018) /* threshold level of the MTL Receive FIFO is 128 Bytes */
