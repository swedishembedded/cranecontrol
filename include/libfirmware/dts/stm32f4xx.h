...
/** @addtogroup Peripheral_memory_map
  ...
  */
#define FLASH                                                                                      \
	(0x08000000) /*!< FLASH(up to 1 MB) base address in the alias region                         */
#define CCMDATARAM                                                                                 \
	(0x10000000) /*!< CCM(core coupled memory) data RAM(64 KB) base address in the alias region  */
#define SRAM1                                                                                      \
	(0x20000000) /*!< SRAM1(112 KB) base address in the alias region                             */
#define SRAM2                                                                                      \
	(0x2001C000) /*!< SRAM2(16 KB) base address in the alias region                              */
#define SRAM3                                                                                      \
	(0x20020000) /*!< SRAM3(64 KB) base address in the alias region                              */
#define PERIPH                                                                                     \
	(0x40000000) /*!< Peripheral base address in the alias region                                */
#define BKPSRAM                                                                                    \
	(0x40024000) /*!< Backup SRAM(4 KB) base address in the alias region                         */

#if defined(STM32F40_41xxx)
#define FSMC_R                                                                                     \
	(0xA0000000) /*!< FSMC registers base address                                                */
#endif /* STM32F40_41xxx */

#if defined(STM32F427_437xx) || defined(STM32F429_439xx)
#define FMC_R                                                                                      \
	(0xA0000000) /*!< FMC registers base address                                                 */
#endif /* STM32F427_437xx ||  STM32F429_439xx */

#define CCMDATARAM_BB                                                                              \
	(0x12000000) /*!< CCM(core coupled memory) data RAM(64 KB) base address in the bit-band region  */
#define SRAM1_BB                                                                                   \
	(0x22000000) /*!< SRAM1(112 KB) base address in the bit-band region                             */
#define SRAM2_BB                                                                                   \
	(0x2201C000) /*!< SRAM2(16 KB) base address in the bit-band region                              */
#define SRAM3_BB                                                                                   \
	(0x22400000) /*!< SRAM3(64 KB) base address in the bit-band region                              */
#define PERIPH_BB                                                                                  \
	(0x42000000) /*!< Peripheral base address in the bit-band region                                */
#define BKPSRAM_BB                                                                                 \
...
#define TIM1_BRK_TIM9_IRQn                                                                         \
	24 /*!< TIM1 Break interrupt and TIM9 global interrupt                    */
#define TIM1_UP_TIM10_IRQn                                                                         \
...
#define TIM8_BRK_TIM12_IRQn                                                                        \
	43 /*!< TIM8 Break Interrupt and TIM12 global interrupt                   */
#define TIM8_UP_TIM13_IRQn                                                                         \
...
#define DMA2_Stream5_IRQn                                                                          \
	68 /*!< DMA2 Stream 5 global interrupt                                    */
#define DMA2_Stream6_IRQn                                                                          \
	69 /*!< DMA2 Stream 6 global interrupt                                    */
#define DMA2_Stream7_IRQn                                                                          \
...
#define OTG_HS_EP1_OUT_IRQn                                                                        \
	74 /*!< USB OTG HS End Point 1 Out global interrupt                       */
#define OTG_HS_EP1_IN_IRQn                                                                         \
