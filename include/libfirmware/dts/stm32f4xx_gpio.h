...
#define GPIO_AF_TAMPER                                                                             \
	(GPIO_Mode_AF | 0x00) /* TAMPER (TAMPER_1 and TAMPER_2) Alternate Function mapping */
...
#define GPIO_AF9_I2C2                                                                              \
	(GPIO_Mode_AF | 0x09) /* I2C2 Alternate Function mapping (Only for STM32F401xx Devices) */
#define GPIO_AF9_I2C3                                                                              \
	(GPIO_Mode_AF | 0x09) /* I2C3 Alternate Function mapping (Only for STM32F401xx Devices) */
...
#define GPIO_AF_OTG_HS_FS                                                                          \
	(GPIO_Mode_AF | 0xC) /* OTG HS configured in FS, Alternate Function mapping */
