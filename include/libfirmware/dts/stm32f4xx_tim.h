...
#define TIM_ICSelection_DirectTI                                                                   \
	(0x0001) /*!< TIM Input 1, 2, 3 or 4 is selected to be 
                                                                   connected to IC1, IC2, IC3 or IC4, respectively */
#define TIM_ICSelection_IndirectTI                                                                 \
	(0x0002) /*!< TIM Input 1, 2, 3 or 4 is selected to be
                                                                   connected to IC2, IC1, IC4 or IC3, respectively. */
#define TIM_ICSelection_TRC                                                                        \
	(0x0003) /*!< TIM Input 1, 2, 3 or 4 is selected to be connected to TRC. */

#define TIM_ICPSC_DIV1                                                                             \
	(0x0000) /*!< Capture performed each time an edge is detected on the capture input. */
...
#define TIM_UpdateSource_Global                                                                    \
	(0x0000) /*!< Source of update is the counter overflow/underflow
