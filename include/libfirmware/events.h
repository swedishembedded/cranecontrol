...
#define events_subscribe(dev, ev, sub)                                                             \
	do {                                                                                       \
		if (dev)                                                                           \
			(*(dev))->subscribe(dev, ev, sub);                                         \
	} while (0)
#define events_publish(dev, ev)                                                                    \
	do {                                                                                       \
		if (dev)                                                                           \
			(*(dev))->publish(dev, ev);                                                \
	} while (0);
#define events_publish_from_isr(dev, ev, wake)                                                     \
	do {                                                                                       \
		if (dev)                                                                           \
			(*(dev))->publish_from_isr(dev, ev, wake);                                 \
	} while (0);
