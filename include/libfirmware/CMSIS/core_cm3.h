...
typedef struct {
	...
	__I uint32_t MMFR
		[4]; /*!< Offset: 0x050 (R/ )  Memory Model Feature Register                         */
	__I uint32_t ISAR
		[5]; /*!< Offset: 0x060 (R/ )  Instruction Set Attributes Register                   */
...
#define SCB_CFSR_MEMFAULTSR_Msk                                                                    \
	(0xFFUL                                                                                    \
	 << SCB_CFSR_MEMFAULTSR_Pos) /*!< SCB CFSR: Memory Manage Fault Status Register Mask */
...
__STATIC_INLINE void NVIC_EnableIRQ(IRQn_Type IRQn)
{
	NVIC->ISER[((uint32_t)(IRQn) >> 5)] =
		(1U << ((uint32_t)(IRQn)&0x1F)); /* enable interrupt */
}
...
__STATIC_INLINE void NVIC_DisableIRQ(IRQn_Type IRQn)
{
	NVIC->ICER[((uint32_t)(IRQn) >> 5)] =
		(1U << ((uint32_t)(IRQn)&0x1F)); /* disable interrupt */
}
...
{
	return ((uint32_t)((NVIC->ISPR[(uint32_t)(IRQn) >> 5] & (1U << ((uint32_t)(IRQn)&0x1F))) ?
				   1 :
...
__STATIC_INLINE void NVIC_SetPendingIRQ(IRQn_Type IRQn)
{
	NVIC->ISPR[((uint32_t)(IRQn) >> 5)] =
		(1U << ((uint32_t)(IRQn)&0x1F)); /* set interrupt pending */
}
...
__STATIC_INLINE void NVIC_ClearPendingIRQ(IRQn_Type IRQn)
{
	NVIC->ICPR[((uint32_t)(IRQn) >> 5)] =
		(1U << ((uint32_t)(IRQn)&0x1F)); /* Clear pending interrupt */
}
...
{
	return ((uint32_t)((NVIC->IABR[(uint32_t)(IRQn) >> 5] & (1U << ((uint32_t)(IRQn)&0x1F))) ?
				   1 :
					     ...
					     uint32_t SubPriority)
{
	...
	return (((PreemptPriority & ((1U << (PreemptPriorityBits)) - 1)) << SubPriorityBits) |
