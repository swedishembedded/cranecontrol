...
QDEF(MP_QSTR_fb, (const byte*)"\x41\x02" "fb")
QDEF(MP_QSTR_readswitch, (const byte*)"\x45\x0a" "readswitch")
...
QDEF(MP_QSTR_MSC_plus_HID, (const byte*)"\x27\x0c" "MSC_plus_HID")
...
QDEF(MP_QSTR_VCP_plus_MSC, (const byte*)"\x67\x0c" "VCP_plus_MSC")
...
QDEF(MP_QSTR__slash_flash, (const byte*)"\x50\x0c" "_slash_flash")
QDEF(MP_QSTR__slash_flash_slash_lib, (const byte*)"\x92\x16" "_slash_flash_slash_lib")
QDEF(MP_QSTR__slash_sd, (const byte*)"\xb7\x09" "_slash_sd")
QDEF(MP_QSTR__slash_sd_slash_lib, (const byte*)"\x75\x13" "_slash_sd_slash_lib")
