...
# 1 "<stdin>"
# 29 "<stdin>"
# 1 "include/py/mpconfig.h" 1
# 62 "include/py/mpconfig.h"
# 1 "include/py/mpconfigport.h" 1
...
# 2 "include/py/mpconfigport.h" 2

# 1 "include/libfirmware/driver.h" 1

# 21 "include/libfirmware/driver.h"
...
# 22 "include/libfirmware/driver.h" 2
# 1 "include/libfdt/libfdt.h" 1
# 54 "include/libfdt/libfdt.h"
# 1 "include/libfdt/libfdt_env.h" 1
# 55 "include/libfdt/libfdt_env.h"
...
# 56 "include/libfdt/libfdt_env.h" 2
...
__attribute__((__pure__)) __attribute__((__nonnull__(1))) __attribute__((__warn_unused_result__));
...
extern char *__realpath_chk(const char *__restrict __name, char *__restrict __resolved,
			    size_t __resolvedlen) __attribute__((__nothrow__, __leaf__))
__attribute__((__warn_unused_result__));
extern char *__realpath_alias(const char *__restrict __name,
	...
	__attribute__((__warn_unused_result__));
extern char *__realpath_chk_warn(const char *__restrict __name, char *__restrict __resolved,
...
extern __inline __attribute__((__always_inline__)) __attribute__((__gnu_inline__))
__attribute__((__artificial__))
__attribute__((__warn_unused_result__)) char *__attribute__((__nothrow__, __leaf__))
...
extern __inline __attribute__((__always_inline__)) __attribute__((__gnu_inline__))
__attribute__((__artificial__)) __attribute__((__warn_unused_result__)) int
...
extern size_t __mbstowcs_chk(wchar_t *__restrict __dst, const char *__restrict __src, size_t __len,
			     size_t __dstlen) __attribute__((__nothrow__, __leaf__));
extern size_t __mbstowcs_alias(wchar_t *__restrict __dst, const char *__restrict __src,
			       size_t __len) __asm__(""
						     "mbstowcs")
	__attribute__((__nothrow__, __leaf__))

	;
extern size_t __mbstowcs_chk_warn(wchar_t *__restrict __dst, const char *__restrict __src,
				  size_t __len, size_t __dstlen) __asm__(""
									 "__mbstowcs_chk")
	__attribute__((__nothrow__, __leaf__))
...
extern size_t __wcstombs_chk(char *__restrict __dst, const wchar_t *__restrict __src, size_t __len,
			     size_t __dstlen) __attribute__((__nothrow__, __leaf__));
extern size_t __wcstombs_alias(char *__restrict __dst, const wchar_t *__restrict __src,
			       size_t __len) __asm__(""
						     "wcstombs")
	__attribute__((__nothrow__, __leaf__))

	;
extern size_t __wcstombs_chk_warn(char *__restrict __dst, const wchar_t *__restrict __src,
				  size_t __len, size_t __dstlen) __asm__(""
									 "__wcstombs_chk")
	__attribute__((__nothrow__, __leaf__))
...
# 58 "include/libfdt/libfdt_env.h" 2
...
extern int strcmp(const char *__s1, const char *__s2) __attribute__((__nothrow__, __leaf__))
...
extern int strcoll(const char *__s1, const char *__s2) __attribute__((__nothrow__, __leaf__))
__attribute__((__pure__)) __attribute__((__nonnull__(1, 2)));

extern size_t strxfrm(char *__restrict __dest, const char *__restrict __src, size_t __n)
	__attribute__((__nothrow__, __leaf__)) __attribute__((__nonnull__(2)));
# 226 "/usr/include/string.h" 3 4
extern char *strchr(const char *__s, int __c) __attribute__((__nothrow__, __leaf__))
__attribute__((__pure__)) __attribute__((__nonnull__(1)));
# 253 "/usr/include/string.h" 3 4
extern char *strrchr(const char *__s, int __c) __attribute__((__nothrow__, __leaf__))
__attribute__((__pure__)) __attribute__((__nonnull__(1)));
...
# 87 "/usr/include/bits/string_fortified.h" 3 4
extern __inline __attribute__((__always_inline__)) __attribute__((__gnu_inline__))
...
# 102 "/usr/include/bits/string_fortified.h" 3 4
extern __inline __attribute__((__always_inline__)) __attribute__((__gnu_inline__))
__attribute__((__artificial__)) char *__attribute__((__nothrow__, __leaf__))
...
extern char *__stpncpy_chk(char *__dest, const char *__src, size_t __n, size_t __destlen)
	__attribute__((__nothrow__, __leaf__));
extern char *__stpncpy_alias(char *__dest, const char *__src, size_t __n) __asm__(""
										  "stpncpy")
	__attribute__((__nothrow__, __leaf__));
...
# 59 "include/libfdt/libfdt_env.h" 2
# 68 "include/libfdt/libfdt_env.h"

# 68 "include/libfdt/libfdt_env.h"
typedef uint16_t fdt16_t;
typedef uint32_t fdt32_t;
typedef uint64_t fdt64_t;
# 81 "include/libfdt/libfdt_env.h"
...
# 55 "include/libfdt/libfdt.h" 2
# 1 "include/libfdt/fdt.h" 1
# 57 "include/libfdt/fdt.h"
struct fdt_header {
	fdt32_t magic;
	fdt32_t totalsize;
...
# 56 "include/libfdt/libfdt.h" 2
# 147 "include/libfdt/libfdt.h"
...
# 169 "include/libfdt/libfdt.h"
int fdt_first_subnode(const void *fdt, int offset);
# 182 "include/libfdt/libfdt.h"
int fdt_next_subnode(const void *fdt, int offset);
# 234 "include/libfdt/libfdt.h"
static inline __attribute__((always_inline)) void fdt_set_magic(void *fdt, uint32_t val)
{
	struct fdt_header *fdth = (struct fdt_header *)fdt;
	fdth->magic = cpu_to_fdt32(val);
}
static inline __attribute__((always_inline)) void fdt_set_totalsize(void *fdt, uint32_t val)
{
	struct fdt_header *fdth = (struct fdt_header *)fdt;
	fdth->totalsize = cpu_to_fdt32(val);
}
static inline __attribute__((always_inline)) void fdt_set_off_dt_struct(void *fdt, uint32_t val)
{
	struct fdt_header *fdth = (struct fdt_header *)fdt;
	fdth->off_dt_struct = cpu_to_fdt32(val);
}
static inline __attribute__((always_inline)) void fdt_set_off_dt_strings(void *fdt, uint32_t val)
{
	struct fdt_header *fdth = (struct fdt_header *)fdt;
	fdth->off_dt_strings = cpu_to_fdt32(val);
}
static inline __attribute__((always_inline)) void fdt_set_off_mem_rsvmap(void *fdt, uint32_t val)
{
	struct fdt_header *fdth = (struct fdt_header *)fdt;
	fdth->off_mem_rsvmap = cpu_to_fdt32(val);
}
static inline __attribute__((always_inline)) void fdt_set_version(void *fdt, uint32_t val)
{
	struct fdt_header *fdth = (struct fdt_header *)fdt;
	fdth->version = cpu_to_fdt32(val);
}
static inline __attribute__((always_inline)) void fdt_set_last_comp_version(void *fdt, uint32_t val)
{
	struct fdt_header *fdth = (struct fdt_header *)fdt;
	fdth->last_comp_version = cpu_to_fdt32(val);
}
static inline __attribute__((always_inline)) void fdt_set_boot_cpuid_phys(void *fdt, uint32_t val)
{
	struct fdt_header *fdth = (struct fdt_header *)fdt;
	fdth->boot_cpuid_phys = cpu_to_fdt32(val);
}
static inline __attribute__((always_inline)) void fdt_set_size_dt_strings(void *fdt, uint32_t val)
{
	struct fdt_header *fdth = (struct fdt_header *)fdt;
	fdth->size_dt_strings = cpu_to_fdt32(val);
}
static inline __attribute__((always_inline)) void fdt_set_size_dt_struct(void *fdt, uint32_t val)
{
	struct fdt_header *fdth = (struct fdt_header *)fdt;
	fdth->size_dt_struct = cpu_to_fdt32(val);
}
# 260 "include/libfdt/libfdt.h"
int fdt_check_header(const void *fdt);
# 281 "include/libfdt/libfdt.h"
int fdt_move(const void *fdt, void *buf, int bufsize);
# 299 "include/libfdt/libfdt.h"
const char *fdt_string(const void *fdt, int stroffset);
# 314 "include/libfdt/libfdt.h"
uint32_t fdt_get_max_phandle(const void *fdt);
# 327 "include/libfdt/libfdt.h"
int fdt_num_mem_rsv(const void *fdt);
# 344 "include/libfdt/libfdt.h"
int fdt_get_mem_rsv(const void *fdt, int n, uint64_t *address, uint64_t *size);
# 359 "include/libfdt/libfdt.h"
int fdt_subnode_offset_namelen(const void *fdt, int parentoffset, const char *name, int namelen);
# 386 "include/libfdt/libfdt.h"
int fdt_subnode_offset(const void *fdt, int parentoffset, const char *name);
# 398 "include/libfdt/libfdt.h"
int fdt_path_offset_namelen(const void *fdt, const char *path, int namelen);
# 424 "include/libfdt/libfdt.h"
int fdt_path_offset(const void *fdt, const char *path);
# 449 "include/libfdt/libfdt.h"
const char *fdt_get_name(const void *fdt, int nodeoffset, int *lenp);
# 469 "include/libfdt/libfdt.h"
int fdt_first_property_offset(const void *fdt, int nodeoffset);
# 490 "include/libfdt/libfdt.h"
int fdt_next_property_offset(const void *fdt, int offset);
# 543 "include/libfdt/libfdt.h"
const struct fdt_property *fdt_get_property_by_offset(const void *fdt, int offset, int *lenp);
# 559 "include/libfdt/libfdt.h"
const struct fdt_property *fdt_get_property_namelen(const void *fdt, int nodeoffset,
						    const char *name, int namelen, int *lenp);
# 593 "include/libfdt/libfdt.h"
...
static inline int fdt_setprop_inplace_cell(void *fdt, int nodeoffset, const char *name,
					   uint32_t val)
{
	return fdt_setprop_inplace_u32(fdt, nodeoffset, name, val);
}
# 1267 "include/libfdt/libfdt.h"
int fdt_nop_property(void *fdt, int nodeoffset, const char *name);
# 1291 "include/libfdt/libfdt.h"
...
# 1787 "include/libfdt/libfdt.h"
int fdt_delprop(void *fdt, int nodeoffset, const char *name);
# 1802 "include/libfdt/libfdt.h"
int fdt_add_subnode_namelen(void *fdt, int parentoffset, const char *name, int namelen);
# 1837 "include/libfdt/libfdt.h"
int fdt_add_subnode(void *fdt, int parentoffset, const char *name);
# 1860 "include/libfdt/libfdt.h"
int fdt_del_node(void *fdt, int nodeoffset);
# 1891 "include/libfdt/libfdt.h"
...
# 23 "include/libfirmware/driver.h" 2
# 1 "include/libfirmware/thread/thread.h" 1
# 20 "include/libfirmware/thread/thread.h"
...
int thread_create(void (*thread)(void *), const char *name, uint32_t stack_words, void *ptr,
		  uint8_t priority, thread_t *handle);
...
# 24 "include/libfirmware/driver.h" 2
# 1 "include/libfirmware/types/list.h" 1
# 10 "include/libfirmware/types/list.h"

# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdbool.h" 1 3 4
# 13 "include/libfirmware/types/list.h" 2
# 1 "include/libfirmware/types/types.h" 1
# 20 "include/libfirmware/types/types.h"

# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 1 3 4
# 23 "include/libfirmware/types/types.h" 2

typedef uint32_t timeout_t;
# 54 "include/libfirmware/types/types.h"
void __attribute__((weak)) panic(const char *msg);
# 14 "include/libfirmware/types/list.h" 2
...
# 73 "include/libfirmware/types/list.h"
...
static inline void list_replace_init(struct list_head *old, struct list_head *item)
{
...
static inline
# 141 "include/libfirmware/types/list.h" 3 4
	_Bool

# 142 "include/libfirmware/types/list.h"
	list_is_first(const struct list_head *list, const struct list_head *head)
{
	return list->prev == head;
}
# 161 "include/libfirmware/types/list.h"
...
# 216 "include/libfirmware/types/list.h"
...
# 275 "include/libfirmware/types/list.h"
...
# 292 "include/libfirmware/types/list.h"
...
# 25 "include/libfirmware/driver.h" 2
...
# 118 "include/libfirmware/driver.h"
...
# 131 "include/libfirmware/driver.h"
int printk(const char *fmt, ...);
int printk_isr(const char *fmt, ...);
# 4 "include/py/mpconfigport.h" 2
# 54 "include/py/mpconfigport.h"
...
# 68 "include/py/mpconfigport.h" 2
# 63 "include/py/mpconfig.h" 2
# 677 "include/py/mpconfig.h"
