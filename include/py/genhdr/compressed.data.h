...
MP_MATCH_COMPRESSED("can't send non-None value to a just-started generator",
		    "\377\201send non-None\306\227\245just-started\212")
...
MP_MATCH_COMPRESSED("function got multiple values for argument '%q'",
		    "\377\204got\207\274\223\200\307")
MP_MATCH_COMPRESSED("function missing keyword-only argument", "\377\204\225keyword-only\200")
MP_MATCH_COMPRESSED("function missing required keyword argument '%q'",
		    "\377\204\225\220\211\200\307")
MP_MATCH_COMPRESSED("function missing required positional argument #%d",
		    "\377\204\225\220positional\200\324")
...
MP_MATCH_COMPRESSED("int() arg 2 must be >= 2 and <= 36",
		    "\377int()\213\316\205\216\340\316\354\337\336")
...
MP_MATCH_COMPRESSED("issubclass() arg 2 must be a class or a tuple of classes",
		    "\377\231\213\316\205\216\245\301\322\245\305\214\374")
MP_MATCH_COMPRESSED("join expects a list of str/bytes objects consistent with self object",
		    "\377join\257\245\312\214str/bytes objects\377\251\314\202")
MP_MATCH_COMPRESSED("local variable referenced before assignment",
		    "\377local variable referenced\363\210")
...
MP_MATCH_COMPRESSED("multiple bases have instance lay-out conflict",
		    "\377\207\362\247\252lay-out\376")
...
MP_MATCH_COMPRESSED("non-default argument follows default argument",
		    "\377non-default\200follows\256\200")
...
MP_MATCH_COMPRESSED("unindent doesn't match any outer indent level",
		    "\377unindent\222match\355\304\267level")
