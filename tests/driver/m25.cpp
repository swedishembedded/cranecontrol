...
static int _mock_spi_transfer(spi_device_t dev, gpio_device_t gpio, uint32_t cs_pin,
...
static const struct spi_device_ops _mock_spi_ops = { .transfer = _mock_spi_transfer };
...
static const struct gpio_device_ops _mock_gpio_ops = { .write_pin = _mock_gpio_write_pin,
