...
int regmap_mem_to_u16(regmap_value_type_t type, const void *data, size_t size, uint16_t *out)
{
	return 0;
}
int regmap_mem_to_u32(regmap_value_type_t type, const void *data, size_t size, uint32_t *out)
{
	return 0;
}
