...
int regmap_read_mem(struct regmap *self, uint32_t id, regmap_value_type_t get_as, void *value, size_t value_size){
...
int regmap_write_mem(struct regmap *self, uint32_t id, regmap_value_type_t set_from, const void* value, size_t size){
	thread_mutex_lock(&self->lock);
