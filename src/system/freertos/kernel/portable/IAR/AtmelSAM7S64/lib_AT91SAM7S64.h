...
__inline void AT91F_SSC_CfgPIO(void)
{
	// Configure PIO controllers to periph mode
	AT91F_PIO_CfgPeriph(AT91C_BASE_PIOA, // PIO controller base address
			    ((unsigned int)AT91C_PA17_TD) | ((unsigned int)AT91C_PA15_TF) |
				    ((unsigned int)AT91C_PA19_RK) | ((unsigned int)AT91C_PA18_RD) |
...
__inline void AT91F_SPI_CfgPIO(void)
{
	...
	AT91F_PIO_CfgPeriph(
		...
		((unsigned int)AT91C_PA11_NPCS0) | ((unsigned int)AT91C_PA13_MOSI) |
			((unsigned int)AT91C_PA31_NPCS1) | ((unsigned int)AT91C_PA12_MISO) |
			((unsigned int)AT91C_PA14_SPCK), // Peripheral A
		((unsigned int)AT91C_PA9_NPCS1) | ((unsigned int)AT91C_PA30_NPCS2) |
			((unsigned int)AT91C_PA10_NPCS2) | ((unsigned int)AT91C_PA22_NPCS3) |
...
__inline void AT91F_TC2_CfgPIO(void)
{
	...
	AT91F_PIO_CfgPeriph(AT91C_BASE_PIOA, // PIO controller base address
			    0, // Peripheral A
			    ((unsigned int)AT91C_PA26_TIOA2) | ((unsigned int)AT91C_PA27_TIOB2) |
...
__inline void AT91F_TC1_CfgPIO(void)
{
	...
	AT91F_PIO_CfgPeriph(AT91C_BASE_PIOA, // PIO controller base address
			    0, // Peripheral A
			    ((unsigned int)AT91C_PA15_TIOA1) | ((unsigned int)AT91C_PA16_TIOB1) |
...
__inline void AT91F_TC0_CfgPIO(void)
{
	...
	AT91F_PIO_CfgPeriph(AT91C_BASE_PIOA, // PIO controller base address
			    0, // Peripheral A
			    ((unsigned int)AT91C_PA0_TIOA0) | ((unsigned int)AT91C_PA1_TIOB0) |
...
__inline void AT91F_PMC_CfgPIO(void)
{
	...
	AT91F_PIO_CfgPeriph(AT91C_BASE_PIOA, // PIO controller base address
			    0, // Peripheral A
			    ((unsigned int)AT91C_PA17_PCK1) | ((unsigned int)AT91C_PA21_PCK1) |
...
__inline void AT91F_US1_CfgPIO(void)
{
	...
	AT91F_PIO_CfgPeriph(
		AT91C_BASE_PIOA, // PIO controller base address
		((unsigned int)AT91C_PA21_RXD1) | ((unsigned int)AT91C_PA27_DTR1) |
			((unsigned int)AT91C_PA26_DCD1) | ((unsigned int)AT91C_PA22_TXD1) |
			((unsigned int)AT91C_PA24_RTS1) | ((unsigned int)AT91C_PA23_SCK1) |
			((unsigned int)AT91C_PA28_DSR1) | ((unsigned int)AT91C_PA29_RI1) |
