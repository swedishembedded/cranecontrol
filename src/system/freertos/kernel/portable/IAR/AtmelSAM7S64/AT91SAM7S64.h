...
#define AT91C_AIC_SRCTYPE_INT_LEVEL_SENSITIVE                                                      \
	((unsigned int)0x0 << 5) // (AIC) Internal Sources Code Label Level Sensitive
#define AT91C_AIC_SRCTYPE_INT_EDGE_TRIGGERED                                                       \
	((unsigned int)0x1 << 5) // (AIC) Internal Sources Code Label Edge triggered
#define AT91C_AIC_SRCTYPE_EXT_HIGH_LEVEL                                                           \
	((unsigned int)0x2 << 5) // (AIC) External Sources Code Label High-level Sensitive
#define AT91C_AIC_SRCTYPE_EXT_POSITIVE_EDGE                                                        \
	((unsigned int)0x3 << 5) // (AIC) External Sources Code Label Positive Edge triggered
...
#define AT91C_SSC_CKG_NONE                                                                         \
	((unsigned int)0x0 << 6) // (SSC) Receive/Transmit Clock Gating: None, continuous clock
#define AT91C_SSC_CKG_LOW                                                                          \
	((unsigned int)0x1 << 6) // (SSC) Receive/Transmit Clock enabled only if RF Low
#define AT91C_SSC_CKG_HIGH                                                                         \
	((unsigned int)0x2 << 6) // (SSC) Receive/Transmit Clock enabled only if RF High
...
#define AT91C_SYSC_SYSC_VRPM                                                                       \
	((AT91_REG *)0xFFFFFD60) // (SYSC) Voltage Regulator Power Mode Register
...
#define AT91C_PA0_TIOA0                                                                            \
	((unsigned int)AT91C_PIO_PA0) //  Timer Counter 0 Multipurpose Timer I/O Pin A
#define AT91C_PIO_PA1 ((unsigned int)1 << 1) // Pin Controlled by PA1
#define AT91C_PA1_PWM1 ((unsigned int)AT91C_PIO_PA1) //  PWM Channel 1
#define AT91C_PA1_TIOB0                                                                            \
	((unsigned int)AT91C_PIO_PA1) //  Timer Counter 0 Multipurpose Timer I/O Pin B
...
#define AT91C_PA15_TIOA1                                                                           \
	((unsigned int)AT91C_PIO_PA15) //  Timer Counter 1 Multipurpose Timer I/O Pin A
#define AT91C_PIO_PA16 ((unsigned int)1 << 16) // Pin Controlled by PA16
#define AT91C_PA16_TK ((unsigned int)AT91C_PIO_PA16) //  SSC Transmit Clock
#define AT91C_PA16_TIOB1                                                                           \
	((unsigned int)AT91C_PIO_PA16) //  Timer Counter 1 Multipurpose Timer I/O Pin B
...
#define AT91C_PA26_TIOA2                                                                           \
	((unsigned int)AT91C_PIO_PA26) //  Timer Counter 2 Multipurpose Timer I/O Pin A
#define AT91C_PIO_PA27 ((unsigned int)1 << 27) // Pin Controlled by PA27
#define AT91C_PA27_DTR1 ((unsigned int)AT91C_PIO_PA27) //  USART 1 Data Terminal ready
#define AT91C_PA27_TIOB2                                                                           \
	((unsigned int)AT91C_PIO_PA27) //  Timer Counter 2 Multipurpose Timer I/O Pin B
