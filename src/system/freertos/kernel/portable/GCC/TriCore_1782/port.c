...
#define portINITIAL_PRIVILEGED_PROGRAM_STATUS_WORD                                                 \
	(0x000014FFUL) /* IO Level 1, MPU Register Set 1 and Call Depth Counting disabled. */
#define portINITIAL_UNPRIVILEGED_PROGRAM_STATUS_WORD                                               \
	(0x000010FFUL) /* IO Level 0, MPU Register Set 1 and Call Depth Counting disabled. */
				   ...
				   void *pvParameters)
{
	...
	pulLowerCSA[0] =
		(portINITIAL_PCXI_UPPER_CONTEXT_WORD | (uint32_t)portADDRESS_TO_CSA(pulUpperCSA));
