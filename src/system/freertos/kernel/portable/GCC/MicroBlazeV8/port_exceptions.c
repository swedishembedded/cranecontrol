...
void vPortExceptionHandler(void *pvExceptionID)
{
	...
	xRegisterDump.ulR1_SP =
		((uint32_t)pulStackPointerOnFunctionEntry) + portexASM_HANDLER_STACK_FRAME_SIZE;
	...
	exception. */
	xRegisterDump.ulPC =
		xRegisterDump.ulR17_return_address_from_exceptions - portexINSTRUCTION_SIZE;
	...
	case XEXC_ID_M_AXI_I_EXCEPTION:
		xRegisterDump.pcExceptionCause =
			(int8_t *const)"XEXC_ID_M_AXI_I_EXCEPTION or XEXC_ID_IPLB_EXCEPTION";
		break;

	case XEXC_ID_M_AXI_D_EXCEPTION:
		xRegisterDump.pcExceptionCause =
			(int8_t *const)"XEXC_ID_M_AXI_D_EXCEPTION or XEXC_ID_DPLB_EXCEPTION";
		break;
	...
	case XEXC_ID_STACK_VIOLATION:
		xRegisterDump.pcExceptionCause =
			(int8_t *const)"XEXC_ID_STACK_VIOLATION or XEXC_ID_MMU";
		break;
...
void vPortExceptionsInstallHandlers(void)
{
	...
	if (ulHandlersAlreadyInstalled == pdFALSE) {
		...
		microblaze_register_exception_handler(XEXC_ID_M_AXI_I_EXCEPTION,
						      vPortExceptionHandlerEntry,
						      (void *)XEXC_ID_M_AXI_I_EXCEPTION);
		...
		microblaze_register_exception_handler(XEXC_ID_M_AXI_D_EXCEPTION,
						      vPortExceptionHandlerEntry,
						      (void *)XEXC_ID_M_AXI_D_EXCEPTION);
