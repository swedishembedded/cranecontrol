...
#define IS_USART_STOPBITS(STOPBITS)                                                                \
	(((STOPBITS) == USART_StopBits_1) || ((STOPBITS) == USART_StopBits_2) ||                   \
...
#define IS_USART_MODE(MODE)                                                                        \
	((((MODE) & (uint32_t)0xFFFFFFF3) == 0x00) && ((MODE) != (uint32_t)0x00))
/**
  * @}
  */
...
#define IS_USART_DMAREQ(DMAREQ)                                                                    \
	((((DMAREQ) & (uint32_t)0xFFFFFF3F) == 0x00) && ((DMAREQ) != (uint32_t)0x00))
...
#define IS_USART_DMAONERROR(DMAERROR)                                                              \
	(((DMAERROR) == USART_DMAOnError_Disable) || ((DMAERROR) == USART_DMAOnError_Enable))
/**
  * @}
  */
...
#define IS_USART_ADDRESS_DETECTION(ADDRESS)                                                        \
	(((ADDRESS) == USART_AddressLength_4b) || ((ADDRESS) == USART_AddressLength_7b))
/**
  * @}
  */
...
#define IS_USART_STOPMODE_WAKEUPSOURCE(SOURCE)                                                     \
	(((SOURCE) == USART_WakeUpSource_AddressMatch) ||                                          \
	 ((SOURCE) == USART_WakeUpSource_StartBit) || ((SOURCE) == USART_WakeUpSource_RXNE))
/**
  * @}
  */
...
#define IS_USART_DE_POLARITY(POLARITY)                                                             \
	(((POLARITY) == USART_DEPolarity_Low) || ((POLARITY) == USART_DEPolarity_High))
/**
  * @}
  */
...
#define IS_USART_INVERSTION_PIN(PIN)                                                               \
	((((PIN) & (uint32_t)0xFFFCFFFF) == 0x00) && ((PIN) != (uint32_t)0x00))
...
#define IS_USART_AUTOBAUDRATE_MODE(MODE)                                                           \
	(((MODE) == USART_AutoBaudRate_StartBit) || ((MODE) == USART_AutoBaudRate_FallingEdge) ||  \
	 ((MODE) == USART_AutoBaudRate_0x7FFrame) || ((MODE) == USART_AutoBaudRate_0x55Frame))
/**
  * @}
  */
...
#define IS_USART_OVRDETECTION(OVR)                                                                 \
	(((OVR) == USART_OVRDetection_Enable) || ((OVR) == USART_OVRDetection_Disable))
/**
  * @}
  */
...
#define IS_USART_REQUEST(REQUEST)                                                                  \
	(((REQUEST) == USART_Request_TXFRQ) || ((REQUEST) == USART_Request_RXFRQ) ||               \
	 ((REQUEST) == USART_Request_MMRQ) || ((REQUEST) == USART_Request_SBKRQ) ||                \
...
#define IS_USART_FLAG(FLAG)                                                                        \
	(((FLAG) == USART_FLAG_PE) || ((FLAG) == USART_FLAG_TXE) || ((FLAG) == USART_FLAG_TC) ||   \
	 ((FLAG) == USART_FLAG_RXNE) || ((FLAG) == USART_FLAG_IDLE) ||                             \
	 ((FLAG) == USART_FLAG_LBD) || ((FLAG) == USART_FLAG_CTS) || ((FLAG) == USART_FLAG_ORE) || \
	 ((FLAG) == USART_FLAG_NE) || ((FLAG) == USART_FLAG_FE) || ((FLAG) == USART_FLAG_nCTSS) || \
	 ((FLAG) == USART_FLAG_RTO) || ((FLAG) == USART_FLAG_EOB) ||                               \
	 ((FLAG) == USART_FLAG_ABRE) || ((FLAG) == USART_FLAG_ABRF) ||                             \
	 ((FLAG) == USART_FLAG_BUSY) || ((FLAG) == USART_FLAG_CM) || ((FLAG) == USART_FLAG_SBK) || \
	 ((FLAG) == USART_FLAG_RWU) || ((FLAG) == USART_FLAG_WU) ||                                \
	 ((FLAG) == USART_FLAG_TEACK) || ((FLAG) == USART_FLAG_REACK))

#define IS_USART_CLEAR_FLAG(FLAG)                                                                  \
	(((FLAG) == USART_FLAG_WU) || ((FLAG) == USART_FLAG_TC) || ((FLAG) == USART_FLAG_IDLE) ||  \
	 ((FLAG) == USART_FLAG_ORE) || ((FLAG) == USART_FLAG_NE) || ((FLAG) == USART_FLAG_FE) ||   \
	 ((FLAG) == USART_FLAG_LBD) || ((FLAG) == USART_FLAG_CTS) || ((FLAG) == USART_FLAG_RTO) || \
	 ((FLAG) == USART_FLAG_EOB) || ((FLAG) == USART_FLAG_CM) || ((FLAG) == USART_FLAG_PE))
/**
  * @}
  */
...
#define IS_USART_CONFIG_IT(IT)                                                                     \
	(((IT) == USART_IT_PE) || ((IT) == USART_IT_TXE) || ((IT) == USART_IT_TC) ||               \
	 ...
	 ((IT) == USART_IT_CTS) || ((IT) == USART_IT_ERR) || ((IT) == USART_IT_RTO) ||             \
	 ((IT) == USART_IT_EOB) || ((IT) == USART_IT_CM) || ((IT) == USART_IT_WU))

#define IS_USART_GET_IT(IT)                                                                        \
	(((IT) == USART_IT_PE) || ((IT) == USART_IT_TXE) || ((IT) == USART_IT_TC) ||               \
	 ((IT) == USART_IT_RXNE) || ((IT) == USART_IT_IDLE) || ((IT) == USART_IT_LBD) ||           \
	 ((IT) == USART_IT_CTS) || ((IT) == USART_IT_ORE) || ((IT) == USART_IT_NE) ||              \
	 ((IT) == USART_IT_FE) || ((IT) == USART_IT_RTO) || ((IT) == USART_IT_EOB) ||              \
	 ((IT) == USART_IT_CM) || ((IT) == USART_IT_WU))

#define IS_USART_CLEAR_IT(IT)                                                                      \
	(((IT) == USART_IT_TC) || ((IT) == USART_IT_PE) || ((IT) == USART_IT_FE) ||                \
	 ((IT) == USART_IT_NE) || ((IT) == USART_IT_ORE) || ((IT) == USART_IT_IDLE) ||             \
	 ((IT) == USART_IT_LBD) || ((IT) == USART_IT_CTS) || ((IT) == USART_IT_RTO) ||             \
	 ((IT) == USART_IT_EOB) || ((IT) == USART_IT_CM) || ((IT) == USART_IT_WU))
/**
  * @}
  */
...
void USART_DirectionModeCmd(USART_TypeDef *USARTx, uint32_t USART_DirectionMode,
