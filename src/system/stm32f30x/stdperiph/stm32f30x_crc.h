...
#define IS_CRC_REVERSE_INPUT_DATA(DATA)                                                            \
	(((DATA) == CRC_ReverseInputData_No) || ((DATA) == CRC_ReverseInputData_8bits) ||          \
	 ((DATA) == CRC_ReverseInputData_16bits) || ((DATA) == CRC_ReverseInputData_32bits))
...
#define IS_CRC_POL_SIZE(SIZE)                                                                      \
	(((SIZE) == CRC_PolSize_7) || ((SIZE) == CRC_PolSize_8) || ((SIZE) == CRC_PolSize_16) ||   \
	 ((SIZE) == CRC_PolSize_32))
