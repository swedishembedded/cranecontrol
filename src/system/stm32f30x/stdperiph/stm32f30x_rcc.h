...
#define IS_RCC_TIMCLK(TIMCLK)                                                                      \
	(((TIMCLK) == RCC_TIM1CLK_HCLK) || ((TIMCLK) == RCC_TIM1CLK_PLLCLK) ||                     \
...
#define IS_RCC_HRTIMCLK(HRTIMCLK)                                                                  \
	(((HRTIMCLK) == RCC_HRTIM1CLK_HCLK) || ((HRTIMCLK) == RCC_HRTIM1CLK_PLLCLK))
...
#define IS_RCC_I2SCLK_SOURCE(SOURCE)                                                               \
	(((SOURCE) == RCC_I2S2CLKSource_SYSCLK) || ((SOURCE) == RCC_I2S2CLKSource_Ext))
...
#define IS_RCC_MCO_PRESCALER(PRESCALER)                                                            \
	(((PRESCALER) == RCC_MCOPrescaler_1) || ((PRESCALER) == RCC_MCOPrescaler_2) ||             \
	 ((PRESCALER) == RCC_MCOPrescaler_4) || ((PRESCALER) == RCC_MCOPrescaler_8) ||             \
	 ((PRESCALER) == RCC_MCOPrescaler_16) || ((PRESCALER) == RCC_MCOPrescaler_32) ||           \
	 ((PRESCALER) == RCC_MCOPrescaler_64) || ((PRESCALER) == RCC_MCOPrescaler_128))
/**
  * @}
  */
