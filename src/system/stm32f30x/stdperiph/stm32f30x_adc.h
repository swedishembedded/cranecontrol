...
#define IS_ADC_ALL_PERIPH(PERIPH)                                                                  \
	(((PERIPH) == ADC1) || ((PERIPH) == ADC2) || ((PERIPH) == ADC3) || ((PERIPH) == ADC4))
...
/** @defgroup ADC_ContinuousConvMode 
  * @{
  */
#define ADC_ContinuousConvMode_Enable                                                              \
	((uint32_t)0x00002000) /*!<  ADC continuous conversion mode enable */
#define ADC_ContinuousConvMode_Disable                                                             \
	((uint32_t)0x00000000) /*!<  ADC continuous conversion mode disable */
#define IS_ADC_CONVMODE(MODE)                                                                      \
	(((MODE) == ADC_ContinuousConvMode_Enable) || ((MODE) == ADC_ContinuousConvMode_Disable))
/**
  * @}
  */
...
#define IS_ADC_OVRUNMODE(MODE)                                                                     \
	(((MODE) == ADC_OverrunMode_Enable) || ((MODE) == ADC_OverrunMode_Disable))
/**
  * @}
  */
...
#define IS_ADC_AUTOINJECMODE(MODE)                                                                 \
	(((MODE) == ADC_AutoInjec_Enable) || ((MODE) == ADC_AutoInjec_Disable))
/**
  * @}
  */
...
#define ADC_ExternalTrigEventEdge_None                                                             \
	((uint16_t)0x0000) /*!<  ADC No external trigger for regular conversion */
#define ADC_ExternalTrigEventEdge_RisingEdge                                                       \
	((uint16_t)0x0400) /*!<  ADC external trigger rising edge for regular conversion */
#define ADC_ExternalTrigEventEdge_FallingEdge                                                      \
	((uint16_t)0x0800) /*!<  ADC ADC external trigger falling edge for regular conversion */
#define ADC_ExternalTrigEventEdge_BothEdge                                                         \
	((uint16_t)0x0C00) /*!<  ADC ADC external trigger both edges for regular conversion */

#define IS_EXTERNALTRIG_EDGE(EDGE)                                                                 \
	(((EDGE) == ADC_ExternalTrigEventEdge_None) ||                                             \
...
#define ADC_ExternalTrigInjecEventEdge_None                                                        \
	((uint16_t)0x0000) /*!<  ADC No external trigger for regular conversion */
#define ADC_ExternalTrigInjecEventEdge_RisingEdge                                                  \
	((uint16_t)0x0040) /*!<  ADC external trigger rising edge for injected conversion */
#define ADC_ExternalTrigInjecEventEdge_FallingEdge                                                 \
	((uint16_t)0x0080) /*!<  ADC external trigger falling edge for injected conversion */
#define ADC_ExternalTrigInjecEventEdge_BothEdge                                                    \
	((uint16_t)0x00C0) /*!<  ADC external trigger both edges for injected conversion */

#define IS_EXTERNALTRIGINJ_EDGE(EDGE)                                                              \
	(((EDGE) == ADC_ExternalTrigInjecEventEdge_None) ||                                        \
...
#define IS_ADC_EXT_TRIG(REGTRIG)                                                                   \
	(((REGTRIG) == ADC_ExternalTrigConvEvent_0) ||                                             \
...
#define ADC_ExternalTrigInjecConvEvent_0                                                           \
	((uint16_t)0x0000) /*!<  ADC external trigger for injected conversion event 0 */
#define ADC_ExternalTrigInjecConvEvent_1                                                           \
	((uint16_t)0x0004) /*!<  ADC external trigger for injected conversion event 1 */
#define ADC_ExternalTrigInjecConvEvent_2                                                           \
	((uint16_t)0x0008) /*!<  ADC external trigger for injected conversion event 2 */
#define ADC_ExternalTrigInjecConvEvent_3                                                           \
	((uint16_t)0x000C) /*!<  ADC external trigger for injected conversion event 3 */
#define ADC_ExternalTrigInjecConvEvent_4                                                           \
	((uint16_t)0x0010) /*!<  ADC external trigger for injected conversion event 4 */
#define ADC_ExternalTrigInjecConvEvent_5                                                           \
	((uint16_t)0x0014) /*!<  ADC external trigger for injected conversion event 5 */
#define ADC_ExternalTrigInjecConvEvent_6                                                           \
	((uint16_t)0x0018) /*!<  ADC external trigger for injected conversion event 6 */
#define ADC_ExternalTrigInjecConvEvent_7                                                           \
	((uint16_t)0x001C) /*!<  ADC external trigger for injected conversion event 7 */
#define ADC_ExternalTrigInjecConvEvent_8                                                           \
	((uint16_t)0x0020) /*!<  ADC external trigger for injected conversion event 8 */
#define ADC_ExternalTrigInjecConvEvent_9                                                           \
	((uint16_t)0x0024) /*!<  ADC external trigger for injected conversion event 9 */
#define ADC_ExternalTrigInjecConvEvent_10                                                          \
	((uint16_t)0x0028) /*!<  ADC external trigger for injected conversion event 10 */
#define ADC_ExternalTrigInjecConvEvent_11                                                          \
	((uint16_t)0x002C) /*!<  ADC external trigger for injected conversion event 11 */
#define ADC_ExternalTrigInjecConvEvent_12                                                          \
	((uint16_t)0x0030) /*!<  ADC external trigger for injected conversion event 12 */
#define ADC_ExternalTrigInjecConvEvent_13                                                          \
	((uint16_t)0x0034) /*!<  ADC external trigger for injected conversion event 13 */
#define ADC_ExternalTrigInjecConvEvent_14                                                          \
	((uint16_t)0x0038) /*!<  ADC external trigger for injected conversion event 14 */
#define ADC_ExternalTrigInjecConvEvent_15                                                          \
	((uint16_t)0x003C) /*!<  ADC external trigger for injected conversion event 15 */

#define IS_ADC_EXT_INJEC_TRIG(INJTRIG)                                                             \
	(((INJTRIG) == ADC_ExternalTrigInjecConvEvent_0) ||                                        \
...
#define IS_ADC_CHANNEL(CHANNEL)                                                                    \
	(((CHANNEL) == ADC_Channel_1) || ((CHANNEL) == ADC_Channel_2) ||                           \
	 ((CHANNEL) == ADC_Channel_3) || ((CHANNEL) == ADC_Channel_4) ||                           \
	 ((CHANNEL) == ADC_Channel_5) || ((CHANNEL) == ADC_Channel_6) ||                           \
	 ((CHANNEL) == ADC_Channel_7) || ((CHANNEL) == ADC_Channel_8) ||                           \
	 ...
	 ((CHANNEL) == ADC_Channel_17) || ((CHANNEL) == ADC_Channel_18))
...
#define ADC_Mode_CombRegSimulInjSimul                                                              \
	((uint32_t)0x00000001) /*!<  ADC multi ADC mode: Combined Regular simultaneous injected simultaneous mode */
#define ADC_Mode_CombRegSimulAltTrig                                                               \
	((uint32_t)0x00000002) /*!<  ADC multi ADC mode: Combined Regular simultaneous Alternate trigger mode */
#define ADC_Mode_InjSimul                                                                          \
	((uint32_t)0x00000005) /*!<  ADC multi ADC mode: Injected simultaneous mode */
#define ADC_Mode_RegSimul                                                                          \
	((uint32_t)0x00000006) /*!<  ADC multi ADC mode: Regular simultaneous mode */
...
#define IS_ADC_MODE(MODE)                                                                          \
	(((MODE) == ADC_Mode_Independent) || ((MODE) == ADC_Mode_CombRegSimulInjSimul) ||          \
	 ((MODE) == ADC_Mode_CombRegSimulAltTrig) || ((MODE) == ADC_Mode_InjSimul) ||              \
	 ((MODE) == ADC_Mode_RegSimul) || ((MODE) == ADC_Mode_Interleave) ||                       \
...
#define IS_ADC_CLOCKMODE(CLOCK)                                                                    \
	(((CLOCK) == ADC_Clock_AsynClkMode) || ((CLOCK) == ADC_Clock_SynClkModeDiv1) ||            \
	 ((CLOCK) == ADC_Clock_SynClkModeDiv2) || ((CLOCK) == ADC_Clock_SynClkModeDiv4))
/**
  * @}
  */
...
#define ADC_DMAAccessMode_1                                                                        \
	((uint32_t)0x00008000) /*!<  DMA mode enabled for 12 and 10-bit resolution (6 bit) */
#define ADC_DMAAccessMode_2                                                                        \
	((uint32_t)0x0000C000) /*!<  DMA mode enabled for 8 and 6-bit resolution (8bit) */
...
#define IS_ADC_SAMPLE_TIME(TIME)                                                                   \
	(((TIME) == ADC_SampleTime_1Cycles5) || ((TIME) == ADC_SampleTime_2Cycles5) ||             \
	 ((TIME) == ADC_SampleTime_4Cycles5) || ((TIME) == ADC_SampleTime_7Cycles5) ||             \
	 ((TIME) == ADC_SampleTime_19Cycles5) || ((TIME) == ADC_SampleTime_61Cycles5) ||           \
	 ((TIME) == ADC_SampleTime_181Cycles5) || ((TIME) == ADC_SampleTime_601Cycles5))
/**
  * @}
  */
...
#define IS_ADC_INJECTED_CHANNEL(CHANNEL)                                                           \
	(((CHANNEL) == ADC_InjectedChannel_1) || ((CHANNEL) == ADC_InjectedChannel_2) ||           \
	 ...
	 ((CHANNEL) == ADC_InjectedChannel_5) || ((CHANNEL) == ADC_InjectedChannel_6) ||           \
	 ((CHANNEL) == ADC_InjectedChannel_7) || ((CHANNEL) == ADC_InjectedChannel_8) ||           \
	 ((CHANNEL) == ADC_InjectedChannel_9) || ((CHANNEL) == ADC_InjectedChannel_10) ||          \
	 ((CHANNEL) == ADC_InjectedChannel_11) || ((CHANNEL) == ADC_InjectedChannel_12) ||         \
	 ((CHANNEL) == ADC_InjectedChannel_13) || ((CHANNEL) == ADC_InjectedChannel_14) ||         \
	 ((CHANNEL) == ADC_InjectedChannel_15) || ((CHANNEL) == ADC_InjectedChannel_16) ||         \
	 ((CHANNEL) == ADC_InjectedChannel_17) || ((CHANNEL) == ADC_InjectedChannel_18))
/**
  * @}
  */
...
#define IS_ADC_INJECTED_SEQUENCE(SEQUENCE)                                                         \
	(((SEQUENCE) == ADC_InjectedSequence_1) || ((SEQUENCE) == ADC_InjectedSequence_2) ||       \
	 ((SEQUENCE) == ADC_InjectedSequence_3) || ((SEQUENCE) == ADC_InjectedSequence_4))
/**
  * @}
  */
...
#define ADC_AnalogWatchdog_SingleRegEnable                                                         \
	((uint32_t)0x00C00000) /*!<  ADC Analog watchdog single regular mode */
#define ADC_AnalogWatchdog_SingleInjecEnable                                                       \
	((uint32_t)0x01400000) /*!<  ADC Analog watchdog single injected mode */
#define ADC_AnalogWatchdog_SingleRegOrInjecEnable                                                  \
	((uint32_t)0x01C00000) /*!<  ADC Analog watchdog single regular or injected mode */
#define ADC_AnalogWatchdog_AllRegEnable                                                            \
	((uint32_t)0x00800000) /*!<  ADC Analog watchdog all regular mode */
#define ADC_AnalogWatchdog_AllInjecEnable                                                          \
	((uint32_t)0x01000000) /*!<  ADC Analog watchdog all injected mode */
#define ADC_AnalogWatchdog_AllRegAllInjecEnable                                                    \
	((uint32_t)0x01800000) /*!<  ADC Analog watchdog all regular and all injected mode */
...
/** @defgroup ADC_Calibration_Mode_definition 
  * @{
  */
#define ADC_CalibrationMode_Single                                                                 \
	((uint32_t)0x00000000) /*!<  ADC Calibration for single ended channel */
#define ADC_CalibrationMode_Differential                                                           \
	((uint32_t)0x40000000) /*!<  ADC Calibration for differential channel */

#define IS_ADC_CALIBRATION_MODE(MODE)                                                              \
	(((MODE) == ADC_CalibrationMode_Single) || ((MODE) == ADC_CalibrationMode_Differential))
...
#define ADC_IT_EOS                                                                                 \
	((uint16_t)0x0008) /*!< ADC End of Regular sequence of Conversions interrupt source */
...
#define ADC_IT_JEOS                                                                                \
	((uint16_t)0x0040) /*!< ADC End of Injected sequence of Conversions interrupt source */
...
#define IS_ADC_GET_IT(IT)                                                                          \
	(((IT) == ADC_IT_RDY) || ((IT) == ADC_IT_EOSMP) || ((IT) == ADC_IT_EOC) ||                 \
	 ((IT) == ADC_IT_EOS) || ((IT) == ADC_IT_OVR) || ((IT) == ADC_IT_EOS) ||                   \
	 ((IT) == ADC_IT_JEOS) || ((IT) == ADC_IT_AWD1) || ((IT) == ADC_IT_AWD2) ||                \
	 ((IT) == ADC_IT_AWD3) || ((IT) == ADC_IT_JQOVF))
/**
  * @}
  */
...
#define IS_ADC_GET_FLAG(FLAG)                                                                      \
	(((FLAG) == ADC_FLAG_RDY) || ((FLAG) == ADC_FLAG_EOSMP) || ((FLAG) == ADC_FLAG_EOC) ||     \
	 ((FLAG) == ADC_FLAG_EOS) || ((FLAG) == ADC_FLAG_OVR) || ((FLAG) == ADC_FLAG_JEOC) ||      \
	 ((FLAG) == ADC_FLAG_JEOS) || ((FLAG) == ADC_FLAG_AWD1) || ((FLAG) == ADC_FLAG_AWD2) ||    \
	 ((FLAG) == ADC_FLAG_AWD3) || ((FLAG) == ADC_FLAG_JQOVF))
/**
  * @}
  */
...
#define ADC_FLAG_MSTEOS                                                                            \
	((uint32_t)0x00000008) /*!< ADC Master End of Regular sequence of Conversions flag */
...
#define ADC_FLAG_MSTJEOS                                                                           \
	((uint32_t)0x00000040) /*!< ADC Master End of Injected sequence of Conversions flag */
...
#define ADC_FLAG_MSTJQOVF                                                                          \
	((uint32_t)0x00000400) /*!< ADC Master Injected Context Queue Overflow flag */
...
#define ADC_FLAG_SLVEOS                                                                            \
	((uint32_t)0x00080000) /*!< ADC Slave End of Regular sequence of Conversions flag */
...
#define ADC_FLAG_SLVJEOS                                                                           \
	((uint32_t)0x00400000) /*!< ADC Slave End of Injected sequence of Conversions flag */
...
#define ADC_FLAG_SLVJQOVF                                                                          \
	((uint32_t)0x04000000) /*!< ADC Slave Injected Context Queue Overflow flag */

#define IS_ADC_CLEAR_COMMONFLAG(FLAG)                                                              \
	((((FLAG) & (uint32_t)0xF800F800) == 0x0000) && ((FLAG) != 0x00000000))
#define IS_ADC_GET_COMMONFLAG(FLAG)                                                                \
	(((FLAG) == ADC_FLAG_MSTRDY) || ((FLAG) == ADC_FLAG_MSTEOSMP) ||                           \
	 ...
	 ((FLAG) == ADC_FLAG_MSTJQOVF) || ((FLAG) == ADC_FLAG_SLVRDY) ||                           \
	 ((FLAG) == ADC_FLAG_SLVEOSMP) || ((FLAG) == ADC_FLAG_SLVEOC) ||                           \
	 ((FLAG) == ADC_FLAG_SLVEOS) || ((FLAG) == ADC_FLAG_SLVOVR) ||                             \
	 ((FLAG) == ADC_FLAG_SLVEOS) || ((FLAG) == ADC_FLAG_SLVJEOS) ||                            \
	 ((FLAG) == ADC_FLAG_SLVAWD1) || ((FLAG) == ADC_FLAG_SLVAWD2) ||                           \
	 ((FLAG) == ADC_FLAG_SLVAWD3) || ((FLAG) == ADC_FLAG_SLVJQOVF))
/**
  * @}
  */
...
void ADC_ExternalTriggerConfig(ADC_TypeDef *ADCx, uint16_t ADC_ExternalTrigConvEvent,
...
void ADC_InjectedChannelSampleTimeConfig(ADC_TypeDef *ADCx, uint8_t ADC_InjectedChannel,
					 uint8_t ADC_SampleTime);
