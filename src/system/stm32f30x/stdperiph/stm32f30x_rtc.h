...
#define IS_RTC_ALARM_SUB_SECOND_MASK(MASK)                                                         \
	(((MASK) == RTC_AlarmSubSecondMask_All) || ((MASK) == RTC_AlarmSubSecondMask_SS14_1) ||    \
	 ...
	 ((MASK) == RTC_AlarmSubSecondMask_SS14_13) || ((MASK) == RTC_AlarmSubSecondMask_SS14) ||  \
...
#define IS_RTC_GET_FLAG(FLAG)                                                                      \
	(((FLAG) == RTC_FLAG_TSOVF) || ((FLAG) == RTC_FLAG_TSF) || ((FLAG) == RTC_FLAG_WUTF) ||    \
	 ...
	 ((FLAG) == RTC_FLAG_ALRAWF) || ((FLAG) == RTC_FLAG_TAMP1F) ||                             \
	 ((FLAG) == RTC_FLAG_TAMP2F) || ((FLAG) == RTC_FLAG_TAMP3F) ||                             \
