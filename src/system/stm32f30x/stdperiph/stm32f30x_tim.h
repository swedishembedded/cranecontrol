...
#define IS_TIM_LIST8_PERIPH(PERIPH)                                                                \
	(((PERIPH) == TIM16) || ((PERIPH) == TIM1) || ((PERIPH) == TIM8))
...
#define IS_TIM_OC_MODE(MODE)                                                                       \
	(((MODE) == TIM_OCMode_Timing) || ((MODE) == TIM_OCMode_Active) ||                         \
	 ...
	 ((MODE) == TIM_OCMode_Retrigerrable_OPM1) || ((MODE) == TIM_OCMode_Retrigerrable_OPM2) || \
	 ((MODE) == TIM_OCMode_Combined_PWM1) || ((MODE) == TIM_OCMode_Combined_PWM2) ||           \
	 ((MODE) == TIM_OCMode_Asymmetric_PWM1) || ((MODE) == TIM_OCMode_Asymmetric_PWM2))
...
#define IS_TIM_BREAK1_STATE(STATE)                                                                 \
	(((STATE) == TIM_Break1_Enable) || ((STATE) == TIM_Break1_Disable))
/**
  * @}
  */
...
#define IS_TIM_BREAK2_STATE(STATE)                                                                 \
	(((STATE) == TIM_Break2_Enable) || ((STATE) == TIM_Break2_Disable))
/**
  * @}
  */
...
#define IS_TIM_BREAK1_POLARITY(POLARITY)                                                           \
	(((POLARITY) == TIM_Break1Polarity_Low) || ((POLARITY) == TIM_Break1Polarity_High))
/**
  * @}
  */
...
#define IS_TIM_BREAK2_POLARITY(POLARITY)                                                           \
	(((POLARITY) == TIM_Break2Polarity_Low) || ((POLARITY) == TIM_Break2Polarity_High))
/**
  * @}
  */
...
#define IS_TIM_IC_SELECTION(SELECTION)                                                             \
	(((SELECTION) == TIM_ICSelection_DirectTI) ||                                              \
	 ((SELECTION) == TIM_ICSelection_IndirectTI) || ((SELECTION) == TIM_ICSelection_TRC))
/**
  * @}
  */
...
#define IS_TIM_DMA_BASE(BASE)                                                                      \
	(((BASE) == TIM_DMABase_CR1) || ((BASE) == TIM_DMABase_CR2) ||                             \
	 ...
	 ((BASE) == TIM_DMABase_CCMR3) || ((BASE) == TIM_DMABase_CCR5) ||                          \
...
#define IS_TIM_EVENT_SOURCE(SOURCE)                                                                \
	((((SOURCE) & (uint16_t)0xFE00) == 0x0000) && ((SOURCE) != 0x0000))
...
#define IS_TIM_TRGO2_SOURCE(SOURCE)                                                                \
	(((SOURCE) == TIM_TRGO2Source_Reset) || ((SOURCE) == TIM_TRGO2Source_Enable) ||            \
	 ((SOURCE) == TIM_TRGO2Source_Update) || ((SOURCE) == TIM_TRGO2Source_OC1) ||              \
	 ((SOURCE) == TIM_TRGO2Source_OC1Ref) || ((SOURCE) == TIM_TRGO2Source_OC2Ref) ||           \
	 ((SOURCE) == TIM_TRGO2Source_OC3Ref) || ((SOURCE) == TIM_TRGO2Source_OC4Ref) ||           \
	 ((SOURCE) == TIM_TRGO2Source_OC5Ref) || ((SOURCE) == TIM_TRGO2Source_OC6Ref) ||           \
...
#define IS_TIM_REMAP(TIM_REMAP)                                                                    \
	(((TIM_REMAP) == TIM16_GPIO) || ((TIM_REMAP) == TIM16_RTC_CLK) ||                          \
	 ((TIM_REMAP) == TIM16_HSEDiv32) || ((TIM_REMAP) == TIM16_MCO) ||                          \
	 ((TIM_REMAP) == TIM1_ADC1_AWDG1) || ((TIM_REMAP) == TIM1_ADC1_AWDG2) ||                   \
	 ((TIM_REMAP) == TIM1_ADC1_AWDG3) || ((TIM_REMAP) == TIM1_ADC4_AWDG1) ||                   \
	 ((TIM_REMAP) == TIM1_ADC4_AWDG2) || ((TIM_REMAP) == TIM1_ADC4_AWDG3) ||                   \
	 ((TIM_REMAP) == TIM8_ADC2_AWDG1) || ((TIM_REMAP) == TIM8_ADC2_AWDG2) ||                   \
	 ((TIM_REMAP) == TIM8_ADC2_AWDG3) || ((TIM_REMAP) == TIM8_ADC3_AWDG1) ||                   \
	 ((TIM_REMAP) == TIM8_ADC3_AWDG2) || ((TIM_REMAP) == TIM8_ADC3_AWDG3))
...
#define IS_TIM_GET_FLAG(FLAG)                                                                      \
	(((FLAG) == TIM_FLAG_Update) || ((FLAG) == TIM_FLAG_CC1) || ((FLAG) == TIM_FLAG_CC2) ||    \
	 ...
	 ((FLAG) == TIM_FLAG_Break2) || ((FLAG) == TIM_FLAG_CC1OF) ||                              \
...
#define IS_TIM_CLEAR_FLAG(TIM_FLAG)                                                                \
	((((TIM_FLAG) & (uint32_t)0xE000) == 0x0000) && ((TIM_FLAG) != 0x0000))
/**
  * @}
  */
