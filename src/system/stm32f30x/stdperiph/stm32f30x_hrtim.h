...
#define IS_HRTIM_TIMERINDEX(TIMERINDEX)                                                            \
	(((TIMERINDEX) == HRTIM_TIMERINDEX_MASTER) ||                                              \
	 ...
	 ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_D) || ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_E))
...
#define IS_HRTIM_TIMERID(TIMERID)                                                                  \
	(((TIMERID) == HRTIM_TIMERID_MASTER) || ((TIMERID) == HRTIM_TIMERID_TIMER_A) ||            \
	 ((TIMERID) == HRTIM_TIMERID_TIMER_B) || ((TIMERID) == HRTIM_TIMERID_TIMER_C) ||           \
	 ((TIMERID) == HRTIM_TIMERID_TIMER_D) || ((TIMERID) == HRTIM_TIMERID_TIMER_E))
/**
 * @}
 */
...
#define IS_HRTIM_COMPAREUNIT(COMPAREUNIT)                                                          \
	(((COMPAREUNIT) == HRTIM_COMPAREUNIT_1) || ((COMPAREUNIT) == HRTIM_COMPAREUNIT_2) ||       \
	 ((COMPAREUNIT) == HRTIM_COMPAREUNIT_3) || ((COMPAREUNIT) == HRTIM_COMPAREUNIT_4))
/**
  * @}
  */
...
#define IS_HRTIM_CAPTUREUNIT(CAPTUREUNIT)                                                          \
	(((CAPTUREUNIT) == HRTIM_CAPTUREUNIT_1) || ((CAPTUREUNIT) == HRTIM_CAPTUREUNIT_2))
/**
  * @}
  */
...
#define IS_HRTIM_OUTPUT(OUTPUT)                                                                    \
	(((OUTPUT) == HRTIM_OUTPUT_TA1) || ((OUTPUT) == HRTIM_OUTPUT_TA2) ||                       \
	 ((OUTPUT) == HRTIM_OUTPUT_TB1) || ((OUTPUT) == HRTIM_OUTPUT_TB2) ||                       \
	 ((OUTPUT) == HRTIM_OUTPUT_TC1) || ((OUTPUT) == HRTIM_OUTPUT_TC2) ||                       \
	 ((OUTPUT) == HRTIM_OUTPUT_TD1) || ((OUTPUT) == HRTIM_OUTPUT_TD2) ||                       \
	 ((OUTPUT) == HRTIM_OUTPUT_TE1) || ((OUTPUT) == HRTIM_OUTPUT_TE2))
...
#define IS_HRTIM_ADCTRIGGER(ADCTRIGGER)                                                            \
	(((ADCTRIGGER) == HRTIM_ADCTRIGGER_1) || ((ADCTRIGGER) == HRTIM_ADCTRIGGER_2) ||           \
	 ((ADCTRIGGER) == HRTIM_ADCTRIGGER_3) || ((ADCTRIGGER) == HRTIM_ADCTRIGGER_4))
/**
  * @}
  */
...
#define IS_HRTIM_EVENT(EVENT)                                                                      \
	(((EVENT) == HRTIM_EVENT_1) || ((EVENT) == HRTIM_EVENT_2) || ((EVENT) == HRTIM_EVENT_3) || \
	 ((EVENT) == HRTIM_EVENT_4) || ((EVENT) == HRTIM_EVENT_5) || ((EVENT) == HRTIM_EVENT_6) || \
	 ((EVENT) == HRTIM_EVENT_7) || ((EVENT) == HRTIM_EVENT_8) || ((EVENT) == HRTIM_EVENT_9) || \
...
#define IS_HRTIM_FAULT(FAULT)                                                                      \
	(((FAULT) == HRTIM_FAULT_1) || ((FAULT) == HRTIM_FAULT_2) || ((FAULT) == HRTIM_FAULT_3) || \
	 ((FAULT) == HRTIM_FAULT_4) || ((FAULT) == HRTIM_FAULT_5))
/**
  * @}
  */
...
#define HRTIM_PRESCALERRATIO_MUL32                                                                 \
	((uint32_t)0x00000000) /*!< fHRCK: 4.608 GHz - Resolution: 217 ps - Min PWM frequency: 70.3 kHz (fHRTIM=144MHz)      */
#define HRTIM_PRESCALERRATIO_MUL16                                                                 \
	((uint32_t)0x00000001) /*!< fHRCK: 2.304 GHz - Resolution: 434 ps - Min PWM frequency: 35.1 KHz (fHRTIM=144MHz)      */
#define HRTIM_PRESCALERRATIO_MUL8                                                                  \
	((uint32_t)0x00000002) /*!< fHRCK: 1.152 GHz - Resolution: 868 ps - Min PWM frequency: 17.6 kHz (fHRTIM=144MHz)      */
#define HRTIM_PRESCALERRATIO_MUL4                                                                  \
	((uint32_t)0x00000003) /*!< fHRCK: 576 MHz - Resolution: 1.73 ns - Min PWM frequency: 8.8 kHz (fHRTIM=144MHz)      */
#define HRTIM_PRESCALERRATIO_MUL2                                                                  \
	((uint32_t)0x00000004) /*!< fHRCK: 288 MHz - Resolution: 3.47 ns - Min PWM frequency: 4.4 kHz (fHRTIM=144MHz)      */
#define HRTIM_PRESCALERRATIO_DIV1                                                                  \
	((uint32_t)0x00000005) /*!< fHRCK: 144 MHz - Resolution: 6.95 ns - Min PWM frequency: 2.2 kHz (fHRTIM=144MHz)      */
#define HRTIM_PRESCALERRATIO_DIV2                                                                  \
	((uint32_t)0x00000006) /*!< fHRCK: 72 MHz - Resolution: 13.88 ns- Min PWM frequency: 1.1 kHz (fHRTIM=144MHz)      */
#define HRTIM_PRESCALERRATIO_DIV4                                                                  \
	((uint32_t)0x00000007) /*!< fHRCK: 36 MHz - Resolution: 27.7 ns- Min PWM frequency: 550Hz (fHRTIM=144MHz)      */
...
#define HRTIM_MODE_CONTINOUS                                                                       \
	((uint32_t)0x00000008) /*!< The timer operates in continuous (free-running) mode */
#define HRTIM_MODE_SINGLESHOT                                                                      \
	((uint32_t)0x00000000) /*!< The timer operates in non retriggerable single-shot mode */
#define HRTIM_MODE_SINGLESHOT_RETRIGGERABLE                                                        \
	((uint32_t)0x00000010) /*!< The timer operates in retriggerable single-shot mode */

#define IS_HRTIM_MODE(MODE)                                                                        \
	(((MODE) == HRTIM_MODE_CONTINOUS) || ((MODE) == HRTIM_MODE_SINGLESHOT) ||                  \
	 ((MODE) == HRTIM_MODE_SINGLESHOT_RETRIGGERABLE))

#define IS_HRTIM_MODE_ONEPULSE(MODE)                                                               \
	(((MODE) == HRTIM_MODE_SINGLESHOT) || ((MODE) == HRTIM_MODE_SINGLESHOT_RETRIGGERABLE))
...
#define IS_HRTIM_HALFMODE(HALFMODE)                                                                \
	(((HALFMODE) == HRTIM_HALFMODE_DISABLED) || ((HALFMODE) == HRTIM_HALFMODE_ENABLED))
/**
  * @}
  */
...
#define HRTIM_SYNCSTART_DISABLED                                                                   \
	((uint32_t)0x00000000) /*!< Synchronization input event has effect on the timer */
#define HRTIM_SYNCSTART_ENABLED                                                                    \
	(HRTIM_MCR_SYNCSTRTM) /*!< Synchronization input event starts the timer */

#define IS_HRTIM_SYNCSTART(SYNCSTART)                                                              \
	(((SYNCSTART) == HRTIM_SYNCSTART_DISABLED) || ((SYNCSTART) == HRTIM_SYNCSTART_ENABLED))
/**
  * @}
  */
...
#define IS_HRTIM_SYNCRESET(SYNCRESET)                                                              \
	(((SYNCRESET) == HRTIM_SYNCRESET_DISABLED) || ((SYNCRESET) == HRTIM_SYNCRESET_ENABLED))
/**
  * @}
  */
...
#define HRTIM_DACSYNC_DACTRIGOUT_1                                                                 \
	(HRTIM_MCR_DACSYNC_0) /*!< DAC synchronization event generated on DACTrigOut1 output upon timer update */
#define HRTIM_DACSYNC_DACTRIGOUT_2                                                                 \
	(HRTIM_MCR_DACSYNC_1) /*!< DAC synchronization event generated on DACTrigOut2 output upon timer update */
#define HRTIM_DACSYNC_DACTRIGOUT_3                                                                 \
	(HRTIM_MCR_DACSYNC_1 |                                                                     \
	 HRTIM_MCR_DACSYNC_0) /*!< DAC update generated on DACTrigOut3 output upon timer update */

#define IS_HRTIM_DACSYNC(DACSYNC)                                                                  \
	(((DACSYNC) == HRTIM_DACSYNC_NONE) || ((DACSYNC) == HRTIM_DACSYNC_DACTRIGOUT_1) ||         \
	 ((DACSYNC) == HRTIM_DACSYNC_DACTRIGOUT_2) || ((DACSYNC) == HRTIM_DACSYNC_DACTRIGOUT_3))
/**
  * @}
  */
...
#define HRTIM_PRELOAD_DISABLED                                                                     \
	((uint32_t)0x00000000) /*!< Preload disabled: the write access is directly done into the active register */
#define HRTIM_PRELOAD_ENABLED                                                                      \
	(HRTIM_MCR_PREEN) /*!< Preload enabled: the write access is done into the preload register */

#define IS_HRTIM_PRELOAD(PRELOAD)                                                                  \
	(((PRELOAD) == HRTIM_PRELOAD_DISABLED) || ((PRELOAD) == HRTIM_PRELOAD_ENABLED))
/**
  * @}
  */
...
/** @defgroup HRTIM_UpdateGating 
  ...
  */
#define HRTIM_UPDATEGATING_INDEPENDENT                                                             \
	(uint32_t)0x00000000 /*!< Update done independently from the DMA burst transfer completion */
#define HRTIM_UPDATEGATING_DMABURST                                                                \
	(HRTIM_TIMCR_UPDGAT_0) /*!< Update done when the DMA burst transfer is completed */
#define HRTIM_UPDATEGATING_DMABURST_UPDATE                                                         \
	(HRTIM_TIMCR_UPDGAT_1) /*!< Update done on timer roll-over following a DMA burst transfer completion*/
#define HRTIM_UPDATEGATING_UPDEN1                                                                  \
	(HRTIM_TIMCR_UPDGAT_1 |                                                                    \
	 HRTIM_TIMCR_UPDGAT_0) /*!< Slave timer only - Update done on a rising edge of HRTIM update enable input 1 */
#define HRTIM_UPDATEGATING_UPDEN2                                                                  \
	(HRTIM_TIMCR_UPDGAT_2) /*!< Slave timer only - Update done on a rising edge of HRTIM update enable input 2 */
#define HRTIM_UPDATEGATING_UPDEN3                                                                  \
	(HRTIM_TIMCR_UPDGAT_2 |                                                                    \
	 HRTIM_TIMCR_UPDGAT_0) /*!< Slave timer only - Update done on a rising edge of HRTIM update enable input 3 */
#define HRTIM_UPDATEGATING_UPDEN1_UPDATE                                                           \
	(HRTIM_TIMCR_UPDGAT_2 |                                                                    \
	 HRTIM_TIMCR_UPDGAT_1) /*!< Slave timer only -  Update done on the update event following a rising edge of HRTIM update enable input 1 */
#define HRTIM_UPDATEGATING_UPDEN2_UPDATE                                                           \
	(HRTIM_TIMCR_UPDGAT_2 | HRTIM_TIMCR_UPDGAT_1 |                                             \
	 HRTIM_TIMCR_UPDGAT_0) /*!< Slave timer only -  Update done on the update event following a rising edge of HRTIM update enable input 2 */
#define HRTIM_UPDATEGATING_UPDEN3_UPDATE                                                           \
	(HRTIM_TIMCR_UPDGAT_3) /*!< Slave timer only -  Update done on the update event following a rising edge of HRTIM update enable input 3 */
...
#define HRTIM_TIMERBURSTMODE_MAINTAINCLOCK                                                         \
	(uint32_t)0x000000 /*!< Timer counter clock is maintained and the timer operates normally */
#define HRTIM_TIMERBURSTMODE_RESETCOUNTER                                                          \
	(HRTIM_BMCR_MTBM) /*!< Timer counter clock is stopped and the counter is reset */
...
/** @defgroup HRTIM_TimerFaultLock
  ...
  */
#define HRTIM_TIMFAULTLOCK_READWRITE                                                               \
	((uint32_t)0x00000000) /*!< Timer fault enabling bits are read/write */
#define HRTIM_TIMFAULTLOCK_READONLY                                                                \
	(HRTIM_FLTR_FLTCLK) /*!< Timer fault enabling bits are read only */
...
#define HRTIM_TIMDEADTIMEINSERTION_DISABLED                                                        \
	((uint32_t)0x00000000) /*!< Output 1 and output 2 signals are independent */
#define HRTIM_TIMDEADTIMEINSERTION_ENABLED                                                         \
	HRTIM_OUTR_DTEN /*!< Deadtime is inserted between output 1 and output 2 */
...
#define HRTIM_TIMDELAYEDPROTECTION_DELAYEDOUT1_EEV68                                               \
	(HRTIM_OUTR_DLYPRTEN) /*!< Output 1 delayed Idle on external Event 6 or 8 */
#define HRTIM_TIMDELAYEDPROTECTION_DELAYEDOUT2_EEV68                                               \
	(HRTIM_OUTR_DLYPRT_0 |                                                                     \
	 HRTIM_OUTR_DLYPRTEN) /*!< Output 2 delayed Idle on external Event 6 or 8 */
#define HRTIM_TIMDELAYEDPROTECTION_DELAYEDBOTH_EEV68                                               \
	(HRTIM_OUTR_DLYPRT_1 |                                                                     \
	 HRTIM_OUTR_DLYPRTEN) /*!< Output 1 and output 2 delayed Idle on external Event 6 or 8 */
#define HRTIM_TIMDELAYEDPROTECTION_BALANCED_EEV68                                                  \
	(HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRT_0 |                                               \
	 HRTIM_OUTR_DLYPRTEN) /*!< Balanced Idle on external Event 6 or 8 */
#define HRTIM_TIMDELAYEDPROTECTION_DELAYEDOUT1_DEEV79                                              \
	(HRTIM_OUTR_DLYPRT_2 |                                                                     \
	 HRTIM_OUTR_DLYPRTEN) /*!< Output 1 delayed Idle on external Event 7 or 9 */
#define HRTIM_TIMDELAYEDPROTECTION_DELAYEDOUT2_DEEV79                                              \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_0 |                                               \
	 HRTIM_OUTR_DLYPRTEN) /*!< Output 2 delayed Idle on external Event 7 or 9 */
#define HRTIM_TIMDELAYEDPROTECTION_DELAYEDBOTH_EEV79                                               \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 |                                               \
	 HRTIM_OUTR_DLYPRTEN) /*!< Output 1 and output2 delayed Idle on external Event 7 or 9 */
#define HRTIM_TIMDELAYEDPROTECTION_BALANCED_EEV79                                                  \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRT_0 |                         \
	 HRTIM_OUTR_DLYPRTEN) /*!< Balanced Idle on external Event 7 or 9 */
...
#define HRTIM_TIMUPDATETRIGGER_MASTER                                                              \
	(HRTIM_TIMCR_MSTU) /*!< Register update is triggered by the master timer update */
#define HRTIM_TIMUPDATETRIGGER_TIMER_A                                                             \
	(HRTIM_TIMCR_TAU) /*!< Register update is triggered by the timer A update */
#define HRTIM_TIMUPDATETRIGGER_TIMER_B                                                             \
	(HRTIM_TIMCR_TBU) /*!< Register update is triggered by the timer B update */
#define HRTIM_TIMUPDATETRIGGER_TIMER_C                                                             \
	(HRTIM_TIMCR_TCU) /*!< Register update is triggered by the timer C update*/
#define HRTIM_TIMUPDATETRIGGER_TIMER_D                                                             \
	(HRTIM_TIMCR_TDU) /*!< Register update is triggered by the timer D update */
#define HRTIM_TIMUPDATETRIGGER_TIMER_E                                                             \
	(HRTIM_TIMCR_TEU) /*!< Register update is triggered by the timer E update */
...
#define HRTIM_TIMRESETTRIGGER_CMP2                                                                 \
	(HRTIM_RSTR_CMP2) /*!< The timer counter is reset upon Timer Compare 2 event */
#define HRTIM_TIMRESETTRIGGER_CMP4                                                                 \
	(HRTIM_RSTR_CMP4) /*!< The timer counter is reset upon Timer Compare 4 event */
#define HRTIM_TIMRESETTRIGGER_MASTER_PER                                                           \
	(HRTIM_RSTR_MSTPER) /*!< The timer counter is reset upon master timer period event */
#define HRTIM_TIMRESETTRIGGER_MASTER_CMP1                                                          \
	(HRTIM_RSTR_MSTCMP1) /*!< The timer counter is reset upon master timer Compare 1 event */
#define HRTIM_TIMRESETTRIGGER_MASTER_CMP2                                                          \
	(HRTIM_RSTR_MSTCMP2) /*!< The timer counter is reset upon master timer Compare 2 event */
#define HRTIM_TIMRESETTRIGGER_MASTER_CMP3                                                          \
	(HRTIM_RSTR_MSTCMP3) /*!< The timer counter is reset upon master timer Compare 3 event */
#define HRTIM_TIMRESETTRIGGER_MASTER_CMP4                                                          \
	(HRTIM_RSTR_MSTCMP4) /*!< The timer counter is reset upon master timer Compare 4 event */
#define HRTIM_TIMRESETTRIGGER_EEV_1                                                                \
	(HRTIM_RSTR_EXTEVNT1) /*!< The timer counter is reset upon external event 1 */
#define HRTIM_TIMRESETTRIGGER_EEV_2                                                                \
	(HRTIM_RSTR_EXTEVNT2) /*!< The timer counter is reset upon external event 2 */
#define HRTIM_TIMRESETTRIGGER_EEV_3                                                                \
	(HRTIM_RSTR_EXTEVNT3) /*!< The timer counter is reset upon external event 3 */
#define HRTIM_TIMRESETTRIGGER_EEV_4                                                                \
	(HRTIM_RSTR_EXTEVNT4) /*!< The timer counter is reset upon external event 4 */
#define HRTIM_TIMRESETTRIGGER_EEV_5                                                                \
	(HRTIM_RSTR_EXTEVNT5) /*!< The timer counter is reset upon external event 5 */
#define HRTIM_TIMRESETTRIGGER_EEV_6                                                                \
	(HRTIM_RSTR_EXTEVNT6) /*!< The timer counter is reset upon external event 6 */
#define HRTIM_TIMRESETTRIGGER_EEV_7                                                                \
	(HRTIM_RSTR_EXTEVNT7) /*!< The timer counter is reset upon external event 7 */
#define HRTIM_TIMRESETTRIGGER_EEV_8                                                                \
	(HRTIM_RSTR_EXTEVNT8) /*!< The timer counter is reset upon external event 8 */
#define HRTIM_TIMRESETTRIGGER_EEV_9                                                                \
	(HRTIM_RSTR_EXTEVNT9) /*!< The timer counter is reset upon external event 9 */
#define HRTIM_TIMRESETTRIGGER_EEV_10                                                               \
	(HRTIM_RSTR_EXTEVNT10) /*!< The timer counter is reset upon external event 10 */
#define HRTIM_TIMRESETTRIGGER_OTHER1_CMP1                                                          \
	(HRTIM_RSTR_TIMBCMP1) /*!< The timer counter is reset upon other timer Compare 1 event */
#define HRTIM_TIMRESETTRIGGER_OTHER1_CMP2                                                          \
	(HRTIM_RSTR_TIMBCMP2) /*!< The timer counter is reset upon other timer Compare 2 event */
#define HRTIM_TIMRESETTRIGGER_OTHER1_CMP4                                                          \
	(HRTIM_RSTR_TIMBCMP4) /*!< The timer counter is reset upon other timer Compare 4 event */
#define HRTIM_TIMRESETTRIGGER_OTHER2_CMP1                                                          \
	(HRTIM_RSTR_TIMCCMP1) /*!< The timer counter is reset upon other timer Compare 1 event */
#define HRTIM_TIMRESETTRIGGER_OTHER2_CMP2                                                          \
	(HRTIM_RSTR_TIMCCMP2) /*!< The timer counter is reset upon other timer Compare 2 event */
#define HRTIM_TIMRESETTRIGGER_OTHER2_CMP4                                                          \
	(HRTIM_RSTR_TIMCCMP4) /*!< The timer counter is reset upon other timer Compare 4 event */
#define HRTIM_TIMRESETTRIGGER_OTHER3_CMP1                                                          \
	(HRTIM_RSTR_TIMDCMP1) /*!< The timer counter is reset upon other timer Compare 1 event */
#define HRTIM_TIMRESETTRIGGER_OTHER3_CMP2                                                          \
	(HRTIM_RSTR_TIMDCMP2) /*!< The timer counter is reset upon other timer Compare 2 event */
#define HRTIM_TIMRESETTRIGGER_OTHER3_CMP4                                                          \
	(HRTIM_RSTR_TIMDCMP4) /*!< The timer counter is reset upon other timer Compare 4 event */
#define HRTIM_TIMRESETTRIGGER_OTHER4_CMP1                                                          \
	(HRTIM_RSTR_TIMECMP1) /*!< The timer counter is reset upon other timer Compare 1 event */
#define HRTIM_TIMRESETTRIGGER_OTHER4_CMP2                                                          \
	(HRTIM_RSTR_TIMECMP2) /*!< The timer counter is reset upon other timer Compare 2 event */
#define HRTIM_TIMRESETTRIGGER_OTHER4_CMP4                                                          \
	(HRTIM_RSTR_TIMECMP4) /*!< The timer counter is reset upon other timer Compare 4 event */
...
#define HRTIM_TIMUPDATEONRESET_DISABLED                                                            \
	(uint32_t)0x00000000 /*!< Update by timer x reset / rollover disabled */
#define HRTIM_TIMUPDATEONRESET_ENABLED                                                             \
	(HRTIM_TIMCR_TRSTU) /*!< Update by timer x reset / rollover enabled */
...
#define HRTIM_AUTODELAYEDMODE_AUTODELAYED_NOTIMEOUT                                                \
	(HRTIM_TIMCR_DELCMP2_0) /*!< Compare event generated only if a capture has occured */
...
#define HRTIM_AUTODELAYEDMODE_AUTODELAYED_TIMEOUTCMP3                                              \
	(HRTIM_TIMCR_DELCMP2_1 |                                                                   \
	 HRTIM_TIMCR_DELCMP2_0) /*!< Compare event generated if a capture has occurred or after a Compare 3 match (timeout if capture event is missing) */
...
#define HRTIM_BASICOCMODE_TOGGLE                                                                   \
	((uint32_t)0x00000001) /*!< Output toggles when the timer counter reaches the compare value */
#define HRTIM_BASICOCMODE_INACTIVE                                                                 \
	((uint32_t)0x00000002) /*!< Output forced to active level when the timer counter reaches the compare value */
#define HRTIM_BASICOCMODE_ACTIVE                                                                   \
	((uint32_t)0x00000003) /*!< Output forced to inactive level when the timer counter reaches the compare value */
...
#define HRTIM_OUTPUTSET_RESYNC                                                                     \
	(HRTIM_SET1R_RESYNC) /*!< Timer reset event coming solely from software or SYNC input forces the output to its active state */
#define HRTIM_OUTPUTSET_TIMPER                                                                     \
	(HRTIM_SET1R_PER) /*!< Timer period event forces the output to its active state */
#define HRTIM_OUTPUTSET_TIMCMP1                                                                    \
	(HRTIM_SET1R_CMP1) /*!< Timer compare 1 event forces the output to its active state */
#define HRTIM_OUTPUTSET_TIMCMP2                                                                    \
	(HRTIM_SET1R_CMP2) /*!< Timer compare 2 event forces the output to its active state */
#define HRTIM_OUTPUTSET_TIMCMP3                                                                    \
	(HRTIM_SET1R_CMP3) /*!< Timer compare 3 event forces the output to its active state */
#define HRTIM_OUTPUTSET_TIMCMP4                                                                    \
	(HRTIM_SET1R_CMP4) /*!< Timer compare 4 event forces the output to its active state */
#define HRTIM_OUTPUTSET_MASTERPER                                                                  \
	(HRTIM_SET1R_MSTPER) /*!< The master timer period event forces the output to its active state */
#define HRTIM_OUTPUTSET_MASTERCMP1                                                                 \
	(HRTIM_SET1R_MSTCMP1) /*!< Master Timer compare 1 event forces the output to its active state */
#define HRTIM_OUTPUTSET_MASTERCMP2                                                                 \
	(HRTIM_SET1R_MSTCMP2) /*!< Master Timer compare 2 event forces the output to its active state */
#define HRTIM_OUTPUTSET_MASTERCMP3                                                                 \
	(HRTIM_SET1R_MSTCMP3) /*!< Master Timer compare 3 event forces the output to its active state */
#define HRTIM_OUTPUTSET_MASTERCMP4                                                                 \
	(HRTIM_SET1R_MSTCMP4) /*!< Master Timer compare 4 event forces the output to its active state */
#define HRTIM_OUTPUTSET_TIMEV_1                                                                    \
	(HRTIM_SET1R_TIMEVNT1) /*!< Timer event 1 forces the output to its active state */
#define HRTIM_OUTPUTSET_TIMEV_2                                                                    \
	(HRTIM_SET1R_TIMEVNT2) /*!< Timer event 2 forces the output to its active state */
#define HRTIM_OUTPUTSET_TIMEV_3                                                                    \
	(HRTIM_SET1R_TIMEVNT3) /*!< Timer event 3 forces the output to its active state */
#define HRTIM_OUTPUTSET_TIMEV_4                                                                    \
	(HRTIM_SET1R_TIMEVNT4) /*!< Timer event 4 forces the output to its active state */
#define HRTIM_OUTPUTSET_TIMEV_5                                                                    \
	(HRTIM_SET1R_TIMEVNT5) /*!< Timer event 5 forces the output to its active state */
#define HRTIM_OUTPUTSET_TIMEV_6                                                                    \
	(HRTIM_SET1R_TIMEVNT6) /*!< Timer event 6 forces the output to its active state */
#define HRTIM_OUTPUTSET_TIMEV_7                                                                    \
	(HRTIM_SET1R_TIMEVNT7) /*!< Timer event 7 forces the output to its active state */
#define HRTIM_OUTPUTSET_TIMEV_8                                                                    \
	(HRTIM_SET1R_TIMEVNT8) /*!< Timer event 8 forces the output to its active state */
#define HRTIM_OUTPUTSET_TIMEV_9                                                                    \
	(HRTIM_SET1R_TIMEVNT9) /*!< Timer event 9 forces the output to its active state */
#define HRTIM_OUTPUTSET_EEV_1                                                                      \
	(HRTIM_SET1R_EXTVNT1) /*!< External event 1 forces the output to its active state */
#define HRTIM_OUTPUTSET_EEV_2                                                                      \
	(HRTIM_SET1R_EXTVNT2) /*!< External event 2 forces the output to its active state */
#define HRTIM_OUTPUTSET_EEV_3                                                                      \
	(HRTIM_SET1R_EXTVNT3) /*!< External event 3 forces the output to its active state */
#define HRTIM_OUTPUTSET_EEV_4                                                                      \
	(HRTIM_SET1R_EXTVNT4) /*!< External event 4 forces the output to its active state */
#define HRTIM_OUTPUTSET_EEV_5                                                                      \
	(HRTIM_SET1R_EXTVNT5) /*!< External event 5 forces the output to its active state */
#define HRTIM_OUTPUTSET_EEV_6                                                                      \
	(HRTIM_SET1R_EXTVNT6) /*!< External event 6 forces the output to its active state */
#define HRTIM_OUTPUTSET_EEV_7                                                                      \
	(HRTIM_SET1R_EXTVNT7) /*!< External event 7 forces the output to its active state */
#define HRTIM_OUTPUTSET_EEV_8                                                                      \
	(HRTIM_SET1R_EXTVNT8) /*!< External event 8 forces the output to its active state */
#define HRTIM_OUTPUTSET_EEV_9                                                                      \
	(HRTIM_SET1R_EXTVNT9) /*!< External event 9 forces the output to its active state */
#define HRTIM_OUTPUTSET_EEV_10                                                                     \
	(HRTIM_SET1R_EXTVNT10) /*!< External event 10 forces the output to its active state */
#define HRTIM_OUTPUTSET_UPDATE                                                                     \
	(HRTIM_SET1R_UPDATE) /*!< Timer register update event forces the output to its active state */

#define IS_HRTIM_OUTPUTSET(OUTPUTSET)                                                              \
	(((OUTPUTSET) == HRTIM_OUTPUTSET_NONE) || ((OUTPUTSET) == HRTIM_OUTPUTSET_RESYNC) ||       \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMPER) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMCMP1) ||    \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMCMP2) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMCMP3) ||   \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMCMP4) || ((OUTPUTSET) == HRTIM_OUTPUTSET_MASTERPER) || \
	 ...
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMEV_1) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMEV_2) ||   \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMEV_3) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMEV_4) ||   \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMEV_5) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMEV_6) ||   \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMEV_7) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMEV_8) ||   \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMEV_9) || ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_1) ||     \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_2) || ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_3) ||       \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_4) || ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_5) ||       \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_6) || ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_7) ||       \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_8) || ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_9) ||       \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_10) || ((OUTPUTSET) == HRTIM_OUTPUTSET_UPDATE))
/**
  * @}
  */
...
#define HRTIM_OUTPUTRESET_RESYNC                                                                   \
	(HRTIM_RST1R_RESYNC) /*!< Timer reset event coming solely from software or SYNC input forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_TIMPER                                                                   \
	(HRTIM_RST1R_PER) /*!< Timer period event forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_TIMCMP1                                                                  \
	(HRTIM_RST1R_CMP1) /*!< Timer compare 1 event forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_TIMCMP2                                                                  \
	(HRTIM_RST1R_CMP2) /*!< Timer compare 2 event forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_TIMCMP3                                                                  \
	(HRTIM_RST1R_CMP3) /*!< Timer compare 3 event forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_TIMCMP4                                                                  \
	(HRTIM_RST1R_CMP4) /*!< Timer compare 4 event forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_MASTERPER                                                                \
	(HRTIM_RST1R_MSTPER) /*!< The master timer period event forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_MASTERCMP1                                                               \
	(HRTIM_RST1R_MSTCMP1) /*!< Master Timer compare 1 event forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_MASTERCMP2                                                               \
	(HRTIM_RST1R_MSTCMP2) /*!< Master Timer compare 2 event forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_MASTERCMP3                                                               \
	(HRTIM_RST1R_MSTCMP3) /*!< Master Timer compare 3 event forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_MASTERCMP4                                                               \
	(HRTIM_RST1R_MSTCMP4) /*!< Master Timer compare 4 event forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_TIMEV_1                                                                  \
	(HRTIM_RST1R_TIMEVNT1) /*!< Timer event 1 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_TIMEV_2                                                                  \
	(HRTIM_RST1R_TIMEVNT2) /*!< Timer event 2 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_TIMEV_3                                                                  \
	(HRTIM_RST1R_TIMEVNT3) /*!< Timer event 3 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_TIMEV_4                                                                  \
	(HRTIM_RST1R_TIMEVNT4) /*!< Timer event 4 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_TIMEV_5                                                                  \
	(HRTIM_RST1R_TIMEVNT5) /*!< Timer event 5 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_TIMEV_6                                                                  \
	(HRTIM_RST1R_TIMEVNT6) /*!< Timer event 6 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_TIMEV_7                                                                  \
	(HRTIM_RST1R_TIMEVNT7) /*!< Timer event 7 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_TIMEV_8                                                                  \
	(HRTIM_RST1R_TIMEVNT8) /*!< Timer event 8 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_TIMEV_9                                                                  \
	(HRTIM_RST1R_TIMEVNT9) /*!< Timer event 9 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_EEV_1                                                                    \
	(HRTIM_RST1R_EXTVNT1) /*!< External event 1 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_EEV_2                                                                    \
	(HRTIM_RST1R_EXTVNT2) /*!< External event 2 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_EEV_3                                                                    \
	(HRTIM_RST1R_EXTVNT3) /*!< External event 3 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_EEV_4                                                                    \
	(HRTIM_RST1R_EXTVNT4) /*!< External event 4 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_EEV_5                                                                    \
	(HRTIM_RST1R_EXTVNT5) /*!< External event 5 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_EEV_6                                                                    \
	(HRTIM_RST1R_EXTVNT6) /*!< External event 6 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_EEV_7                                                                    \
	(HRTIM_RST1R_EXTVNT7) /*!< External event 7 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_EEV_8                                                                    \
	(HRTIM_RST1R_EXTVNT8) /*!< External event 8 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_EEV_9                                                                    \
	(HRTIM_RST1R_EXTVNT9) /*!< External event 9 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_EEV_10                                                                   \
	(HRTIM_RST1R_EXTVNT10) /*!< External event 10 forces the output to its inactive state */
#define HRTIM_OUTPUTRESET_UPDATE                                                                   \
	(HRTIM_RST1R_UPDATE) /*!< Timer register update event forces the output to its inactive state */
...
#define HRTIM_OUTPUTIDLEMODE_NONE                                                                  \
	(uint32_t)0x00000000 /*!< The output is not affected by the burst mode operation */
#define HRTIM_OUTPUTIDLEMODE_IDLE                                                                  \
	(HRTIM_OUTR_IDLM1) /*!< The output is in idle state when requested by the burst mode controller */
...
#define HRTIM_OUTPUTIDLESTATE_INACTIVE                                                             \
	(uint32_t)0x00000000 /*!< Output at inactive level when in IDLE state */
#define HRTIM_OUTPUTIDLESTATE_ACTIVE                                                               \
	(HRTIM_OUTR_IDLES1) /*!< Output at active level when in IDLE state */
...
#define HRTIM_OUTPUTFAULTSTATE_NONE                                                                \
	(uint32_t)0x00000000 /*!< The output is not affected by the fault input */
#define HRTIM_OUTPUTFAULTSTATE_ACTIVE                                                              \
	(HRTIM_OUTR_FAULT1_0) /*!< Output at active level when in FAULT state */
#define HRTIM_OUTPUTFAULTSTATE_INACTIVE                                                            \
	(HRTIM_OUTR_FAULT1_1) /*!< Output at inactive level when in FAULT state */
#define HRTIM_OUTPUTFAULTSTATE_HIGHZ                                                               \
	(HRTIM_OUTR_FAULT1_1 | HRTIM_OUTR_FAULT1_0) /*!< Output is tri-stated when in FAULT state */
...
#define HRTIM_OUTPUTCHOPPERMODE_ENABLED                                                            \
	(HRTIM_OUTR_CHP1) /*!< Output at active level when in FAULT state */
...
#define HRTIM_OUTPUTBURSTMODEENTRY_REGULAR                                                         \
	(uint32_t)0x00000000 /*!< The programmed Idle state is applied immediately to the Output */
#define HRTIM_OUTPUTBURSTMODEENTRY_DELAYED                                                         \
	(HRTIM_OUTR_DIDL1) /*!< Deadtime is inserted on output before entering the idle mode */
...
#define HRTIM_CAPTURETRIGGER_UPDATE                                                                \
	(HRTIM_CPT1CR_UPDCPT) /*!< The update event triggers the Capture */
#define HRTIM_CAPTURETRIGGER_EEV_1                                                                 \
	(HRTIM_CPT1CR_EXEV1CPT) /*!< The External event 1 triggers the Capture */
#define HRTIM_CAPTURETRIGGER_EEV_2                                                                 \
	(HRTIM_CPT1CR_EXEV2CPT) /*!< The External event 2 triggers the Capture */
#define HRTIM_CAPTURETRIGGER_EEV_3                                                                 \
	(HRTIM_CPT1CR_EXEV3CPT) /*!< The External event 3 triggers the Capture */
#define HRTIM_CAPTURETRIGGER_EEV_4                                                                 \
	(HRTIM_CPT1CR_EXEV4CPT) /*!< The External event 4 triggers the Capture */
#define HRTIM_CAPTURETRIGGER_EEV_5                                                                 \
	(HRTIM_CPT1CR_EXEV5CPT) /*!< The External event 5 triggers the Capture */
#define HRTIM_CAPTURETRIGGER_EEV_6                                                                 \
	(HRTIM_CPT1CR_EXEV6CPT) /*!< The External event 6 triggers the Capture */
#define HRTIM_CAPTURETRIGGER_EEV_7                                                                 \
	(HRTIM_CPT1CR_EXEV7CPT) /*!< The External event 7 triggers the Capture */
#define HRTIM_CAPTURETRIGGER_EEV_8                                                                 \
	(HRTIM_CPT1CR_EXEV8CPT) /*!< The External event 8 triggers the Capture */
#define HRTIM_CAPTURETRIGGER_EEV_9                                                                 \
	(HRTIM_CPT1CR_EXEV9CPT) /*!< The External event 9 triggers the Capture */
#define HRTIM_CAPTURETRIGGER_EEV_10                                                                \
	(HRTIM_CPT1CR_EXEV10CPT) /*!< The External event 10 triggers the Capture */
#define HRTIM_CAPTURETRIGGER_TA1_SET                                                               \
	(HRTIM_CPT1CR_TA1SET) /*!< Capture is triggered by TA1 output inactive to active transition */
#define HRTIM_CAPTURETRIGGER_TA1_RESET                                                             \
	(HRTIM_CPT1CR_TA1RST) /*!< Capture is triggered by TA1 output active to inactive transition */
#define HRTIM_CAPTURETRIGGER_TIMERA_CMP1                                                           \
	(HRTIM_CPT1CR_TA1CMP1) /*!< Timer A Compare 1 triggers Capture */
#define HRTIM_CAPTURETRIGGER_TIMERA_CMP2                                                           \
	(HRTIM_CPT1CR_TA1CMP2) /*!< Timer A Compare 2 triggers Capture */
#define HRTIM_CAPTURETRIGGER_TB1_SET                                                               \
	(HRTIM_CPT1CR_TB1SET) /*!< Capture is triggered by TB1 output inactive to active transition */
#define HRTIM_CAPTURETRIGGER_TB1_RESET                                                             \
	(HRTIM_CPT1CR_TB1RST) /*!< Capture is triggered by TB1 output active to inactive transition */
#define HRTIM_CAPTURETRIGGER_TIMERB_CMP1                                                           \
	(HRTIM_CPT1CR_TB1CMP1) /*!< Timer B Compare 1 triggers Capture */
#define HRTIM_CAPTURETRIGGER_TIMERB_CMP2                                                           \
	(HRTIM_CPT1CR_TB1CMP2) /*!< Timer B Compare 2 triggers Capture */
#define HRTIM_CAPTURETRIGGER_TC1_SET                                                               \
	(HRTIM_CPT1CR_TC1SET) /*!< Capture is triggered by TC1 output inactive to active transition */
#define HRTIM_CAPTURETRIGGER_TC1_RESET                                                             \
	(HRTIM_CPT1CR_TC1RST) /*!< Capture is triggered by TC1 output active to inactive transition */
#define HRTIM_CAPTURETRIGGER_TIMERC_CMP1                                                           \
	(HRTIM_CPT1CR_TC1CMP1) /*!< Timer C Compare 1 triggers Capture */
#define HRTIM_CAPTURETRIGGER_TIMERC_CMP2                                                           \
	(HRTIM_CPT1CR_TC1CMP2) /*!< Timer C Compare 2 triggers Capture */
#define HRTIM_CAPTURETRIGGER_TD1_SET                                                               \
	(HRTIM_CPT1CR_TD1SET) /*!< Capture is triggered by TD1 output inactive to active transition */
#define HRTIM_CAPTURETRIGGER_TD1_RESET                                                             \
	(HRTIM_CPT1CR_TD1RST) /*!< Capture is triggered by TD1 output active to inactive transition */
#define HRTIM_CAPTURETRIGGER_TIMERD_CMP1                                                           \
	(HRTIM_CPT1CR_TD1CMP1) /*!< Timer D Compare 1 triggers Capture */
#define HRTIM_CAPTURETRIGGER_TIMERD_CMP2                                                           \
	(HRTIM_CPT1CR_TD1CMP2) /*!< Timer D Compare 2 triggers Capture */
#define HRTIM_CAPTURETRIGGER_TE1_SET                                                               \
	(HRTIM_CPT1CR_TE1SET) /*!< Capture is triggered by TE1 output inactive to active transition */
#define HRTIM_CAPTURETRIGGER_TE1_RESET                                                             \
	(HRTIM_CPT1CR_TE1RST) /*!< Capture is triggered by TE1 output active to inactive transition */
#define HRTIM_CAPTURETRIGGER_TIMERE_CMP1                                                           \
	(HRTIM_CPT1CR_TE1CMP1) /*!< Timer E Compare 1 triggers Capture */
#define HRTIM_CAPTURETRIGGER_TIMERE_CMP2                                                           \
	(HRTIM_CPT1CR_TE1CMP2) /*!< Timer E Compare 2 triggers Capture */
...
#define HRTIM_TIMEVENTFILTER_BLANKINGCMP1                                                          \
	(HRTIM_EEFR1_EE1FLTR_0) /*!< Blanking from counter reset/roll-over to Compare 1 */
#define HRTIM_TIMEVENTFILTER_BLANKINGCMP2                                                          \
	(HRTIM_EEFR1_EE1FLTR_1) /*!< Blanking from counter reset/roll-over to Compare 2 */
#define HRTIM_TIMEVENTFILTER_BLANKINGCMP3                                                          \
	(HRTIM_EEFR1_EE1FLTR_1 |                                                                   \
	 HRTIM_EEFR1_EE1FLTR_0) /*!< Blanking from counter reset/roll-over to Compare 3 */
#define HRTIM_TIMEVENTFILTER_BLANKINGCMP4                                                          \
	(HRTIM_EEFR1_EE1FLTR_2) /*!< Blanking from counter reset/roll-over to Compare 4 */
#define HRTIM_TIMEVENTFILTER_BLANKINGFLTR1                                                         \
	(HRTIM_EEFR1_EE1FLTR_2 |                                                                   \
	 HRTIM_EEFR1_EE1FLTR_0) /*!< Blanking from another timing unit: TIMFLTR1 source */
#define HRTIM_TIMEVENTFILTER_BLANKINGFLTR2                                                         \
	(HRTIM_EEFR1_EE1FLTR_2 |                                                                   \
	 HRTIM_EEFR1_EE1FLTR_1) /*!< Blanking from another timing unit: TIMFLTR2 source */
#define HRTIM_TIMEVENTFILTER_BLANKINGFLTR3                                                         \
	(HRTIM_EEFR1_EE1FLTR_2 | HRTIM_EEFR1_EE1FLTR_1 |                                           \
	 HRTIM_EEFR1_EE1FLTR_0) /*!< Blanking from another timing unit: TIMFLTR3 source */
#define HRTIM_TIMEVENTFILTER_BLANKINGFLTR4                                                         \
	(HRTIM_EEFR1_EE1FLTR_3) /*!< Blanking from another timing unit: TIMFLTR4 source */
#define HRTIM_TIMEVENTFILTER_BLANKINGFLTR5                                                         \
	(HRTIM_EEFR1_EE1FLTR_3 |                                                                   \
	 HRTIM_EEFR1_EE1FLTR_0) /*!< Blanking from another timing unit: TIMFLTR5 source */
#define HRTIM_TIMEVENTFILTER_BLANKINGFLTR6                                                         \
	(HRTIM_EEFR1_EE1FLTR_3 |                                                                   \
	 HRTIM_EEFR1_EE1FLTR_1) /*!< Blanking from another timing unit: TIMFLTR6 source */
#define HRTIM_TIMEVENTFILTER_BLANKINGFLTR7                                                         \
	(HRTIM_EEFR1_EE1FLTR_3 | HRTIM_EEFR1_EE1FLTR_1 |                                           \
	 HRTIM_EEFR1_EE1FLTR_0) /*!< Blanking from another timing unit: TIMFLTR7 source */
#define HRTIM_TIMEVENTFILTER_BLANKINGFLTR8                                                         \
	(HRTIM_EEFR1_EE1FLTR_3 |                                                                   \
	 HRTIM_EEFR1_EE1FLTR_2) /*!< Blanking from another timing unit: TIMFLTR8 source */
#define HRTIM_TIMEVENTFILTER_WINDOWINGCMP2                                                         \
	(HRTIM_EEFR1_EE1FLTR_3 | HRTIM_EEFR1_EE1FLTR_2 |                                           \
	 HRTIM_EEFR1_EE1FLTR_0) /*!< Windowing from counter reset/roll-over to Compare 2 */
#define HRTIM_TIMEVENTFILTER_WINDOWINGCMP3                                                         \
	(HRTIM_EEFR1_EE1FLTR_3 | HRTIM_EEFR1_EE1FLTR_2 |                                           \
	 HRTIM_EEFR1_EE1FLTR_1) /*!< Windowing from counter reset/roll-over to Compare 3 */
...
#define HRTIM_TIMEVENTLATCH_DISABLED                                                               \
	((uint32_t)0x00000000) /*!< Event is ignored if it happens during a blank, or passed through during a window */
#define HRTIM_TIMEVENTLATCH_ENABLED                                                                \
	HRTIM_EEFR1_EE1LTCH /*!< Event 1 is latched and delayed till the end of the blanking or windowing period */ /*!< Blanking from counter reset/roll-over to Compare 1 */
...
#define HRTIM_TIMDEADTIME_RISINGSIGN_POSITIVE                                                      \
	((uint32_t)0x00000000) /*!< Positive deadtime on rising edge */
#define HRTIM_TIMDEADTIME_RISINGSIGN_NEGATIVE                                                      \
	(HRTIM_DTR_SDTR) /*!< Negative deadtime on rising edge */
...
/** @defgroup HRTIM_DeadtimeRisingLock
  ...
  */
#define HRTIM_TIMDEADTIME_RISINGLOCK_WRITE                                                         \
	((uint32_t)0x00000000) /*!< Deadtime rising value and sign is writable */
#define HRTIM_TIMDEADTIME_RISINGLOCK_READONLY                                                      \
	(HRTIM_DTR_DTRLK) /*!< Deadtime rising value and sign is read-only */
...
#define HRTIM_TIMDEADTIME_RISINGSIGNLOCK_WRITE                                                     \
	((uint32_t)0x00000000) /*!< Deadtime rising sign is writable */
#define HRTIM_TIMDEADTIME_RISINGSIGNLOCK_READONLY                                                  \
	(HRTIM_DTR_DTRSLK) /*!< Deadtime rising sign is read-only */
...
/** @defgroup HRTIM_DeadtimeFallingSign
  ...
  */
#define HRTIM_TIMDEADTIME_FALLINGSIGN_POSITIVE                                                     \
	((uint32_t)0x00000000) /*!< Positive deadtime on falling edge */
#define HRTIM_TIMDEADTIME_FALLINGSIGN_NEGATIVE                                                     \
	(HRTIM_DTR_SDTF) /*!< Negative deadtime on falling edge */
...
/** @defgroup HRTIM_DeadtimeFallingLock
  ...
  *        value) is write protected
  */
#define HRTIM_TIMDEADTIME_FALLINGLOCK_WRITE                                                        \
	((uint32_t)0x00000000) /*!< Deadtime falling value and sign is writable */
#define HRTIM_TIMDEADTIME_FALLINGLOCK_READONLY                                                     \
	(HRTIM_DTR_DTFLK) /*!< Deadtime falling value and sign is read-only */
...
/** @defgroup HRTIM_DeadtimeFallingSignLock
  ...
  *        protected
  */
#define HRTIM_TIMDEADTIME_FALLINGSIGNLOCK_WRITE                                                    \
	((uint32_t)0x00000000) /*!< Deadtime falling sign is writable */
#define HRTIM_TIMDEADTIME_FALLINGSIGNLOCK_READONLY                                                 \
	(HRTIM_DTR_DTFSLK) /*!< Deadtime falling sign is read-only */
...
#define HRTIM_SYNCINPUTSOURCE_NONE                                                                 \
	(uint32_t)0x00000000 /*!< disabled. HRTIM is not synchronized and runs in standalone mode */
#define HRTIM_SYNCINPUTSOURCE_INTERNALEVENT                                                        \
	HRTIM_MCR_SYNC_IN_1 /*!< The HRTIM is synchronized with the on-chip timer */
#define HRTIM_SYNCINPUTSOURCE_EXTERNALEVENT                                                        \
	(HRTIM_MCR_SYNC_IN_1 |                                                                     \
	 HRTIM_MCR_SYNC_IN_0) /*!< A positive pulse on SYNCIN input triggers the HRTIM */
...
#define HRTIM_SYNCOUTPUTSOURCE_MASTER_START                                                        \
	(uint32_t)0x00000000 /*!< A pulse is sent on the SYNCOUT output (16x fHRTIM clock cycles) upon master timer start event */
#define HRTIM_SYNCOUTPUTSOURCE_MASTER_CMP1                                                         \
	(HRTIM_MCR_SYNC_SRC_0) /*!< A pulse is sent on the SYNCOUT output (16x fHRTIM clock cycles) upon master timer compare 1 event*/
#define HRTIM_SYNCOUTPUTSOURCE_TIMA_START                                                          \
	(HRTIM_MCR_SYNC_SRC_1) /*!< A pulse is sent on the SYNCOUT output (16x fHRTIM clock cycles) upon timer A start or reset events */
#define HRTIM_SYNCOUTPUTSOURCE_TIMA_CMP1                                                           \
	(HRTIM_MCR_SYNC_SRC_1 |                                                                    \
	 HRTIM_MCR_SYNC_SRC_0) /*!< A pulse is sent on the SYNCOUT output (16x fHRTIM clock cycles) upon timer A compare 1 event */
...
#define HRTIM_SYNCOUTPUTPOLARITY_NONE                                                              \
	(uint32_t)0x00000000 /*!< Synchronization output event is disabled */
#define HRTIM_SYNCOUTPUTPOLARITY_POSITIVE                                                          \
	(HRTIM_MCR_SYNC_OUT_0) /*!< Positive pulse on SCOUT output (16x fHRTIM clock cycles) */
...
#define HRTIM_EVENTSRC_4                                                                           \
	(HRTIM_EECR1_EE1SRC_1 | HRTIM_EECR1_EE1SRC_0) /*!< External event source 4 */

#define IS_HRTIM_EVENTSRC(EVENTSRC)                                                                \
	(((EVENTSRC) == HRTIM_EVENTSRC_1) || ((EVENTSRC) == HRTIM_EVENTSRC_2) ||                   \
	 ((EVENTSRC) == HRTIM_EVENTSRC_3) || ((EVENTSRC) == HRTIM_EVENTSRC_4))
/**
  * @}
  */
...
#define HRTIM_EVENTSENSITIVITY_LEVEL                                                               \
	((uint32_t)0x00000000) /*!< External event is active on level */
#define HRTIM_EVENTSENSITIVITY_RISINGEDGE                                                          \
	(HRTIM_EECR1_EE1SNS_0) /*!< External event is active on Rising edge */
#define HRTIM_EVENTSENSITIVITY_FALLINGEDGE                                                         \
	(HRTIM_EECR1_EE1SNS_1) /*!< External event is active on Falling edge */
#define HRTIM_EVENTSENSITIVITY_BOTHEDGES                                                           \
	(HRTIM_EECR1_EE1SNS_1 |                                                                    \
	 HRTIM_EECR1_EE1SNS_0) /*!< External event is active on Rising and Falling edges */
...
#define HRTIM_EVENTFASTMODE_DISABLE                                                                \
	((uint32_t)0x00000000) /*!< External Event is acting asynchronously on outputs (low latency mode) */
#define HRTIM_EVENTFASTMODE_ENABLE                                                                 \
	(HRTIM_EECR1_EE1FAST) /*!< External Event is re-synchronized by the HRTIM logic before acting on outputs */
...
#define IS_HRTIM_FASTMODE_AVAILABLE(EVENT)                                                         \
	(((EVENT) == HRTIM_EVENT_1) || ((EVENT) == HRTIM_EVENT_2) || ((EVENT) == HRTIM_EVENT_3) || \
	 ((EVENT) == HRTIM_EVENT_4) || ((EVENT) == HRTIM_EVENT_5))
/**
  * @}
  */
...
#define HRTIM_EVENTFILTER_5                                                                        \
	(HRTIM_EECR3_EE6F_2 | HRTIM_EECR3_EE6F_0) /*!< fSAMPLING= fEEVS/2, N=8 */
#define HRTIM_EVENTFILTER_6                                                                        \
	(HRTIM_EECR3_EE6F_2 | HRTIM_EECR3_EE6F_1) /*!< fSAMPLING= fEEVS/4, N=6 */
#define HRTIM_EVENTFILTER_7                                                                        \
	(HRTIM_EECR3_EE6F_2 | HRTIM_EECR3_EE6F_1 |                                                 \
	 HRTIM_EECR3_EE6F_0) /*!< fSAMPLING= fEEVS/4, N=8 */
#define HRTIM_EVENTFILTER_8 (HRTIM_EECR3_EE6F_3) /*!< fSAMPLING= fEEVS/8, N=6 */
#define HRTIM_EVENTFILTER_9                                                                        \
	(HRTIM_EECR3_EE6F_3 | HRTIM_EECR3_EE6F_0) /*!< fSAMPLING= fEEVS/8, N=8 */
#define HRTIM_EVENTFILTER_10                                                                       \
	(HRTIM_EECR3_EE6F_3 | HRTIM_EECR3_EE6F_1) /*!< fSAMPLING= fEEVS/16, N=5 */
#define HRTIM_EVENTFILTER_11                                                                       \
	(HRTIM_EECR3_EE6F_3 | HRTIM_EECR3_EE6F_1 |                                                 \
	 HRTIM_EECR3_EE6F_0) /*!< fSAMPLING= fEEVS/16, N=6 */
#define HRTIM_EVENTFILTER_12                                                                       \
	(HRTIM_EECR3_EE6F_3 | HRTIM_EECR3_EE6F_2) /*!< fSAMPLING= fEEVS/16, N=8 */
#define HRTIM_EVENTFILTER_13                                                                       \
	(HRTIM_EECR3_EE6F_3 | HRTIM_EECR3_EE6F_2 |                                                 \
	 HRTIM_EECR3_EE6F_0) /*!< fSAMPLING= fEEVS/32, N=5 */
#define HRTIM_EVENTFILTER_14                                                                       \
	(HRTIM_EECR3_EE6F_3 | HRTIM_EECR3_EE6F_2 |                                                 \
	 HRTIM_EECR3_EE6F_1) /*!< fSAMPLING= fEEVS/32, N=6 */
#define HRTIM_EVENTFILTER_15                                                                       \
	(HRTIM_EECR3_EE6F_3 | HRTIM_EECR3_EE6F_2 | HRTIM_EECR3_EE6F_1 |                            \
	 HRTIM_EECR3_EE6F_0) /*!< fSAMPLING= fEEVS/32, N=8 */

#define IS_HRTIM_EVENTFILTER(EVENTFILTER)                                                          \
	(((EVENTFILTER) == HRTIM_EVENTFILTER_NONE) || ((EVENTFILTER) == HRTIM_EVENTFILTER_1) ||    \
	 ((EVENTFILTER) == HRTIM_EVENTFILTER_2) || ((EVENTFILTER) == HRTIM_EVENTFILTER_3) ||       \
	 ((EVENTFILTER) == HRTIM_EVENTFILTER_4) || ((EVENTFILTER) == HRTIM_EVENTFILTER_5) ||       \
	 ((EVENTFILTER) == HRTIM_EVENTFILTER_6) || ((EVENTFILTER) == HRTIM_EVENTFILTER_7) ||       \
	 ((EVENTFILTER) == HRTIM_EVENTFILTER_8) || ((EVENTFILTER) == HRTIM_EVENTFILTER_9) ||       \
	 ((EVENTFILTER) == HRTIM_EVENTFILTER_10) || ((EVENTFILTER) == HRTIM_EVENTFILTER_11) ||     \
	 ((EVENTFILTER) == HRTIM_EVENTFILTER_12) || ((EVENTFILTER) == HRTIM_EVENTFILTER_13) ||     \
	 ((EVENTFILTER) == HRTIM_EVENTFILTER_14) || ((EVENTFILTER) == HRTIM_EVENTFILTER_15))
/**
  * @}
  */
...
#define HRTIM_EVENTPRESCALER_DIV8                                                                  \
	(HRTIM_EECR3_EEVSD_1 | HRTIM_EECR3_EEVSD_0) /*!< fEEVS=fHRTIM / 8 */
...
#define HRTIM_FAULTSOURCE_INTERNAL                                                                 \
	(HRTIM_FLTINR1_FLT1SRC) /*!< Fault input is FLT_Int signal (e.g. internal comparator) */
...
#define HRTIM_FAULTFILTER_3                                                                        \
	(HRTIM_FLTINR1_FLT1F_1 | HRTIM_FLTINR1_FLT1F_0) /*!< fSAMPLING= fHRTIM, N=8 */
#define HRTIM_FAULTFILTER_4 (HRTIM_FLTINR1_FLT1F_2) /*!< fSAMPLING= fFLTS/2, N=6 */
#define HRTIM_FAULTFILTER_5                                                                        \
	(HRTIM_FLTINR1_FLT1F_2 | HRTIM_FLTINR1_FLT1F_0) /*!< fSAMPLING= fFLTS/2, N=8 */
#define HRTIM_FAULTFILTER_6                                                                        \
	(HRTIM_FLTINR1_FLT1F_2 | HRTIM_FLTINR1_FLT1F_1) /*!< fSAMPLING= fFLTS/4, N=6 */
#define HRTIM_FAULTFILTER_7                                                                        \
	(HRTIM_FLTINR1_FLT1F_2 | HRTIM_FLTINR1_FLT1F_1 |                                           \
	 HRTIM_FLTINR1_FLT1F_0) /*!< fSAMPLING= fFLTS/4, N=8 */
#define HRTIM_FAULTFILTER_8 (HRTIM_FLTINR1_FLT1F_3) /*!< fSAMPLING= fFLTS/8, N=6 */
#define HRTIM_FAULTFILTER_9                                                                        \
	(HRTIM_FLTINR1_FLT1F_3 | HRTIM_FLTINR1_FLT1F_0) /*!< fSAMPLING= fFLTS/8, N=8 */
#define HRTIM_FAULTFILTER_10                                                                       \
	(HRTIM_FLTINR1_FLT1F_3 | HRTIM_FLTINR1_FLT1F_1) /*!< fSAMPLING= fFLTS/16, N=5 */
#define HRTIM_FAULTFILTER_11                                                                       \
	(HRTIM_FLTINR1_FLT1F_3 | HRTIM_FLTINR1_FLT1F_1 |                                           \
	 HRTIM_FLTINR1_FLT1F_0) /*!< fSAMPLING= fFLTS/16, N=6 */
#define HRTIM_FAULTFILTER_12                                                                       \
	(HRTIM_FLTINR1_FLT1F_3 | HRTIM_FLTINR1_FLT1F_2) /*!< fSAMPLING= fFLTS/16, N=8 */
#define HRTIM_FAULTFILTER_13                                                                       \
	(HRTIM_FLTINR1_FLT1F_3 | HRTIM_FLTINR1_FLT1F_2 |                                           \
	 HRTIM_FLTINR1_FLT1F_0) /*!< fSAMPLING= fFLTS/32, N=5 */
#define HRTIM_FAULTFILTER_14                                                                       \
	(HRTIM_FLTINR1_FLT1F_3 | HRTIM_FLTINR1_FLT1F_2 |                                           \
	 HRTIM_FLTINR1_FLT1F_1) /*!< fSAMPLING= fFLTS/32, N=6 */
#define HRTIM_FAULTFILTER_15                                                                       \
	(HRTIM_FLTINR1_FLT1F_3 | HRTIM_FLTINR1_FLT1F_2 | HRTIM_FLTINR1_FLT1F_1 |                   \
	 HRTIM_FLTINR1_FLT1F_0) /*!< fSAMPLING= fFLTS/32, N=8 */

#define IS_HRTIM_FAULTFILTER(FAULTFILTER)                                                          \
	(((FAULTFILTER) == HRTIM_FAULTFILTER_NONE) || ((FAULTFILTER) == HRTIM_FAULTFILTER_1) ||    \
	 ((FAULTFILTER) == HRTIM_FAULTFILTER_2) || ((FAULTFILTER) == HRTIM_FAULTFILTER_3) ||       \
	 ((FAULTFILTER) == HRTIM_FAULTFILTER_4) || ((FAULTFILTER) == HRTIM_FAULTFILTER_5) ||       \
	 ((FAULTFILTER) == HRTIM_FAULTFILTER_6) || ((FAULTFILTER) == HRTIM_FAULTFILTER_7) ||       \
	 ((FAULTFILTER) == HRTIM_FAULTFILTER_8) || ((FAULTFILTER) == HRTIM_FAULTFILTER_9) ||       \
	 ((FAULTFILTER) == HRTIM_FAULTFILTER_10) || ((FAULTFILTER) == HRTIM_FAULTFILTER_11) ||     \
	 ((FAULTFILTER) == HRTIM_FAULTFILTER_12) || ((FAULTFILTER) == HRTIM_FAULTFILTER_13) ||     \
	 ((FAULTFILTER) == HRTIM_FAULTFILTER_14) || ((FAULTFILTER) == HRTIM_FAULTFILTER_15))
/**
  * @}
  */
...
#define IS_HRTIM_FAULTLOCK(FAULTLOCK)                                                              \
	(((FAULTLOCK) == HRTIM_FAULTLOCK_READWRITE) || ((FAULTLOCK) == HRTIM_FAULTLOCK_READONLY))
/**
  * @}
  */
...
#define HRTIM_FAULTPRESCALER_DIV8                                                                  \
	(HRTIM_FLTINR2_FLTSD_1 | HRTIM_FLTINR2_FLTSD_0) /*!< fFLTS=fHRTIM / 8 */
...
#define HRTIM_BURSTMODE_SINGLESHOT                                                                 \
	((uint32_t)0x00000000) /*!< Burst mode operates in single shot mode */
...
#define IS_HRTIM_BURSTMODE(BURSTMODE)                                                              \
	(((BURSTMODE) == HRTIM_BURSTMODE_SINGLESHOT) || ((BURSTMODE) == HRTIM_BURSTMODE_CONTINOUS))
/**
  * @}
  */
...
#define HRTIM_BURSTMODECLOCKSOURCE_MASTER                                                          \
	((uint32_t)0x00000000) /*!< Master timer counter reset/roll-over is used as clock source for the burst mode counter */
#define HRTIM_BURSTMODECLOCKSOURCE_TIMER_A                                                         \
	(HRTIM_BMCR_BMCLK_0) /*!< Timer A counter reset/roll-over is used as clock source for the burst mode counter */
#define HRTIM_BURSTMODECLOCKSOURCE_TIMER_B                                                         \
	(HRTIM_BMCR_BMCLK_1) /*!< Timer B counter reset/roll-over is used as clock source for the burst mode counter */
#define HRTIM_BURSTMODECLOCKSOURCE_TIMER_C                                                         \
	(HRTIM_BMCR_BMCLK_1 |                                                                      \
	 HRTIM_BMCR_BMCLK_0) /*!< Timer C counter reset/roll-over is used as clock source for the burst mode counter */
#define HRTIM_BURSTMODECLOCKSOURCE_TIMER_D                                                         \
	(HRTIM_BMCR_BMCLK_2) /*!< Timer D counter reset/roll-over is used as clock source for the burst mode counter */
#define HRTIM_BURSTMODECLOCKSOURCE_TIMER_E                                                         \
	(HRTIM_BMCR_BMCLK_2 |                                                                      \
	 HRTIM_BMCR_BMCLK_0) /*!< Timer E counter reset/roll-over is used as clock source for the burst mode counter */
#define HRTIM_BURSTMODECLOCKSOURCE_ONCHIPEV_1                                                      \
	(HRTIM_BMCR_BMCLK_2 |                                                                      \
	 HRTIM_BMCR_BMCLK_1) /*!< On-chip Event 1 (BMClk[1]), acting as a burst mode counter clock */
...
#define HRTIM_BURSTMODECLOCKSOURCE_ONCHIPEV_4                                                      \
	(HRTIM_BMCR_BMCLK_3 |                                                                      \
	 HRTIM_BMCR_BMCLK_0) /*!< On-chip Event 4 (BMClk[4]), acting as a burst mode counter clock */
#define HRTIM_BURSTMODECLOCKSOURCE_FHRTIM                                                          \
	(HRTIM_BMCR_BMCLK_3 |                                                                      \
	 HRTIM_BMCR_BMCLK_1) /*!< Prescaled fHRTIM clock is used as clock source for the burst mode counter */
...
#define HRTIM_BURSTMODEPRESCALER_DIV8                                                              \
	(HRTIM_BMCR_BMPSC_1 | HRTIM_BMCR_BMPSC_0) /*!< fBRST = fHRTIM/8 */
#define HRTIM_BURSTMODEPRESCALER_DIV16 (HRTIM_BMCR_BMPSC_2) /*!< fBRST = fHRTIM/16 */
#define HRTIM_BURSTMODEPRESCALER_DIV32                                                             \
	(HRTIM_BMCR_BMPSC_2 | HRTIM_BMCR_BMPSC_0) /*!< fBRST = fHRTIM/32 */
#define HRTIM_BURSTMODEPRESCALER_DIV64                                                             \
	(HRTIM_BMCR_BMPSC_2 | HRTIM_BMCR_BMPSC_1) /*!< fBRST = fHRTIM/64 */
#define HRTIM_BURSTMODEPRESCALER_DIV128                                                            \
	(HRTIM_BMCR_BMPSC_2 | HRTIM_BMCR_BMPSC_1 | HRTIM_BMCR_BMPSC_0) /*!< fBRST = fHRTIM/128 */
#define HRTIM_BURSTMODEPRESCALER_DIV256 (HRTIM_BMCR_BMPSC_3) /*!< fBRST = fHRTIM/256 */
#define HRTIM_BURSTMODEPRESCALER_DIV512                                                            \
	(HRTIM_BMCR_BMPSC_3 | HRTIM_BMCR_BMPSC_0) /*!< fBRST = fHRTIM/512 */
#define HRTIM_BURSTMODEPRESCALER_DIV1024                                                           \
	(HRTIM_BMCR_BMPSC_3 | HRTIM_BMCR_BMPSC_1) /*!< fBRST = fHRTIM/1024 */
#define HRTIM_BURSTMODEPRESCALER_DIV2048                                                           \
	(HRTIM_BMCR_BMPSC_3 | HRTIM_BMCR_BMPSC_1 | HRTIM_BMCR_BMPSC_0) /*!< fBRST = fHRTIM/2048*/
#define HRTIM_BURSTMODEPRESCALER_DIV4096                                                           \
	(HRTIM_BMCR_BMPSC_3 | HRTIM_BMCR_BMPSC_2) /*!< fBRST = fHRTIM/4096 */
#define HRTIM_BURSTMODEPRESCALER_DIV8192                                                           \
	(HRTIM_BMCR_BMPSC_3 | HRTIM_BMCR_BMPSC_2 | HRTIM_BMCR_BMPSC_0) /*!< fBRST = fHRTIM/8192 */
#define HRTIM_BURSTMODEPRESCALER_DIV16384                                                          \
	(HRTIM_BMCR_BMPSC_3 | HRTIM_BMCR_BMPSC_2 | HRTIM_BMCR_BMPSC_1) /*!< fBRST = fHRTIM/16384 */
#define HRTIM_BURSTMODEPRESCALER_DIV32768                                                          \
	(HRTIM_BMCR_BMPSC_3 | HRTIM_BMCR_BMPSC_2 | HRTIM_BMCR_BMPSC_1 |                            \
	 HRTIM_BMCR_BMPSC_0) /*!< fBRST = fHRTIM/32768 */
...
#define HRIM_BURSTMODEPRELOAD_DISABLED                                                             \
	((uint32_t)0x00000000) /*!< Preload disabled: the write access is directly done into active registers */
#define HRIM_BURSTMODEPRELOAD_ENABLED                                                              \
	(HRTIM_BMCR_BMPREN) /*!< Preload enabled: the write access is done into preload registers */
...
#define HRTIM_BURSTMODETRIGGER_TIMERA_EVENT7                                                       \
	(HRTIM_BMTRGR_TAEEV7) /*!< Timer A period following External Event 7  */
#define HRTIM_BURSTMODETRIGGER_TIMERD_EVENT8                                                       \
	(HRTIM_BMTRGR_TDEEV8) /*!< Timer D period following External Event 8  */
...
#define HRTIM_ADCTRIGGEREVENT13_MASTER_CMP1                                                        \
	(HRTIM_ADC1R_AD1MC1) /*!< ADC Trigger on master compare 1 */
#define HRTIM_ADCTRIGGEREVENT13_MASTER_CMP2                                                        \
	(HRTIM_ADC1R_AD1MC2) /*!< ADC Trigger on master compare 2 */
#define HRTIM_ADCTRIGGEREVENT13_MASTER_CMP3                                                        \
	(HRTIM_ADC1R_AD1MC3) /*!< ADC Trigger on master compare 3 */
#define HRTIM_ADCTRIGGEREVENT13_MASTER_CMP4                                                        \
	(HRTIM_ADC1R_AD1MC4) /*!< ADC Trigger on master compare 4 */
#define HRTIM_ADCTRIGGEREVENT13_MASTER_PERIOD                                                      \
	(HRTIM_ADC1R_AD1MPER) /*!< ADC Trigger on master period */
#define HRTIM_ADCTRIGGEREVENT13_EVENT_1                                                            \
	(HRTIM_ADC1R_AD1EEV1) /*!< ADC Trigger on external event 1 */
#define HRTIM_ADCTRIGGEREVENT13_EVENT_2                                                            \
	(HRTIM_ADC1R_AD1EEV2) /*!< ADC Trigger on external event 2 */
#define HRTIM_ADCTRIGGEREVENT13_EVENT_3                                                            \
	(HRTIM_ADC1R_AD1EEV3) /*!< ADC Trigger on external event 3 */
#define HRTIM_ADCTRIGGEREVENT13_EVENT_4                                                            \
	(HRTIM_ADC1R_AD1EEV4) /*!< ADC Trigger on external event 4 */
#define HRTIM_ADCTRIGGEREVENT13_EVENT_5                                                            \
	(HRTIM_ADC1R_AD1EEV5) /*!< ADC Trigger on external event 5 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERA_CMP2                                                        \
	(HRTIM_ADC1R_AD1TAC2) /*!< ADC Trigger on Timer A compare 2 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERA_CMP3                                                        \
	(HRTIM_ADC1R_AD1TAC3) /*!< ADC Trigger on Timer A compare 3 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERA_CMP4                                                        \
	(HRTIM_ADC1R_AD1TAC4) /*!< ADC Trigger on Timer A compare 4 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERA_PERIOD                                                      \
	(HRTIM_ADC1R_AD1TAPER) /*!< ADC Trigger on Timer A period */
#define HRTIM_ADCTRIGGEREVENT13_TIMERA_RESET                                                       \
	(HRTIM_ADC1R_AD1TARST) /*!< ADC Trigger on Timer A reset */
#define HRTIM_ADCTRIGGEREVENT13_TIMERB_CMP2                                                        \
	(HRTIM_ADC1R_AD1TBC2) /*!< ADC Trigger on Timer B compare 2 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERB_CMP3                                                        \
	(HRTIM_ADC1R_AD1TBC3) /*!< ADC Trigger on Timer B compare 3 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERB_CMP4                                                        \
	(HRTIM_ADC1R_AD1TBC4) /*!< ADC Trigger on Timer B compare 4 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERB_PERIOD                                                      \
	(HRTIM_ADC1R_AD1TBPER) /*!< ADC Trigger on Timer B period */
#define HRTIM_ADCTRIGGEREVENT13_TIMERB_RESET                                                       \
	(HRTIM_ADC1R_AD1TBRST) /*!< ADC Trigger on Timer B reset */
#define HRTIM_ADCTRIGGEREVENT13_TIMERC_CMP2                                                        \
	(HRTIM_ADC1R_AD1TCC2) /*!< ADC Trigger on Timer C compare 2 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERC_CMP3                                                        \
	(HRTIM_ADC1R_AD1TCC3) /*!< ADC Trigger on Timer C compare 3 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERC_CMP4                                                        \
	(HRTIM_ADC1R_AD1TCC4) /*!< ADC Trigger on Timer C compare 4 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERC_PERIOD                                                      \
	(HRTIM_ADC1R_AD1TCPER) /*!< ADC Trigger on Timer C period */
#define HRTIM_ADCTRIGGEREVENT13_TIMERD_CMP2                                                        \
	(HRTIM_ADC1R_AD1TDC2) /*!< ADC Trigger on Timer D compare 2 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERD_CMP3                                                        \
	(HRTIM_ADC1R_AD1TDC3) /*!< ADC Trigger on Timer D compare 3 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERD_CMP4                                                        \
	(HRTIM_ADC1R_AD1TDC4) /*!< ADC Trigger on Timer D compare 4 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERD_PERIOD                                                      \
	(HRTIM_ADC1R_AD1TDPER) /*!< ADC Trigger on Timer D period */
#define HRTIM_ADCTRIGGEREVENT13_TIMERE_CMP2                                                        \
	(HRTIM_ADC1R_AD1TEC2) /*!< ADC Trigger on Timer E compare 2 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERE_CMP3                                                        \
	(HRTIM_ADC1R_AD1TEC3) /*!< ADC Trigger on Timer E compare 3 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERE_CMP4                                                        \
	(HRTIM_ADC1R_AD1TEC4) /*!< ADC Trigger on Timer E compare 4 */
#define HRTIM_ADCTRIGGEREVENT13_TIMERE_PERIOD                                                      \
	(HRTIM_ADC1R_AD1TEPER) /*!< ADC Trigger on Timer E period */

#define HRTIM_ADCTRIGGEREVENT24_NONE (uint32_t)0x00000000 /*!< No ADC trigger event */
#define HRTIM_ADCTRIGGEREVENT24_MASTER_CMP1                                                        \
	(HRTIM_ADC2R_AD2MC1) /*!< ADC Trigger on master compare 1 */
#define HRTIM_ADCTRIGGEREVENT24_MASTER_CMP2                                                        \
	(HRTIM_ADC2R_AD2MC2) /*!< ADC Trigger on master compare 2 */
#define HRTIM_ADCTRIGGEREVENT24_MASTER_CMP3                                                        \
	(HRTIM_ADC2R_AD2MC3) /*!< ADC Trigger on master compare 3 */
#define HRTIM_ADCTRIGGEREVENT24_MASTER_CMP4                                                        \
	(HRTIM_ADC2R_AD2MC4) /*!< ADC Trigger on master compare 4 */
#define HRTIM_ADCTRIGGEREVENT24_MASTER_PERIOD                                                      \
	(HRTIM_ADC2R_AD2MPER) /*!< ADC Trigger on master period */
#define HRTIM_ADCTRIGGEREVENT24_EVENT_6                                                            \
	(HRTIM_ADC2R_AD2EEV6) /*!< ADC Trigger on external event 6 */
#define HRTIM_ADCTRIGGEREVENT24_EVENT_7                                                            \
	(HRTIM_ADC2R_AD2EEV7) /*!< ADC Trigger on external event 7 */
#define HRTIM_ADCTRIGGEREVENT24_EVENT_8                                                            \
	(HRTIM_ADC2R_AD2EEV8) /*!< ADC Trigger on external event 8 */
#define HRTIM_ADCTRIGGEREVENT24_EVENT_9                                                            \
	(HRTIM_ADC2R_AD2EEV9) /*!< ADC Trigger on external event 9 */
#define HRTIM_ADCTRIGGEREVENT24_EVENT_10                                                           \
	(HRTIM_ADC2R_AD2EEV10) /*!< ADC Trigger on external event 10 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERA_CMP2                                                        \
	(HRTIM_ADC2R_AD2TAC2) /*!< ADC Trigger on Timer A compare 2 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERA_CMP3                                                        \
	(HRTIM_ADC2R_AD2TAC3) /*!< ADC Trigger on Timer A compare 3 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERA_CMP4                                                        \
	(HRTIM_ADC2R_AD2TAC4) /*!< ADC Trigger on Timer A compare 4 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERA_PERIOD                                                      \
	(HRTIM_ADC2R_AD2TAPER) /*!< ADC Trigger on Timer A period */
#define HRTIM_ADCTRIGGEREVENT24_TIMERB_CMP2                                                        \
	(HRTIM_ADC2R_AD2TBC2) /*!< ADC Trigger on Timer B compare 2 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERB_CMP3                                                        \
	(HRTIM_ADC2R_AD2TBC3) /*!< ADC Trigger on Timer B compare 3 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERB_CMP4                                                        \
	(HRTIM_ADC2R_AD2TBC4) /*!< ADC Trigger on Timer B compare 4 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERB_PERIOD                                                      \
	(HRTIM_ADC2R_AD2TBPER) /*!< ADC Trigger on Timer B period */
#define HRTIM_ADCTRIGGEREVENT24_TIMERC_CMP2                                                        \
	(HRTIM_ADC2R_AD2TCC2) /*!< ADC Trigger on Timer C compare 2 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERC_CMP3                                                        \
	(HRTIM_ADC2R_AD2TCC3) /*!< ADC Trigger on Timer C compare 3 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERC_CMP4                                                        \
	(HRTIM_ADC2R_AD2TCC4) /*!< ADC Trigger on Timer C compare 4 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERC_PERIOD                                                      \
	(HRTIM_ADC2R_AD2TCPER) /*!< ADC Trigger on Timer C period */
#define HRTIM_ADCTRIGGEREVENT24_TIMERC_RESET                                                       \
	(HRTIM_ADC2R_AD2TCRST) /*!< ADC Trigger on Timer C reset */
#define HRTIM_ADCTRIGGEREVENT24_TIMERD_CMP2                                                        \
	(HRTIM_ADC2R_AD2TDC2) /*!< ADC Trigger on Timer D compare 2 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERD_CMP3                                                        \
	(HRTIM_ADC2R_AD2TDC3) /*!< ADC Trigger on Timer D compare 3 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERD_CMP4                                                        \
	(HRTIM_ADC2R_AD2TDC4) /*!< ADC Trigger on Timer D compare 4 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERD_PERIOD                                                      \
	(HRTIM_ADC2R_AD2TDPER) /*!< ADC Trigger on Timer D period */
#define HRTIM_ADCTRIGGEREVENT24_TIMERD_RESET                                                       \
	(HRTIM_ADC2R_AD2TDRST) /*!< ADC Trigger on Timer D reset */
#define HRTIM_ADCTRIGGEREVENT24_TIMERE_CMP2                                                        \
	(HRTIM_ADC2R_AD2TEC2) /*!< ADC Trigger on Timer E compare 2 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERE_CMP3                                                        \
	(HRTIM_ADC2R_AD2TEC3) /*!< ADC Trigger on Timer E compare 3 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERE_CMP4                                                        \
	(HRTIM_ADC2R_AD2TEC4) /*!< ADC Trigger on Timer E compare 4 */
#define HRTIM_ADCTRIGGEREVENT24_TIMERE_RESET                                                       \
	(HRTIM_ADC2R_AD2TERST) /*!< ADC Trigger on Timer E reset */
...
/** @defgroup HRTIM_BurstDMARegistersUpdate 
  ...
  *        DMA operation
  */
#define HRTIM_BURSTDMA_NONE                                                                        \
	(uint32_t)0x00000000 /*!< No register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_CR                                                                          \
	(HRTIM_BDTUPR_TIMCR) /*!< MCR or TIMxCR register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_ICR                                                                         \
	(HRTIM_BDTUPR_TIMICR) /*!< MICR or TIMxICR register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_DIER                                                                        \
	(HRTIM_BDTUPR_TIMDIER) /*!< MDIER or TIMxDIER register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_CNT                                                                         \
	(HRTIM_BDTUPR_TIMCNT) /*!< MCNTR or CNTxCR register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_PER                                                                         \
	(HRTIM_BDTUPR_TIMPER) /*!< MPER or PERxR register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_REP                                                                         \
	(HRTIM_BDTUPR_TIMREP) /*!< MREPR or REPxR register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_CMP1                                                                        \
	(HRTIM_BDTUPR_TIMCMP1) /*!< MCMP1R or CMP1xR register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_CMP2                                                                        \
	(HRTIM_BDTUPR_TIMCMP2) /*!< MCMP2R or CMP2xR register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_CMP3                                                                        \
	(HRTIM_BDTUPR_TIMCMP3) /*!< MCMP3R or CMP3xR register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_CMP4                                                                        \
	(HRTIM_BDTUPR_TIMCMP4) /*!< MCMP4R or CMP4xR register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_DTR                                                                         \
	(HRTIM_BDTUPR_TIMDTR) /*!< TDxR register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_SET1R                                                                       \
	(HRTIM_BDTUPR_TIMSET1R) /*!< SET1R register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_RST1R                                                                       \
	(HRTIM_BDTUPR_TIMRST1R) /*!< RST1R register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_SET2R                                                                       \
	(HRTIM_BDTUPR_TIMSET2R) /*!< SET2R register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_RST2R                                                                       \
	(HRTIM_BDTUPR_TIMRST2R) /*!< RST1R register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_EEFR1                                                                       \
	(HRTIM_BDTUPR_TIMEEFR1) /*!< EEFxR1 register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_EEFR2                                                                       \
	(HRTIM_BDTUPR_TIMEEFR2) /*!< EEFxR2 register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_RSTR                                                                        \
	(HRTIM_BDTUPR_TIMRSTR) /*!< RSTxR register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_CHPR                                                                        \
	(HRTIM_BDTUPR_TIMCHPR) /*!< CHPxR register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_OUTR                                                                        \
	(HRTIM_BDTUPR_TIMOUTR) /*!< OUTxR register is updated by Burst DMA accesses */
#define HRTIM_BURSTDMA_FLTR                                                                        \
	(HRTIM_BDTUPR_TIMFLTR) /*!< FLTxR register is updated by Burst DMA accesses */
...
#define IS_HRTIM_FAULTCTL(FAULTCTL)                                                                \
	(((FAULTCTL) == HRTIM_FAULT_DISABLED) || ((FAULTCTL) == HRTIM_FAULT_ENABLED))
/**
  * @}
  */
...
/** @defgroup HRTIM_SoftwareTimerUpdate 
  ...
  */
#define HRTIM_TIMERUPDATE_MASTER                                                                   \
	(HRTIM_CR2_MSWU) /*!< Forces an immediate transfer from the preload to the active register in the master timer */
#define HRTIM_TIMERUPDATE_A                                                                        \
	(HRTIM_CR2_TASWU) /*!< Forces an immediate transfer from the preload to the active register in the timer A */
#define HRTIM_TIMERUPDATE_B                                                                        \
	(HRTIM_CR2_TBSWU) /*!< Forces an immediate transfer from the preload to the active register in the timer B */
#define HRTIM_TIMERUPDATE_C                                                                        \
	(HRTIM_CR2_TCSWU) /*!< Forces an immediate transfer from the preload to the active register in the timer C */
#define HRTIM_TIMERUPDATE_D                                                                        \
	(HRTIM_CR2_TDSWU) /*!< Forces an immediate transfer from the preload to the active register in the timer D */
#define HRTIM_TIMERUPDATE_E                                                                        \
	(HRTIM_CR2_TESWU) /*!< Forces an immediate transfer from the preload to the active register in the timer E */
...
#define HRTIM_OUTPUTLEVEL_INACTIVE                                                                 \
	(uint32_t)0x00000002 /*!< Forces the output to its inactive state */
...
#define HRTIM_OUTPUTSTATE_IDLE                                                                     \
	(uint32_t)0x00000001 /*!< Main operating mode, where the output can take the active or 
                                                              inactive level as programmed in the crossbar unit */
#define HRTIM_OUTPUTSTATE_RUN                                                                      \
	(uint32_t)0x00000002 /*!< Default operating state (e.g. after an HRTIM reset, when the 
                                                              outputs are disabled by software or during a burst mode operation */
#define HRTIM_OUTPUTSTATE_FAULT                                                                    \
	(uint32_t)0x00000003 /*!< Safety state, entered in case of a shut-down request on
                                                              FAULTx inputs */
/**
  * @}
  */
...
/** @defgroup HRTIM_CurrentPushPullStatus 
  ...
  *        in push-pull mode
  */
#define HRTIM_PUSHPULL_CURRENTSTATUS_OUTPUT1                                                       \
	(uint32_t)0x00000000 /*!< Signal applied on output 1 and output 2 forced inactive */
#define HRTIM_PUSHPULL_CURRENTSTATUS_OUTPUT2                                                       \
	(HRTIM_TIMISR_CPPSTAT) /*!< Signal applied on output 2 and output 1 forced inactive */
/**
  * @}
  */
...
/** @defgroup HRTIM_IdlePushPullStatus 
  ...
  */
#define HRTIM_PUSHPULL_IDLESTATUS_OUTPUT1                                                          \
	(uint32_t)0x00000000 /*!< Protection occurred when the output 1 was active and output 2 forced inactive */
#define HRTIM_PUSHPULL_IDLESTATUS_OUTPUT2                                                          \
	(HRTIM_TIMISR_IPPSTAT) /*!< Protection occurred when the output 2 was active and output 1 forced inactive */
/**
  * @}
  */
...
#define IS_HRTIM_IT(IT)                                                                            \
	(((IT) == HRTIM_ISR_FLT1) || ((IT) == HRTIM_ISR_FLT2) || ((IT) == HRTIM_ISR_FLT3) ||       \
	 ((IT) == HRTIM_ISR_FLT4) || ((IT) == HRTIM_ISR_FLT5) || ((IT) == HRTIM_ISR_SYSFLT) ||     \
	 ((IT) == HRTIM_ISR_DLLRDY) || ((IT) == HRTIM_ISR_BMPER))
...
#define IS_HRTIM_FLAG(FLAG)                                                                        \
	(((FLAG) == HRTIM_ISR_FLT1) || ((FLAG) == HRTIM_ISR_FLT2) || ((FLAG) == HRTIM_ISR_FLT3) || \
	 ((FLAG) == HRTIM_ISR_FLT4) || ((FLAG) == HRTIM_ISR_FLT5) ||                               \
	 ((FLAG) == HRTIM_ISR_SYSFLT) || ((FLAG) == HRTIM_ISR_DLLRDY) ||                           \
...
#define IS_HRTIM_MASTER_IT(IT)                                                                     \
	(((IT) == HRTIM_MDIER_MCMP1IE) || ((IT) == HRTIM_MDIER_MCMP2IE) ||                         \
	 ((IT) == HRTIM_MDIER_MCMP3IE) || ((IT) == HRTIM_MDIER_MCMP4IE) ||                         \
	 ((IT) == HRTIM_MDIER_MREPIE) || ((IT) == HRTIM_MDIER_SYNCIE) ||                           \
...
#define IS_HRTIM_MASTER_FLAG(FLAG)                                                                 \
	(((FLAG) == HRTIM_MISR_MCMP1) || ((FLAG) == HRTIM_MISR_MCMP2) ||                           \
	 ((FLAG) == HRTIM_MISR_MCMP3) || ((FLAG) == HRTIM_MISR_MCMP4) ||                           \
	 ((FLAG) == HRTIM_MISR_MREP) || ((FLAG) == HRTIM_MISR_SYNC) ||                             \
...
#define IS_HRTIM_TIM_IT(IT)                                                                        \
	(((IT) == HRTIM_TIMDIER_CMP1IE) || ((IT) == HRTIM_TIMDIER_CMP2IE) ||                       \
	 ((IT) == HRTIM_TIMDIER_CMP3IE) || ((IT) == HRTIM_TIMDIER_CMP4IE) ||                       \
	 ((IT) == HRTIM_TIMDIER_REPIE) || ((IT) == HRTIM_TIMDIER_UPDIE) ||                         \
	 ((IT) == HRTIM_TIMDIER_CPT1IE) || ((IT) == HRTIM_TIMDIER_CPT2IE) ||                       \
	 ((IT) == HRTIM_TIMDIER_SET1IE) || ((IT) == HRTIM_TIMDIER_RST1IE) ||                       \
	 ((IT) == HRTIM_TIMDIER_SET2IE) || ((IT) == HRTIM_TIMDIER_RST2IE) ||                       \
	 ((IT) == HRTIM_TIMDIER_RSTIE) || ((IT) == HRTIM_TIMDIER_DLYPRTIE))
...
#define IS_HRTIM_TIM_FLAG(FLAG)                                                                    \
	(((FLAG) == HRTIM_TIM_FLAG_CMP1) || ((FLAG) == HRTIM_TIM_FLAG_CMP2) ||                     \
	 ((FLAG) == HRTIM_TIM_FLAG_CMP3) || ((FLAG) == HRTIM_TIM_FLAG_CMP4) ||                     \
	 ((FLAG) == HRTIM_TIM_FLAG_REP) || ((FLAG) == HRTIM_TIM_FLAG_UPD) ||                       \
	 ((FLAG) == HRTIM_TIM_FLAG_CPT1) || ((FLAG) == HRTIM_TIM_FLAG_CPT2) ||                     \
	 ((FLAG) == HRTIM_TIM_FLAG_SET1) || ((FLAG) == HRTIM_TIM_FLAG_RST1) ||                     \
	 ((FLAG) == HRTIM_TIM_FLAG_SET2) || ((FLAG) == HRTIM_TIM_FLAG_RST2) ||                     \
	 ((FLAG) == HRTIM_TIM_FLAG_RST) || ((FLAG) == HRTIM_TIM_FLAG_DLYPRT1))
...
#define IS_HRTIM_MASTER_DMA(DMA)                                                                   \
	(((DMA) == HRTIM_MDIER_MCMP1DE) || ((DMA) == HRTIM_MDIER_MCMP2DE) ||                       \
	 ((DMA) == HRTIM_MDIER_MCMP3DE) || ((DMA) == HRTIM_MDIER_MCMP4DE) ||                       \
	 ((DMA) == HRTIM_MDIER_MREPDE) || ((DMA) == HRTIM_MDIER_SYNCDE) ||                         \
...
#define IS_HRTIM_TIM_DMA(DMA)                                                                      \
	(((DMA) == HRTIM_TIMDIER_CMP1DE) || ((DMA) == HRTIM_TIMDIER_CMP2DE) ||                     \
	 ((DMA) == HRTIM_TIMDIER_CMP3DE) || ((DMA) == HRTIM_TIMDIER_CMP4DE) ||                     \
	 ((DMA) == HRTIM_TIMDIER_REPDE) || ((DMA) == HRTIM_TIMDIER_UPDDE) ||                       \
	 ((DMA) == HRTIM_TIMDIER_CPT1DE) || ((DMA) == HRTIM_TIMDIER_CPT2DE) ||                     \
	 ((DMA) == HRTIM_TIMDIER_SET1DE) || ((DMA) == HRTIM_TIMDIER_RST1DE) ||                     \
	 ((DMA) == HRTIM_TIMDIER_SET2DE) || ((DMA) == HRTIM_TIMDIER_RST2DE) ||                     \
	 ((DMA) == HRTIM_TIMDIER_RSTDE) || ((DMA) == HRTIM_TIMDIER_DLYPRTDE))
...
void HRTIM_WaveformOuputConfig(HRTIM_TypeDef *HRTIMx, uint32_t TimerIdx, uint32_t Output,
...
void HRTIM_ITConfig(HRTIM_TypeDef *HRTIMx, uint32_t TimerIdx, uint32_t HRTIM_TIM_IT,
...
uint32_t HRTIM_GetDelayedProtectionStatus(HRTIM_TypeDef *HRTIMx, uint32_t TimerIdx,
					  uint32_t Output);
