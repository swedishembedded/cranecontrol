...
#define IS_I2C_REGISTER(REGISTER)                                                                  \
	(((REGISTER) == I2C_Register_CR1) || ((REGISTER) == I2C_Register_CR2) ||                   \
	 ...
	 ((REGISTER) == I2C_Register_TIMINGR) || ((REGISTER) == I2C_Register_TIMEOUTR) ||          \
...
#define IS_I2C_GET_FLAG(FLAG)                                                                      \
	(((FLAG) == I2C_FLAG_TXE) || ((FLAG) == I2C_FLAG_TXIS) || ((FLAG) == I2C_FLAG_RXNE) ||     \
	 ((FLAG) == I2C_FLAG_ADDR) || ((FLAG) == I2C_FLAG_NACKF) || ((FLAG) == I2C_FLAG_STOPF) ||  \
	 ((FLAG) == I2C_FLAG_TC) || ((FLAG) == I2C_FLAG_TCR) || ((FLAG) == I2C_FLAG_BERR) ||       \
	 ((FLAG) == I2C_FLAG_ARLO) || ((FLAG) == I2C_FLAG_OVR) || ((FLAG) == I2C_FLAG_PECERR) ||   \
	 ((FLAG) == I2C_FLAG_TIMEOUT) || ((FLAG) == I2C_FLAG_ALERT) || ((FLAG) == I2C_FLAG_BUSY))
...
#define IS_I2C_GET_IT(IT)                                                                          \
	(((IT) == I2C_IT_TXIS) || ((IT) == I2C_IT_RXNE) || ((IT) == I2C_IT_ADDR) ||                \
	 ...
	 ((IT) == I2C_IT_OVR) || ((IT) == I2C_IT_PECERR) || ((IT) == I2C_IT_TIMEOUT) ||            \
	 ((IT) == I2C_IT_ALERT))
...
void I2C_TransferHandling(I2C_TypeDef *I2Cx, uint16_t Address, uint8_t Number_Bytes,
