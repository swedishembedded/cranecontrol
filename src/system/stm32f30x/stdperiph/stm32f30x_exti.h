...
#define EXTI_Line16                                                                                \
	((uint32_t)0x10) /*!< External interrupt line 16 
                                                      Connected to the PVD Output */
#define EXTI_Line17                                                                                \
	((uint32_t)0x11) /*!< Internal interrupt line 17 
                                                      Connected to the RTC Alarm 
                                                      event */
#define EXTI_Line18                                                                                \
	((uint32_t)0x12) /*!< Internal interrupt line 18 
                                                      Connected to the USB Device
                                                      Wakeup from suspend event */
#define EXTI_Line19                                                                                \
	((uint32_t)0x13) /*!< Internal interrupt line 19
                                                      Connected to the RTC Tamper
                                                      and Time Stamp events */
#define EXTI_Line20                                                                                \
	((uint32_t)0x14) /*!< Internal interrupt line 20
                                                      Connected to the RTC wakeup
                                                      event */
#define EXTI_Line21                                                                                \
	((uint32_t)0x15) /*!< Internal interrupt line 21
                                                      Connected to the Comparator 1
                                                      event */
#define EXTI_Line22                                                                                \
	((uint32_t)0x16) /*!< Internal interrupt line 22
                                                      Connected to the Comparator 2
                                                      event */
#define EXTI_Line23                                                                                \
	((uint32_t)0x17) /*!< Internal interrupt line 23
                                                      Connected to the I2C1 wakeup
                                                      event */
#define EXTI_Line24                                                                                \
	((uint32_t)0x18) /*!< Internal interrupt line 24
                                                      Connected to the I2C2 wakeup
                                                      event */
#define EXTI_Line25                                                                                \
	((uint32_t)0x19) /*!< Internal interrupt line 25
                                                      Connected to the USART1 wakeup
                                                      event */
#define EXTI_Line26                                                                                \
	((uint32_t)0x1A) /*!< Internal interrupt line 26
                                                      Connected to the USART2 wakeup
                                                      event */
#define EXTI_Line27                                                                                \
	((uint32_t)0x1B) /*!< Internal interrupt line 27
                                                       reserved */
#define EXTI_Line28                                                                                \
	((uint32_t)0x1C) /*!< Internal interrupt line 28
                                                      Connected to the USART3 wakeup
                                                      event */
#define EXTI_Line29                                                                                \
	((uint32_t)0x1D) /*!< Internal interrupt line 29
                                                      Connected to the Comparator 3 
                                                      event */
#define EXTI_Line30                                                                                \
	((uint32_t)0x1E) /*!< Internal interrupt line 30
                                                      Connected to the Comparator 4 
                                                      event */
#define EXTI_Line31                                                                                \
	((uint32_t)0x1F) /*!< Internal interrupt line 31
                                                      Connected to the Comparator 5 
                                                      event */
#define EXTI_Line32                                                                                \
	((uint32_t)0x20) /*!< Internal interrupt line 32
                                                      Connected to the Comparator 6 
                                                      event */
#define EXTI_Line33                                                                                \
	((uint32_t)0x21) /*!< Internal interrupt line 33
                                                      Connected to the Comparator 7 
                                                      event */
#define EXTI_Line34                                                                                \
	((uint32_t)0x22) /*!< Internal interrupt line 34
                                                      Connected to the USART4 wakeup
                                                      event */
#define EXTI_Line35                                                                                \
	((uint32_t)0x23) /*!< Internal interrupt line 35
...
#define IS_EXTI_LINE_EXT(LINE)                                                                     \
	(((LINE) <= 0x16) ||                                                                       \
	 (((LINE) == EXTI_Line29) || ((LINE) == EXTI_Line30) || ((LINE) == EXTI_Line31) ||         \
...
#define IS_GET_EXTI_LINE(LINE)                                                                     \
	(((LINE) == EXTI_Line0) || ((LINE) == EXTI_Line1) || ((LINE) == EXTI_Line2) ||             \
	 ...
	 ((LINE) == EXTI_Line21) || ((LINE) == EXTI_Line22) || ((LINE) == EXTI_Line29) ||          \
