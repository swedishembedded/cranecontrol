...
#define IS_GPIO_LIST_PERIPH(PERIPH)                                                                \
	(((PERIPH) == GPIOA) || ((PERIPH) == GPIOB) || ((PERIPH) == GPIOD))
...
#define IS_GPIO_AF(AF)                                                                             \
	(((AF) == GPIO_AF_0) || ((AF) == GPIO_AF_1) || ((AF) == GPIO_AF_2) ||                      \
	 ...
	 ((AF) == GPIO_AF_6) || ((AF) == GPIO_AF_7) || ((AF) == GPIO_AF_8) ||                      \
	 ((AF) == GPIO_AF_9) || ((AF) == GPIO_AF_10) || ((AF) == GPIO_AF_11) ||                    \
	 ((AF) == GPIO_AF_12) || ((AF) == GPIO_AF_13) || ((AF) == GPIO_AF_14) ||                   \
	 ((AF) == GPIO_AF_15))
