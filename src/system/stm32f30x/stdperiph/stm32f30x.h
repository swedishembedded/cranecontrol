...
#if !defined(STM32F303xC) && !defined(STM32F334x8) && !defined(STM32F303x8) &&                     \
...
#define __STM32F30X_STDPERIPH_VERSION                                                              \
	((__STM32F30X_STDPERIPH_VERSION_MAIN << 24) | (__STM32F30X_STDPERIPH_VERSION_SUB1 << 16) | \
	 (__STM32F30X_STDPERIPH_VERSION_SUB2 << 8) | (__STM32F30X_STDPERIPH_VERSION_RC))
...
/******  STM32 specific Interrupt Numbers **********************************************************************/
	...
	COMP1_2_3_IRQn =
		64, /*!< COMP1, COMP2 and COMP3 global Interrupt                           */
	COMP4_5_6_IRQn =
		65, /*!< COMP5, COMP6 and COMP4 global Interrupt                           */
	...
	TIM7_DAC2_IRQn =
		55, /*!< TIM7 global and DAC2 underrun error Interrupt                      */
	COMP2_IRQn = 64, /*!< COMP2 global Interrupt                                            */
	COMP4_6_IRQn = 65, /*!< COMP6 and COMP4 global Interrupt                                  */
	HRTIM1_Master_IRQn =
		67, /*!< HRTIM Master Timer global Interrupts                              */
	HRTIM1_TIMA_IRQn =
...
typedef struct {
	...
	__IO uint32_t
		BSRR; /*!< GPIO port bit set/reset registerBSRR,                     Address offset: 0x18 */
	__IO uint32_t
...
typedef struct {
	__IO uint32_t
		MCR; /*!< HRTIM Master Timer control register,                     Address offset: 0x00 */
	__IO uint32_t
		MISR; /*!< HRTIM Master Timer interrupt status register,            Address offset: 0x04 */
	__IO uint32_t
		MICR; /*!< HRTIM Master Timer interupt clear register,              Address offset: 0x08 */
	__IO uint32_t
		MDIER; /*!< HRTIM Master Timer DMA/interrupt enable register         Address offset: 0x0C */
	__IO uint32_t
		MCNTR; /*!< HRTIM Master Timer counter register,                     Address offset: 0x10 */
	__IO uint32_t
		MPER; /*!< HRTIM Master Timer period register,                      Address offset: 0x14 */
	__IO uint32_t
		MREP; /*!< HRTIM Master Timer repetition register,                  Address offset: 0x18 */
	__IO uint32_t
		MCMP1R; /*!< HRTIM Master Timer compare 1 register,                   Address offset: 0x1C */
	uint32_t RESERVED0; /*!< Reserved,                                                                0x20 */
	__IO uint32_t
		MCMP2R; /*!< HRTIM Master Timer compare 2 register,                   Address offset: 0x24 */
	__IO uint32_t
		MCMP3R; /*!< HRTIM Master Timer compare 3 register,                   Address offset: 0x28 */
	__IO uint32_t
		MCMP4R; /*!< HRTIM Master Timer compare 4 register,                   Address offset: 0x2C */
} HRTIM_Master_TypeDef;

/* HRTIM slave definition */
typedef struct {
	__IO uint32_t
		TIMxCR; /*!< HRTIM Timerx control register,                              Address offset: 0x00  */
	__IO uint32_t
		TIMxISR; /*!< HRTIM Timerx interrupt status register,                     Address offset: 0x04  */
	__IO uint32_t
		TIMxICR; /*!< HRTIM Timerx interrupt clear register,                      Address offset: 0x08  */
	__IO uint32_t
		TIMxDIER; /*!< HRTIM Timerx DMA/interrupt enable register,                 Address offset: 0x0C  */
	__IO uint32_t
		CNTxR; /*!< HRTIM Timerx counter register,                              Address offset: 0x10  */
	__IO uint32_t
		PERxR; /*!< HRTIM Timerx period register,                               Address offset: 0x14  */
	__IO uint32_t
		REPxR; /*!< HRTIM Timerx repetition register,                           Address offset: 0x18  */
	__IO uint32_t
		CMP1xR; /*!< HRTIM Timerx compare 1 register,                            Address offset: 0x1C  */
	__IO uint32_t
		CMP1CxR; /*!< HRTIM Timerx compare 1 compound register,                   Address offset: 0x20  */
	__IO uint32_t
		CMP2xR; /*!< HRTIM Timerx compare 2 register,                            Address offset: 0x24  */
	__IO uint32_t
		CMP3xR; /*!< HRTIM Timerx compare 3 register,                            Address offset: 0x28  */
	__IO uint32_t
		CMP4xR; /*!< HRTIM Timerx compare 4 register,                            Address offset: 0x2C  */
	__IO uint32_t
		CPT1xR; /*!< HRTIM Timerx capture 1 register,                            Address offset: 0x30  */
	__IO uint32_t
		CPT2xR; /*!< HRTIM Timerx capture 2 register,                            Address offset: 0x34 */
	__IO uint32_t
		DTxR; /*!< HRTIM Timerx dead time register,                            Address offset: 0x38 */
	__IO uint32_t
		SETx1R; /*!< HRTIM Timerx output 1 set register,                         Address offset: 0x3C */
	__IO uint32_t
		RSTx1R; /*!< HRTIM Timerx output 1 reset register,                       Address offset: 0x40 */
	__IO uint32_t
		SETx2R; /*!< HRTIM Timerx output 2 set register,                         Address offset: 0x44 */
	__IO uint32_t
		RSTx2R; /*!< HRTIM Timerx output 2 reset register,                       Address offset: 0x48 */
	__IO uint32_t
		EEFxR1; /*!< HRTIM Timerx external event filtering 1 register,           Address offset: 0x4C */
	__IO uint32_t
		EEFxR2; /*!< HRTIM Timerx external event filtering 2 register,           Address offset: 0x50 */
	__IO uint32_t
		RSTxR; /*!< HRTIM Timerx Reset register,                                Address offset: 0x54 */
	__IO uint32_t
		CHPxR; /*!< HRTIM Timerx Chopper register,                              Address offset: 0x58 */
	__IO uint32_t
		CPT1xCR; /*!< HRTIM Timerx Capture 1 register,                            Address offset: 0x5C */
	__IO uint32_t
		CPT2xCR; /*!< HRTIM Timerx Capture 2 register,                            Address offset: 0x60 */
	__IO uint32_t
		OUTxR; /*!< HRTIM Timerx Output register,                               Address offset: 0x64 */
	__IO uint32_t
		FLTxR; /*!< HRTIM Timerx Fault register,                                Address offset: 0x68 */
	uint32_t RESERVED0
		[5]; /*!< Reserved,                                                                       */
...
typedef struct {
	__IO uint32_t
		CR1; /*!< HRTIM control register1,                                    Address offset: 0x00 */
	__IO uint32_t
		CR2; /*!< HRTIM control register2,                                    Address offset: 0x04 */
	__IO uint32_t
		ISR; /*!< HRTIM interrupt status register,                            Address offset: 0x08 */
	__IO uint32_t
		ICR; /*!< HRTIM interrupt clear register,                             Address offset: 0x0C */
	__IO uint32_t
		IER; /*!< HRTIM interrupt enable register,                            Address offset: 0x10 */
	__IO uint32_t
		OENR; /*!< HRTIM Output enable register,                               Address offset: 0x14 */
	__IO uint32_t
		DISR; /*!< HRTIM Output disable register,                              Address offset: 0x18 */
	__IO uint32_t
		ODSR; /*!< HRTIM Output disable status register,                       Address offset: 0x1C */
	__IO uint32_t
		BMCR; /*!< HRTIM Burst mode control register,                          Address offset: 0x20 */
	__IO uint32_t
		BMTRGR; /*!< HRTIM Busrt mode trigger register,                          Address offset: 0x24 */
	__IO uint32_t
		BMCMPR; /*!< HRTIM Burst mode compare register,                          Address offset: 0x28 */
	__IO uint32_t
		BMPER; /*!< HRTIM Burst mode period register,                           Address offset: 0x2C */
	__IO uint32_t
		EECR1; /*!< HRTIM Timer external event control register1,               Address offset: 0x30 */
	__IO uint32_t
		EECR2; /*!< HRTIM Timer external event control register2,               Address offset: 0x34 */
	__IO uint32_t
		EECR3; /*!< HRTIM Timer external event control register3,               Address offset: 0x38 */
	__IO uint32_t
		ADC1R; /*!< HRTIM ADC Trigger 1 register,                               Address offset: 0x3C */
	__IO uint32_t
		ADC2R; /*!< HRTIM ADC Trigger 2 register,                               Address offset: 0x40 */
	__IO uint32_t
		ADC3R; /*!< HRTIM ADC Trigger 3 register,                               Address offset: 0x44 */
	__IO uint32_t
		ADC4R; /*!< HRTIM ADC Trigger 4 register,                               Address offset: 0x48 */
	__IO uint32_t
		DLLCR; /*!< HRTIM DLL control register,                                 Address offset: 0x4C */
	__IO uint32_t
		FLTINxR1; /*!< HRTIM Fault input register1,                                Address offset: 0x50 */
	__IO uint32_t
		FLTINxR2; /*!< HRTIM Fault input register2,                                Address offset: 0x54 */
	__IO uint32_t
		BDMUPDR; /*!< HRTIM Burst DMA Master Timer update register,               Address offset: 0x58 */
	__IO uint32_t
		BDTAUPR; /*!< HRTIM Burst DMA Timerx update register,                     Address offset: 0x5C */
	__IO uint32_t
		BDTBUPR; /*!< HRTIM Burst DMA Timerx update register,                     Address offset: 0x60 */
	__IO uint32_t
		BDTCUPR; /*!< HRTIM Burst DMA Timerx update register,                     Address offset: 0x64 */
	__IO uint32_t
		BDTDUPR; /*!< HRTIM Burst DMA Timerx update register,                     Address offset: 0x68 */
	__IO uint32_t
		BDTEUPR; /*!< HRTIM Burst DMA Timerx update register,                     Address offset: 0x6C */
	__IO uint32_t
		BDMADR; /*!< HRTIM Burst DMA Master Data register,                       Address offset: 0x70 */
...
typedef struct {
	...
	__IO uint32_t EXTICR
		[4]; /*!< SYSCFG external interrupt configuration registers, Address offset: 0x14-0x08 */
	__IO uint32_t
...
typedef struct {
	...
	__IO uint32_t IOGXCR
		[8]; /*!< TSC I/O group x counter register,                         Address offset: 0x34-50 */
} TSC_TypeDef;
...
#define HRTIM_TIMISR_DLYPRT                                                                        \
	((uint32_t)0x00004000) /*!< Slave output 1 delay protection interrupt flag */
...
#define HRTIM_TIMICR_DLYPRT1C                                                                      \
	((uint32_t)0x00004000) /*!< Slave output 1 delay protection clear flag */
#define HRTIM_TIMICR_DLYPRT2C                                                                      \
	((uint32_t)0x00008000) /*!< Slave output 2 delay protection clear flag */
...
#define HRTIM_TIMDIER_DLYPRTIE                                                                     \
	((uint32_t)0x00004000) /*!< Slave delay protection interrupt enable */
...
#define HRTIM_SET1R_UPDATE                                                                         \
	((uint32_t)0x80000000) /*!< Register update (transfer preload to active) */
...
#define HRTIM_EECR3_EEVSD_0                                                                        \
	((uint32_t)0x40000000) /*!< External event sampling clock division bit 0 */
#define HRTIM_EECR3_EEVSD_1                                                                        \
	((uint32_t)0x80000000) /*!< External event sampling clock division bit 1 */
...
#define ADC_IER_EOS                                                                                \
	((uint32_t)0x00000008) /*!< ADC End of Regular sequence of Conversions interrupt source */
...
#define ADC_IER_JEOS                                                                               \
	((uint32_t)0x00000040) /*!< ADC End of Injected sequence of Conversions interrupt source */
...
#define ADC_IER_JQOVF                                                                              \
	((uint32_t)0x00000400) /*!< ADC Injected Context Queue Overflow interrupt source */
...
#define ADC_CFGR_EXTSEL                                                                            \
	((uint32_t)0x000003C0) /*!< ADC External trigger selection for regular group */
...
#define ADC_CFGR_EXTEN                                                                             \
	((uint32_t)0x00000C00) /*!< ADC External trigger enable and polarity selection for regular channels */
...
#define ADC_CFGR_CONT                                                                              \
	((uint32_t)0x00002000) /*!< ADC Single/continuous conversion mode for regular conversion */
...
#define ADC_CFGR_AWD1SGL                                                                           \
	((uint32_t)0x00400000) /*!< Enable the watchdog 1 on a single channel or on all channels */
#define ADC_CFGR_AWD1EN                                                                            \
	((uint32_t)0x00800000) /*!< ADC Analog watchdog 1 enable on regular Channels */
#define ADC_CFGR_JAWD1EN                                                                           \
	((uint32_t)0x01000000) /*!< ADC Analog watchdog 1 enable on injected Channels */
...
#define ADC_JSQR_JEXTSEL                                                                           \
	((uint32_t)0x0000003C) /*!< ADC external trigger selection for injected group */
...
#define ADC_JSQR_JEXTEN                                                                            \
	((uint32_t)0x000000C0) /*!< ADC external trigger enable and polarity selection for injected channels */
...
#define ADC_OFR1_OFFSET1                                                                           \
	((uint32_t)0x00000FFF) /*!< ADC data offset 1 for channel programmed into bits OFFSET1_CH[4:0] */
...
#define ADC_OFR1_OFFSET1_CH                                                                        \
	((uint32_t)0x7C000000) /*!< ADC Channel selection for the data offset 1 */
...
#define ADC_OFR2_OFFSET2                                                                           \
	((uint32_t)0x00000FFF) /*!< ADC data offset 2 for channel programmed into bits OFFSET2_CH[4:0] */
...
#define ADC_OFR2_OFFSET2_CH                                                                        \
	((uint32_t)0x7C000000) /*!< ADC Channel selection for the data offset 2 */
...
#define ADC_OFR3_OFFSET3                                                                           \
	((uint32_t)0x00000FFF) /*!< ADC data offset 3 for channel programmed into bits OFFSET3_CH[4:0] */
...
#define ADC_OFR3_OFFSET3_CH                                                                        \
	((uint32_t)0x7C000000) /*!< ADC Channel selection for the data offset 3 */
...
#define ADC_OFR4_OFFSET4                                                                           \
	((uint32_t)0x00000FFF) /*!< ADC data offset 4 for channel programmed into bits OFFSET4_CH[4:0] */
...
#define ADC_OFR4_OFFSET4_CH                                                                        \
	((uint32_t)0x7C000000) /*!< ADC Channel selection for the data offset 4 */
...
#define ADC_CALFACT_CALFACT_S                                                                      \
	((uint32_t)0x0000007F) /*!< ADC calibration factors in single-ended mode */
...
#define ADC_CALFACT_CALFACT_D                                                                      \
	((uint32_t)0x007F0000) /*!< ADC calibration factors in differential mode */
...
#define ADC12_CSR_ADRDY_EOSMP_MST                                                                  \
	((uint32_t)0x00000002) /*!< End of sampling phase flag of the master ADC */
#define ADC12_CSR_ADRDY_EOC_MST                                                                    \
	((uint32_t)0x00000004) /*!< End of regular conversion of the master ADC */
#define ADC12_CSR_ADRDY_EOS_MST                                                                    \
	((uint32_t)0x00000008) /*!< End of regular sequence flag of the master ADC */
#define ADC12_CSR_ADRDY_OVR_MST ((uint32_t)0x00000010) /*!< Overrun flag of the master ADC */
#define ADC12_CSR_ADRDY_JEOC_MST                                                                   \
	((uint32_t)0x00000020) /*!< End of injected conversion of the master ADC */
#define ADC12_CSR_ADRDY_JEOS_MST                                                                   \
	((uint32_t)0x00000040) /*!< End of injected sequence flag of the master ADC */
...
#define ADC12_CSR_JQOVF_MST                                                                        \
	((uint32_t)0x00000400) /*!< Injected context queue overflow flag of the master ADC */
#define ADC12_CSR_ADRDY_SLV ((uint32_t)0x00010000) /*!< Slave ADC ready */
#define ADC12_CSR_ADRDY_EOSMP_SLV                                                                  \
	((uint32_t)0x00020000) /*!< End of sampling phase flag of the slave ADC */
#define ADC12_CSR_ADRDY_EOC_SLV                                                                    \
	((uint32_t)0x00040000) /*!< End of regular conversion of the slave ADC */
#define ADC12_CSR_ADRDY_EOS_SLV                                                                    \
	((uint32_t)0x00080000) /*!< End of regular sequence flag of the slave ADC */
#define ADC12_CSR_ADRDY_OVR_SLV ((uint32_t)0x00100000) /*!< Overrun flag of the slave ADC */
#define ADC12_CSR_ADRDY_JEOC_SLV                                                                   \
	((uint32_t)0x00200000) /*!< End of injected conversion of the slave ADC */
#define ADC12_CSR_ADRDY_JEOS_SLV                                                                   \
	((uint32_t)0x00400000) /*!< End of injected sequence flag of the slave ADC */
...
#define ADC12_CSR_JQOVF_SLV                                                                        \
	((uint32_t)0x04000000) /*!< Injected context queue overflow flag of the slave ADC */

/********************  Bit definition for ADC34_CSR register  ********************/
#define ADC34_CSR_ADRDY_MST ((uint32_t)0x00000001) /*!< Master ADC ready */
#define ADC34_CSR_ADRDY_EOSMP_MST                                                                  \
	((uint32_t)0x00000002) /*!< End of sampling phase flag of the master ADC */
#define ADC34_CSR_ADRDY_EOC_MST                                                                    \
	((uint32_t)0x00000004) /*!< End of regular conversion of the master ADC */
#define ADC34_CSR_ADRDY_EOS_MST                                                                    \
	((uint32_t)0x00000008) /*!< End of regular sequence flag of the master ADC */
#define ADC34_CSR_ADRDY_OVR_MST ((uint32_t)0x00000010) /*!< Overrun flag of the master ADC */
#define ADC34_CSR_ADRDY_JEOC_MST                                                                   \
	((uint32_t)0x00000020) /*!< End of injected conversion of the master ADC */
#define ADC34_CSR_ADRDY_JEOS_MST                                                                   \
	((uint32_t)0x00000040) /*!< End of injected sequence flag of the master ADC */
...
#define ADC34_CSR_JQOVF_MST                                                                        \
	((uint32_t)0x00000400) /*!< Injected context queue overflow flag of the master ADC */
#define ADC34_CSR_ADRDY_SLV ((uint32_t)0x00010000) /*!< Slave ADC ready */
#define ADC34_CSR_ADRDY_EOSMP_SLV                                                                  \
	((uint32_t)0x00020000) /*!< End of sampling phase flag of the slave ADC */
#define ADC34_CSR_ADRDY_EOC_SLV                                                                    \
	((uint32_t)0x00040000) /*!< End of regular conversion of the slave ADC */
#define ADC34_CSR_ADRDY_EOS_SLV                                                                    \
	((uint32_t)0x00080000) /*!< End of regular sequence flag of the slave ADC */
#define ADC12_CSR_ADRDY_OVR_SLV ((uint32_t)0x00100000) /*!< Overrun flag of the slave ADC */
#define ADC34_CSR_ADRDY_JEOC_SLV                                                                   \
	((uint32_t)0x00200000) /*!< End of injected conversion of the slave ADC */
#define ADC34_CSR_ADRDY_JEOS_SLV                                                                   \
	((uint32_t)0x00400000) /*!< End of injected sequence flag of the slave ADC */
...
#define OPAMP1_CSR_FORCEVP                                                                         \
	((uint32_t)0x00000002) /*!< Connect the internal references to the plus input of the OPAMPX */
...
#define OPAMP1_CSR_TSTREF                                                                          \
	((uint32_t)0x20000000) /*!< It enables the switch to put out the internal reference */
...
#define EXTI_RTSR_TR20                                                                             \
	((uint32_t)0x00100000) /*!< Rising trigger event configuration bit of line 20 */
#define EXTI_RTSR_TR21                                                                             \
	((uint32_t)0x00200000) /*!< Rising trigger event configuration bit of line 21 */
#define EXTI_RTSR_TR22                                                                             \
	((uint32_t)0x00400000) /*!< Rising trigger event configuration bit of line 22 */
#define EXTI_RTSR_TR23                                                                             \
	((uint32_t)0x00800000) /*!< Rising trigger event configuration bit of line 23 */
#define EXTI_RTSR_TR24                                                                             \
	((uint32_t)0x01000000) /*!< Rising trigger event configuration bit of line 24 */
#define EXTI_RTSR_TR25                                                                             \
	((uint32_t)0x02000000) /*!< Rising trigger event configuration bit of line 25 */
#define EXTI_RTSR_TR26                                                                             \
	((uint32_t)0x04000000) /*!< Rising trigger event configuration bit of line 26 */
#define EXTI_RTSR_TR27                                                                             \
	((uint32_t)0x08000000) /*!< Rising trigger event configuration bit of line 27 */
#define EXTI_RTSR_TR28                                                                             \
	((uint32_t)0x10000000) /*!< Rising trigger event configuration bit of line 28 */
...
#define EXTI_FTSR_TR20                                                                             \
	((uint32_t)0x00100000) /*!< Falling trigger event configuration bit of line 20 */
#define EXTI_FTSR_TR21                                                                             \
	((uint32_t)0x00200000) /*!< Falling trigger event configuration bit of line 21 */
#define EXTI_FTSR_TR22                                                                             \
	((uint32_t)0x00400000) /*!< Falling trigger event configuration bit of line 22 */
#define EXTI_FTSR_TR23                                                                             \
	((uint32_t)0x00800000) /*!< Falling trigger event configuration bit of line 23 */
#define EXTI_FTSR_TR24                                                                             \
	((uint32_t)0x01000000) /*!< Falling trigger event configuration bit of line 24 */
#define EXTI_FTSR_TR25                                                                             \
	((uint32_t)0x02000000) /*!< Falling trigger event configuration bit of line 25 */
#define EXTI_FTSR_TR26                                                                             \
	((uint32_t)0x04000000) /*!< Falling trigger event configuration bit of line 26 */
#define EXTI_FTSR_TR27                                                                             \
	((uint32_t)0x08000000) /*!< Falling trigger event configuration bit of line 27 */
#define EXTI_FTSR_TR28                                                                             \
	((uint32_t)0x10000000) /*!< Falling trigger event configuration bit of line 28 */
...
#define PWR_CSR_VREFINTRDYF                                                                        \
	((uint16_t)0x0008) /*!< Internal voltage reference (VREFINT) ready flag */
...
#define RCC_BDCR_RTCSEL_HSE                                                                        \
	((uint32_t)0x00000300) /*!< HSE oscillator clock divided by 32 used as RTC clock */
...
#define RCC_CFGR2_ADCPRE12_NO                                                                      \
	((uint32_t)0x00000000) /*!< ADC12 clock disabled, ADC12 can use AHB clock */
...
#define RCC_CFGR2_ADCPRE34_NO                                                                      \
	((uint32_t)0x00000000) /*!< ADC34 clock disabled, ADC34 can use AHB clock */
...
#define SYSCFG_CFGR1_DAC_TRIG_RMP                                                                  \
	SYSCFG_CFGR1_DAC1_TRIG1_RMP /*!< Old define maintained for legacy purpose */
#define SYSCFG_CFGR1_TIM6DAC1                                                                      \
	SYSCFG_CFGR1_TIM6DAC1Ch1_DMA_RMP /*!< Old define maintained for legacy purpose */
#define SYSCFG_CFGR1_TIM7DAC2                                                                      \
	SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP /*!< Old define maintained for legacy purpose */
...
#define SYSCFG_CFGR2_LOCKUP_LOCK                                                                   \
	((uint32_t)0x00000001) /*!< Enables and locks the PVD connection with Timer1/8/15/16/17 Break Input and also the PVD_EN and PVDSEL[2:0] bits of the Power Control Interface */
#define SYSCFG_CFGR2_SRAM_PARITY_LOCK                                                              \
	((uint32_t)0x00000002) /*!< Enables and locks the SRAM_PARITY error signal with Break Input of TIMER1/8/15/16/17 */
#define SYSCFG_CFGR2_PVD_LOCK                                                                      \
	((uint32_t)0x00000004) /*!< Enables and locks the LOCKUP (Hardfault) output of CortexM4 with Break Input of TIMER1/8/15/16/17 */
#define SYSCFG_CFGR2_BYP_ADDR_PAR                                                                  \
	((uint32_t)0x00000010) /*!< Disables the address parity check on RAM */
...
#define USART_CR1_DEDT                                                                             \
	((uint32_t)0x001F0000) /*!< DEDT[4:0] bits (Driver Enable Deassertion Time) */
...
#define USART_CR3_SCARCNT                                                                          \
	((uint32_t)0x000E0000) /*!< SCARCNT[2:0] bits (SmartCard Auto-Retry Count) */
...
#define USART_CR3_WUS                                                                              \
	((uint32_t)0x00300000) /*!< WUS[1:0] bits (Wake UP Interrupt Flag Selection) */
