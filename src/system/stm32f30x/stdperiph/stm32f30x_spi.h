...
#define IS_SPI_RX_FIFO_THRESHOLD(THRESHOLD)                                                        \
	(((THRESHOLD) == SPI_RxFIFOThreshold_HF) || ((THRESHOLD) == SPI_RxFIFOThreshold_QF))
/**
  * @}
  */
...
#define IS_SPI_I2S_GET_IT(IT)                                                                      \
	(((IT) == SPI_I2S_IT_RXNE) || ((IT) == SPI_I2S_IT_TXE) || ((IT) == SPI_I2S_IT_OVR) ||      \
	 ((IT) == SPI_IT_MODF) || ((IT) == SPI_I2S_IT_FRE) || ((IT) == I2S_IT_UDR))
/**
  * @}
  */
...
#define IS_SPI_I2S_GET_FLAG(FLAG)                                                                  \
	(((FLAG) == SPI_I2S_FLAG_BSY) || ((FLAG) == SPI_I2S_FLAG_OVR) ||                           \
	 ...
	 ((FLAG) == SPI_I2S_FLAG_FRE) || ((FLAG) == I2S_FLAG_CHSIDE) || ((FLAG) == I2S_FLAG_UDR))
/**
  * @}
  */
