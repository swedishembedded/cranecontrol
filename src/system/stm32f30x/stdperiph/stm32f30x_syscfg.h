...
#define SYSCFG_DMARemap_TIM16                                                                      \
	SYSCFG_CFGR1_TIM16_DMA_RMP /*!< Remap TIM16 DMA requests from channel3 to channel4 */
...
#define SYSCFG_DMARemap_TIM6DAC1Ch1                                                                \
	SYSCFG_CFGR1_TIM6DAC1Ch1_DMA_RMP /* Remap TIM6/DAC1 Ch1 DMA requests */
#define SYSCFG_DMARemap_TIM7DAC1Ch2                                                                \
	SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP /* Remap TIM7/DAC1 Ch2 DMA requests */
...
#define IS_SYSCFG_DMA_REMAP(REMAP)                                                                 \
	(((REMAP) == SYSCFG_DMARemap_TIM17) || ((REMAP) == SYSCFG_DMARemap_TIM16) ||               \
	 ((REMAP) == SYSCFG_DMARemap_ADC2ADC4) || ((REMAP) == SYSCFG_DMARemap_TIM6DAC1Ch1) ||      \
	 ((REMAP) == SYSCFG_DMARemap_TIM7DAC1Ch2) || ((REMAP) == SYSCFG_DMARemap_DAC2Ch1) ||       \
	 ((REMAP) == SYSCFG_DMARemapCh2_SPI1_RX) || ((REMAP) == SYSCFG_DMARemapCh4_SPI1_RX) ||     \
	 ((REMAP) == SYSCFG_DMARemapCh6_SPI1_RX) || ((REMAP) == SYSCFG_DMARemapCh5_SPI1_TX) ||     \
	 ((REMAP) == SYSCFG_DMARemapCh5_SPI1_TX) || ((REMAP) == SYSCFG_DMARemapCh7_SPI1_TX) ||     \
	 ((REMAP) == SYSCFG_DMARemapCh7_I2C1_RX) || ((REMAP) == SYSCFG_DMARemapCh3_I2C1_RX) ||     \
	 ((REMAP) == SYSCFG_DMARemapCh5_I2C1_RX) || ((REMAP) == SYSCFG_DMARemapCh6_I2C1_TX) ||     \
	 ((REMAP) == SYSCFG_DMARemapCh2_I2C1_TX) || ((REMAP) == SYSCFG_DMARemapCh4_I2C1_TX) ||     \
	 ((REMAP) == SYSCFG_DMARemapCh4_ADC2) || ((REMAP) == SYSCFG_DMARemapCh2_ADC2))
...
#define SYSCFG_TriggerRemap_DACHRTIM1_TRIG1                                                        \
	((uint32_t)0x80010000) /*!< Remap DAC trigger to HRTIM1 TRIG1 */
#define SYSCFG_TriggerRemap_DACHRTIM1_TRIG2                                                        \
	((uint32_t)0x80020000) /*!< Remap DAC trigger to HRTIM1 TRIG2 */

#define IS_SYSCFG_TRIGGER_REMAP(REMAP)                                                             \
	(((REMAP) == SYSCFG_TriggerRemap_DACTIM3) ||                                               \
...
#define SYSCFG_EncoderRemap_TIM2                                                                   \
	SYSCFG_CFGR1_ENCODER_MODE_0 /*!< Timer 2 IC1 and IC2 connected to TIM15 IC1 and IC2 */
#define SYSCFG_EncoderRemap_TIM3                                                                   \
	SYSCFG_CFGR1_ENCODER_MODE_1 /*!< Timer 3 IC1 and IC2 connected to TIM15 IC1 and IC2 */
#define SYSCFG_EncoderRemap_TIM4                                                                   \
	SYSCFG_CFGR1_ENCODER_MODE /*!< Timer 4 IC1 and IC2 connected to TIM15 IC1 and IC2 */

#define IS_SYSCFG_ENCODER_REMAP(REMAP)                                                             \
	(((REMAP) == SYSCFG_EncoderRemap_No) || ((REMAP) == SYSCFG_EncoderRemap_TIM2) ||           \
	 ((REMAP) == SYSCFG_EncoderRemap_TIM3) || ((REMAP) == SYSCFG_EncoderRemap_TIM4))
...
#define IS_SYSCFG_I2C_FMP(PIN)                                                                     \
	(((PIN) == SYSCFG_I2CFastModePlus_PB6) || ((PIN) == SYSCFG_I2CFastModePlus_PB7) ||         \
	 ((PIN) == SYSCFG_I2CFastModePlus_PB8) || ((PIN) == SYSCFG_I2CFastModePlus_PB9) ||         \
	 ((PIN) == SYSCFG_I2CFastModePlus_I2C1) || ((PIN) == SYSCFG_I2CFastModePlus_I2C2))
...
/** @defgroup SYSCFG_FPU_Interrupt_Config 
  * @{
  */
#define SYSCFG_IT_IXC                                                                              \
	SYSCFG_CFGR1_FPU_IE_5 /*!< Inexact Interrupt enable (interrupt disabled by default) */
...
#define SYSCFG_Break_PVD                                                                           \
	SYSCFG_CFGR2_PVD_LOCK /*!< Enables and locks the PVD connection with TIM1/8/15/16/17 Break Input and also the PVD_EN and PVDSEL[2:0] bits of the Power Control Interface */
#define SYSCFG_Break_SRAMParity                                                                    \
	SYSCFG_CFGR2_SRAM_PARITY_LOCK /*!< Enables and locks the SRAM_PARITY error signal with Break Input of TIM1/8/15/16/17 */
#define SYSCFG_Break_Lockup                                                                        \
	SYSCFG_CFGR2_LOCKUP_LOCK /*!< Enables and locks the LOCKUP output of CortexM4 with Break Input of TIM1/8/15/16/17 */

#define IS_SYSCFG_LOCK_CONFIG(CONFIG)                                                              \
	(((CONFIG) == SYSCFG_Break_PVD) || ((CONFIG) == SYSCFG_Break_SRAMParity) ||                \
...
#define IS_SYSCFG_PAGE(PAGE)                                                                       \
	((((PAGE) & (uint32_t)0xFFFFFF00) == 0x00000000) && ((PAGE) != 0x00000000))
