...
#define DAC_Trigger_T6_TRGO                                                                        \
	((uint32_t)0x00000004) /*!< TIM6 TRGO selected as external conversion trigger for DAC1/2 channel1/2 */
#define DAC_Trigger_T3_TRGO                                                                        \
	((uint32_t)0x0000000C) /*!< TIM3 TRGO selected as external conversion trigger for DAC1/2 channel1/2 */
#define DAC_Trigger_T8_TRGO                                                                        \
	((uint32_t)0x0000000C) /*!< TIM8 TRGO selected as external conversion trigger for DAC1 channel1/2 */
#define DAC_Trigger_T7_TRGO                                                                        \
	((uint32_t)0x00000014) /*!< TIM7 TRGO selected as external conversion trigger for DAC1/2 channel1/2 */
#define DAC_Trigger_T15_TRGO                                                                       \
	((uint32_t)0x0000001C) /*!< TIM15 TRGO selected as external conversion trigger for DAC1/2 channel1/2 */
#define DAC_Trigger_HRTIM1_DACTRG1                                                                 \
	((uint32_t)0x0000001C) /*!< HRTIM1 DACTRG1 selected as external conversion trigger for DAC1 channel1/2 */
#define DAC_Trigger_T2_TRGO                                                                        \
	((uint32_t)0x00000024) /*!< TIM2 TRGO selected as external conversion trigger for DAC1/2 channel1/2 */
...
#define DAC_Trigger_HRTIM1_DACTRG2                                                                 \
	((uint32_t)0x0000002C) /*!< HRTIM1 DACTRG2 selected as external conversion trigger for DAC1 channel1/2 */
#define DAC_Trigger_HRTIM1_DACTRG3                                                                 \
	((uint32_t)0x0000002C) /*!< HRTIM1 DACTRG3 selected as external conversion trigger for DAC2 channel1 */
#define DAC_Trigger_Ext_IT9                                                                        \
	((uint32_t)0x00000034) /*!< EXTI Line9 event selected as external conversion trigger for DAC1/2 channel1/2 */
#define DAC_Trigger_Software                                                                       \
	((uint32_t)0x0000003C) /*!< Conversion started by software trigger for DAC1/2 channel1/2 */

#define IS_DAC_TRIGGER(TRIGGER)                                                                    \
	(((TRIGGER) == DAC_Trigger_None) || ((TRIGGER) == DAC_Trigger_T6_TRGO) ||                  \
	 ((TRIGGER) == DAC_Trigger_T3_TRGO) || ((TRIGGER) == DAC_Trigger_T8_TRGO) ||               \
	 ((TRIGGER) == DAC_Trigger_T7_TRGO) || ((TRIGGER) == DAC_Trigger_T15_TRGO) ||              \
	 ((TRIGGER) == DAC_Trigger_HRTIM1_DACTRG1) || ((TRIGGER) == DAC_Trigger_T2_TRGO) ||        \
	 ((TRIGGER) == DAC_Trigger_T4_TRGO) || ((TRIGGER) == DAC_Trigger_HRTIM1_DACTRG2) ||        \
	 ((TRIGGER) == DAC_Trigger_HRTIM1_DACTRG3) || ((TRIGGER) == DAC_Trigger_Ext_IT9) ||        \
...
#define IS_DAC_BUFFER_SWITCH_STATE(STATE)                                                          \
	(((STATE) == DAC_BufferSwitch_Enable) || ((STATE) == DAC_BufferSwitch_Disable))
/**
  * @}
  */
...
void DAC_WaveGenerationCmd(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t DAC_Wave,
...
void DAC_ITConfig(DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t DAC_IT,
		  FunctionalState NewState);
