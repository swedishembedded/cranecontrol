...
void termui_draw_float(struct termui *self, unsigned width, float value)
{
	...
	for (size_t c = 0; c < width - (half + len); c++)
		console_printf(self->console, " ");
...
void termui_draw_frame(struct termui *self, unsigned x, unsigned y, unsigned w, unsigned h,
		       const char *title)
{
	// draw the border
...
void termui_draw_ind_float(struct termui *self, unsigned x, unsigned y, unsigned width,
...
void termui_draw_ind_int(struct termui *self, unsigned x, unsigned y, unsigned width,
