...
#define _ToggleDTOG_RX(bEpNum)                                                                     \
	(_SetENDPOINT(bEpNum, (uint16_t)(EP_CTR_RX | EP_CTR_TX | EP_DTOG_RX |                      \
					 (_GetENDPOINT(bEpNum) & (uint16_t)EPREG_MASK))))
#define _ToggleDTOG_TX(bEpNum)                                                                     \
	(_SetENDPOINT(bEpNum, (uint16_t)(EP_CTR_RX | EP_CTR_TX | EP_DTOG_TX |                      \
					 (_GetENDPOINT(bEpNum) & (uint16_t)EPREG_MASK))))
...
#define _SetEPAddress(bEpNum, bAddr)                                                               \
	_SetENDPOINT(bEpNum, (uint32_t)(EP_CTR_RX | EP_CTR_TX |                                    \
					(_GetENDPOINT(bEpNum) & (uint32_t)EPREG_MASK)) |           \
				     (uint32_t)bAddr)
