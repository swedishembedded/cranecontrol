...
typedef enum { KS0713_OP_NONE, KS0713_OP_SET, KS0713_OP_CLR, KS0713_OP_XOR } ks0713_pixel_op_t;
...
void ks0713_draw_line(struct ks0713 *self, int8_t x1, int8_t y1, int8_t x2, int8_t y2,
