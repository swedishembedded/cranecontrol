...
void nrf24l01_settxaddr(struct nrf24l01 *nrf, uint8_t *addr)
{
	...
	uint8_t addrrev[NRF24L01_ADDRSIZE];
	nrf24l01_revaddress(addr, (uint8_t *)addrrev);
	nrf24l01_writeregisters(nrf, NRF24L01_REG_RX_ADDR_P0, addrrev,
				NRF24L01_ADDRSIZE); //set rx address for ack on pipe 0
	nrf24l01_writeregisters(nrf, NRF24L01_REG_TX_ADDR, addrrev,
				NRF24L01_ADDRSIZE); //set tx address
}
...
static void nrf24l01_setRX(struct nrf24l01 *nrf)
{
	...
	nrf24l01_writeregister(nrf, NRF24L01_REG_CONFIG,
			       nrf24l01_readregister(nrf, NRF24L01_REG_CONFIG) |
				       (1 << NRF24L01_REG_PRIM_RX)); //prx mode
	nrf24l01_writeregister(nrf, NRF24L01_REG_CONFIG,
			       nrf24l01_readregister(nrf, NRF24L01_REG_CONFIG) |
				       (1 << NRF24L01_REG_PWR_UP)); //power up
	nrf24l01_writeregister(nrf, NRF24L01_REG_STATUS,
...
{
	uint8_t config = nrf24l01_readregister(nrf, NRF24L01_REG_CONFIG) &
...
#if NRF24L01_ENABLEDP0 == 1
	nrf24l01_writeregister(nrf, NRF24L01_REG_EN_RXADDR,
			       nrf24l01_readregister(nrf, NRF24L01_REG_EN_RXADDR) |
...
//auto ack
#if NRF24L01_ACK == 1
	nrf24l01_writeregister(nrf, NRF24L01_REG_EN_AA,
			       nrf24l01_readregister(nrf, NRF24L01_REG_EN_AA) |
...
void nrf24l01_scan(struct nrf24l01 *nrf, uint8_t iterations, uint8_t result[NRF24L01_MAX_CHANNEL])
{
	...
	for (int j = 0; j < iterations; j++) {
		for (int i = 0; i < NRF24L01_MAX_CHANNEL; i++) {
			...
			if (nrf24l01_readregister(nrf, NRF24L01_REG_CD) > 0)
				channel[i]++;
		}
	}
	uint32_t norm = 0;
