...
static int8_t mpu6050_readBytes(struct mpu6050 *self, uint8_t regAddr, uint8_t length,
				uint8_t *data)
{
 ...
 */
static int8_t mpu6050_readBits(struct mpu6050 *self, uint8_t regAddr, uint8_t bitStart,
...
static void mpu6050_writeBits(struct mpu6050 *self, uint8_t regAddr, uint8_t bitStart,
			      uint8_t length, uint8_t data)
{
	//      010 value to write
	// 76543210 bit numbers
...
{
	mpu6050_readBits(self, MPU6050_RA_WHO_AM_I, MPU6050_WHO_AM_I_BIT, MPU6050_WHO_AM_I_LENGTH,
			 (uint8_t *)self->buffer);
...
void mpu6050_convertAcc(struct mpu6050 *self, int16_t ax, int16_t ay, int16_t az, float *axg,
			float *ayg, float *azg)
{
	(void)(self);
...
void mpu6050_convertGyr(struct mpu6050 *self, int16_t gx, int16_t gy, int16_t gz, float *gxd,
			float *gyd, float *gzd)
{
	(void)(self);
