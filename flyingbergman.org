...
*** Add deadband
** Finish encoder driver and update [[file:doc/usermanual.org::Universal%20encoder%20inputs][encoder inputs section]]
*** Add reconfiguration of encoder inputs to different modes
*** Add support for checking encoder errors and update
** Document gpio connections based on the device tree
